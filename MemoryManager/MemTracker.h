...
public:
    ...
    DECLSPEC_RESTRICT static void *
    Allocate(const size_t size, const AllocType type = AllocType_Unknown, const char *source_file = "(Unknown File)",
             const char *source_function = "(Unknown Function)", const int source_line = -1);

    DECLSPEC_RESTRICT static void *
    Reallocate(void *memory, const size_t size, const char *source_file = "(Unknown File)",
               const char *source_function = "(Unknown Function)", const int source_line = -1);

    static void
    Free(void *memory, const DeallocType type = DeallocType_Unknown, const char *source_file = "(Unknown File)",
         const char *source_function = "(Unknown Function)", const int source_line = -1);
