...
AllocateMemory(size_t size, AllocType type, const char *file, unsigned int line, const char *function) {
...
DECLSPEC_RESTRICT void *
ReallocateMemory(void *memory, size_t new_size, const char *file, unsigned int line, const char *function) {
...
return
MemoryTracker::Allocate(size, AllocType_New, info
->CurrentSourceFile, info->CurrentSourceFunction, info->CurrentSourceLine);
};
...
{
return
MemoryTracker::Allocate(size, AllocType_New, file,
...
{
MemoryTrackerThreadLocalInformation *info = MemoryTracker::GetThreadLocalInformation();
MemoryTracker::Free(memory, DeallocType_Delete, info
->CurrentSourceFile, info->CurrentSourceFunction, info->CurrentSourceLine);
};
...
{
MemoryTracker::Free(memory, DeallocType_Delete, file,
"(Unknown Function)", line);
};
...
MemoryTrackerThreadLocalInformation *info = MemoryTracker::GetThreadLocalInformation();
return
MemoryTracker::Allocate(size, AllocType_VectorNew, info
->CurrentSourceFile, info->CurrentSourceFunction, info->CurrentSourceLine);
};
...
{
return
MemoryTracker::Allocate(size, AllocType_VectorNew, file,
"(Unknown Function)", line);
};
...
{
MemoryTrackerThreadLocalInformation *info = MemoryTracker::GetThreadLocalInformation();
MemoryTracker::Free(memory, DeallocType_VectorDelete, info
->CurrentSourceFile, info->CurrentSourceFunction, info->CurrentSourceLine);
};
...
{
MemoryTracker::Free(memory, DeallocType_VectorDelete, file,
"(Unknown Function)", line);
};
