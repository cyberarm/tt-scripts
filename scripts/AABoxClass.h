...
public:
    ...
    void
    Init_Random(float min_center = -1.0f, float max_center = 1.0f, float min_extent = 0.5f, float max_extent = 1.0f);
...
public:
    ...
    inline MinMaxAABoxClass(const Vector3 &min_corner, const Vector3 &max_corner) : MinCorner(min_corner),
