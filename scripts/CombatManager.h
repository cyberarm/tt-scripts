...
private:
    ...
    static REF_DECL(CCameraClass
    *, MainCamera);
    static REF_DECL(SimpleSceneClass
    *, BackgroundScene);
    static REF_DECL(SoundEnvironmentClass
    *, SoundEnvironment);
    static REF_DECL(DazzleLayerClass
    *, DazzleLayer);
    static REF_DECL(MessageWindowClass
    *, MessageWindow);
    ...
    static REF_DECL(CombatNetworkHandlerClass
    *, NetworkHandler);
    static REF_DECL(CombatMiscHandlerClass
    *, MiscHandler);
