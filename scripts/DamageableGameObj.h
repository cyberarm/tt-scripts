...
public:
    ...
    const DamageableGameObjDef SCRIPTS_API
    &
    ...
    bool Is_Damaged() {
        return (DefenseObject.Get_Shield_Strength() < DefenseObject.Get_Shield_Strength_Max() ||
                DefenseObject.Get_Health() < DefenseObject.Get_Health_Max());
    }
