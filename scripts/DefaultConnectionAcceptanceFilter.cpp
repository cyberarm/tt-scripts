...
bool
DefaultConnectionAcceptanceFilter::isPlayerNameAllowed(cGameData &gameData, const WideStringClass &playerName, int id) {
    if (IS_SOLOPLAY) {
        return true;
    }
...
DefaultConnectionAcceptanceFilter::getStatus(const ConnectionRequest &connectionRequest,
                                             WideStringClass &refusalMessage) {
