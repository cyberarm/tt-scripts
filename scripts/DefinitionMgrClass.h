...
public:
    ...
    *
    ...
    Find_Named_Definition(const char *name, bool twiddle);

    SHARED_API static DefinitionClass
    *

    Find_Typed_Definition(const char *name, uint32 class_id, bool twiddle);
