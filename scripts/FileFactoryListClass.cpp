...
FileClass *FileFactoryListClass::Get_File(const char *fileName) {
    FileClass *
    result = NULL; // The first file for which Is_Available returns true, or else the first file that is non-null, or otherwise null.
...
REF_DEF3(FileFactoryListClass
*, FileFactoryListClass::Instance, 0x0085DB70, 0x0085CD58, 0x0085CE48);
#else
