...
public:
    ...
    static SHARED_API SList<C4GameObj>
    C4GameObjList;
    static SHARED_API SList<BeaconGameObj>
    BeaconGameObjList;
    static SHARED_API SList<SoldierGameObj>
    SoldierGameObjList;
    static SHARED_API SList<VehicleGameObj>
    VehicleGameObjList;
    static SHARED_API SList<ScriptZoneGameObj>
    ScriptZoneGameObjList;
#ifndef TTLE_EXPORTS
...
public:
    ...
    SCRIPTS_API static SmartGameObj
    *

    Find_SmartGameObj(int);
