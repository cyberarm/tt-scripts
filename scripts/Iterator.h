...
public:
    ...
    inline Iterator(VectorClass<T> &vector) {
        current = &vector[0];
        end = &vector[vector.Length()];
    }
...
public:
    ...
    inline Iterator(const VectorClass<T> &vector) {
        current = &vector[0];
        end = &vector[vector.Length()];
    }
...
public:
    ...
    inline Iterator(DynamicVectorClass<T> &vector) {
        current = &vector[0];
        end = &vector[vector.Count()];
    }
...
public:
    ...
    inline Iterator(const DynamicVectorClass<T> &vector) {
        current = &vector[0];
        end = &vector[vector.Count()];
    }
...
public:
    ...
    inline Iterator(SimpleVecClass<T> &vector) {
        current = &vector[0];
        end = &vector[vector.Length()];
    }
...
public:
    ...
    inline Iterator(const SimpleVecClass<T> &vector) {
        current = &vector[0];
        end = &vector[vector.Length()];
    }
...
public:
    ...
    inline Iterator(SimpleDynVecClass<T> &vector) {
        current = &vector[0];
        end = &vector[vector.Count()];
    }
...
public:
    ...
    inline Iterator(const SimpleDynVecClass<T> &vector) {
        current = &vector[0];
        end = &vector[vector.Count()];
    }
