...
enum PerkTypeCategories {
    INVALID = -1,
    PerkPurchase = 0,
    PerkJob = 1,
    PerkSwimming = 2,
    PerkCharacterHealth = 3,
    PerkVehicle = 4,
    PerkCombat = 5,
    PerkDeath = 6,
    PerkMisc = 7,
    PerkWeapon = 8,
    PerkSpawnCharacter = 9,
    PerkUnusable = 999
};
...
public:
    ...
    void AddAPerkType(int PerkID, const char *Name, unsigned int UnlockCost, bool MultiplyUnlockCost, bool ResetOnFail,
                      bool RequiresOrder, PerkTypeCategories Category, int MaxPerkUse, const char *Description) {
    ...
    void Finalize_Perks() {
        for (int x = 0; x < PERKCOUNT; x++)
            PerkSystemPerkTypeNodeList[x].CategoryPerkID = (PerkTypeCategoryCounts[PerkSystemPerkTypeNodeList[x].Category] = (
                    PerkTypeCategoryCounts[PerkSystemPerkTypeNodeList[x].Category] + 1));
    }
};
...
struct PlayerPerkDataNode {// A single perk for a player
    bool HasPerk;
...
struct PlayerPerksDataNode {// All of the players perks
    char PlayerName[128];
    int UnlockedPerks;
...
private:
    ...
    PlayerPerksDataNode *
    AddAPlayerPerkNode(PlayerPerksDataNode *Node, const char *PlayerName, PlayerPerkDataNode PPerkList[]) {
    ...
    PlayerPerksDataNode *GetPlayerPerkList(
            const char *PlayerName) {// Used to find if a player's perk list already exists, if not it creates a new node for the player's name
    ...
    void AddPlayerToPerkList(const char *PlayerName,
                             PlayerPerkDataNode PPerkList[]) {// Used when loading the player perk list control file
        if (!PlayerPerksDataNodeList) {
            PlayerPerksDataNodeList = AddAPlayerPerkNode(new PlayerPerksDataNode, PlayerName, PPerkList);
            return;
        }
...
public:
    ...
    void FindPlayerPerkList(GameObject *obj,
                            int DisplayMessage) {// Searches for the player's perk list, when it finds it it pulls it into the player ID if it isn't already, then it reloads the player's selected perks
    ...
    bool IncreasePlayerPerkUnlockAmount(GameObject *obj, int PerkID, unsigned int IncreaseAmount) {
        ...
        if (PerkSystemPerkTypeNodeList[PerkID].RequiresOrder) {
            ...
            PlayerPerkListNodes[PlayerID]->PlayerPerkList[PerkID].PerkProgress += IncreaseAmount;
        if ((PlayerPerkListNodes[PlayerID]->PlayerPerkList[PerkID].PerkProgress >=
             PerkSystemPerkTypeNodeList[PerkID].UnlockCost && !PerkSystemPerkTypeNodeList[PerkID].ResetOnFail) ||
            PlayerPerkListNodes[PlayerID]->PlayerPerkList[PerkID].PerkProgress ==
            PerkSystemPerkTypeNodeList[PerkID].UnlockCost) {
        ...
        } else if (PlayerPerkListNodes[PlayerID]->PlayerPerkList[PerkID].PerkProgress >
                   PerkSystemPerkTypeNodeList[PerkID].UnlockCost && PerkSystemPerkTypeNodeList[PerkID].ResetOnFail) {
            PlayerPerkListNodes[PlayerID]->PlayerPerkList[PerkID].PerkProgress = 0;
            return false;
        }
    ...
    void SaveData() {
        ...
        while (Current) {
            ...
            for (int x = 0; x < PERKCOUNT; x++)
                sprintf(EncryptString, "%s%d %d ", EncryptString, Current->PlayerPerkList[x].PerkProgress,
                        Current->PlayerPerkList[x].PerkProgress);
        ...
        while (Current) {
            ...
            sprintf(EncryptString, "");
            for (int x = 0; x < PERKCOUNT; x++)
                sprintf(EncryptString, "%s%.2f ", EncryptString,
                        Current->PlayerPerkList[x].HasPerk ? 100.00 : ((float) Current->PlayerPerkList[x].PerkProgress /
                                                                       PerkSystemPerkTypeNodeList[x].UnlockCost *
                                                                       100.0f));
        ...
        if (LoadPerks) {
            while (!feof(LoadPerks)) {
                ...
                sscanf(DecryptedString,
                       "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d 0",
                       &LA[0].PerkProgress, &LA2[0].PerkProgress, &LA[1].PerkProgress, &LA2[1].PerkProgress,
                       &LA[2].PerkProgress, &LA2[2].PerkProgress, &LA[3].PerkProgress, &LA2[3].PerkProgress,
                       &LA[4].PerkProgress, &LA2[4].PerkProgress, &LA[5].PerkProgress, &LA2[5].PerkProgress,
                       &LA[6].PerkProgress, &LA2[6].PerkProgress, &LA[7].PerkProgress, &LA2[7].PerkProgress,
                       &LA[8].PerkProgress, &LA2[8].PerkProgress, &LA[9].PerkProgress, &LA2[9].PerkProgress,
                       &LA[10].PerkProgress, &LA2[10].PerkProgress, &LA[11].PerkProgress, &LA2[11].PerkProgress,
                       &LA[12].PerkProgress, &LA2[12].PerkProgress, &LA[13].PerkProgress, &LA2[13].PerkProgress,
                       &LA[14].PerkProgress, &LA2[14].PerkProgress, &LA[15].PerkProgress, &LA2[15].PerkProgress,
                       &LA[16].PerkProgress, &LA2[16].PerkProgress, &LA[17].PerkProgress, &LA2[17].PerkProgress,
                       &LA[18].PerkProgress, &LA2[18].PerkProgress, &LA[19].PerkProgress, &LA2[19].PerkProgress,
                       &LA[20].PerkProgress, &LA2[20].PerkProgress, &LA[21].PerkProgress, &LA2[21].PerkProgress,
                       &LA[22].PerkProgress, &LA2[22].PerkProgress, &LA[23].PerkProgress, &LA2[23].PerkProgress,
                       &LA[24].PerkProgress, &LA2[24].PerkProgress, &LA[25].PerkProgress, &LA2[25].PerkProgress,
                       &LA[26].PerkProgress, &LA2[26].PerkProgress, &LA[27].PerkProgress, &LA2[27].PerkProgress,
                       &LA[28].PerkProgress, &LA2[28].PerkProgress, &LA[29].PerkProgress, &LA2[29].PerkProgress,
                       &LA[30].PerkProgress, &LA2[30].PerkProgress, &LA[31].PerkProgress, &LA2[31].PerkProgress,
                       &LA[32].PerkProgress, &LA2[32].PerkProgress, &LA[33].PerkProgress, &LA2[33].PerkProgress,
                       &LA[34].PerkProgress, &LA2[34].PerkProgress, &LA[35].PerkProgress, &LA2[35].PerkProgress,
                       &LA[36].PerkProgress, &LA2[36].PerkProgress, &LA[37].PerkProgress, &LA2[37].PerkProgress,
                       &LA[38].PerkProgress, &LA2[38].PerkProgress, &LA[39].PerkProgress, &LA2[39].PerkProgress,
                       &LA[40].PerkProgress, &LA2[40].PerkProgress, &LA[41].PerkProgress, &LA2[41].PerkProgress,
                       &LA[42].PerkProgress, &LA2[42].PerkProgress, &LA[43].PerkProgress, &LA2[43].PerkProgress,
                       &LA[44].PerkProgress, &LA2[44].PerkProgress, &LA[45].PerkProgress, &LA2[45].PerkProgress,
                       &LA[46].PerkProgress, &LA2[46].PerkProgress, &LA[47].PerkProgress, &LA2[47].PerkProgress,
                       &LA[48].PerkProgress, &LA2[48].PerkProgress, &LA[49].PerkProgress, &LA2[49].PerkProgress,
                       &LA[50].PerkProgress, &LA2[50].PerkProgress, &LA[51].PerkProgress, &LA2[51].PerkProgress,
                       &LA[52].PerkProgress, &LA2[52].PerkProgress, &LA[53].PerkProgress, &LA2[53].PerkProgress,
                       &LA[54].PerkProgress, &LA2[54].PerkProgress, &LA[55].PerkProgress, &LA2[55].PerkProgress,
                       &LA[56].PerkProgress, &LA2[56].PerkProgress, &LA[57].PerkProgress, &LA2[57].PerkProgress,
                       &LA[58].PerkProgress, &LA2[58].PerkProgress, &LA[59].PerkProgress, &LA2[59].PerkProgress,
                       &LA[60].PerkProgress, &LA2[60].PerkProgress, &LA[61].PerkProgress, &LA2[61].PerkProgress,
                       &LA[62].PerkProgress, &LA2[62].PerkProgress, &LA[63].PerkProgress, &LA2[63].PerkProgress,
                       &LA[64].PerkProgress, &LA2[64].PerkProgress, &LA[65].PerkProgress, &LA2[65].PerkProgress,
                       &LA[66].PerkProgress, &LA2[66].PerkProgress, &LA[67].PerkProgress, &LA2[67].PerkProgress,
                       &LA[68].PerkProgress, &LA2[68].PerkProgress, &LA[69].PerkProgress, &LA2[69].PerkProgress,
                       &LA[70].PerkProgress, &LA2[70].PerkProgress, &LA[71].PerkProgress, &LA2[71].PerkProgress,
                       &LA[72].PerkProgress, &LA2[72].PerkProgress, &LA[73].PerkProgress, &LA2[73].PerkProgress,
                       &LA[74].PerkProgress, &LA2[74].PerkProgress, &LA[75].PerkProgress, &LA2[75].PerkProgress,
                       &LA[76].PerkProgress, &LA2[76].PerkProgress, &LA[77].PerkProgress, &LA2[77].PerkProgress,
                       &LA[78].PerkProgress, &LA2[78].PerkProgress, &LA[79].PerkProgress, &LA2[79].PerkProgress,
                       &LA[80].PerkProgress, &LA2[80].PerkProgress, &LA[81].PerkProgress, &LA2[81].PerkProgress,
                       &LA[82].PerkProgress, &LA2[82].PerkProgress, &LA[83].PerkProgress, &LA2[83].PerkProgress,
                       &LA[84].PerkProgress, &LA2[84].PerkProgress, &LA[85].PerkProgress, &LA2[85].PerkProgress,
                       &LA[86].PerkProgress, &LA2[86].PerkProgress, &LA[87].PerkProgress, &LA2[87].PerkProgress,
                       &LA[88].PerkProgress, &LA2[88].PerkProgress, &LA[89].PerkProgress, &LA2[89].PerkProgress,
                       &LA[90].PerkProgress, &LA2[90].PerkProgress, &LA[91].PerkProgress, &LA2[91].PerkProgress,
                       &LA[92].PerkProgress, &LA2[92].PerkProgress, &LA[93].PerkProgress, &LA2[93].PerkProgress,
                       &LA[94].PerkProgress, &LA2[94].PerkProgress, &LA[95].PerkProgress, &LA2[95].PerkProgress,
                       &LA[96].PerkProgress, &LA2[96].PerkProgress, &LA[97].PerkProgress, &LA2[97].PerkProgress,
                       &LA[98].PerkProgress, &LA2[98].PerkProgress, &LA[99].PerkProgress, &LA2[99].PerkProgress,
                       &LA[100].PerkProgress, &LA2[100].PerkProgress, &LA[101].PerkProgress, &LA2[101].PerkProgress,
                       &LA[102].PerkProgress, &LA2[102].PerkProgress, &LA[103].PerkProgress, &LA2[103].PerkProgress,
                       &LA[104].PerkProgress, &LA2[104].PerkProgress, &LA[105].PerkProgress, &LA2[105].PerkProgress,
                       &LA[106].PerkProgress, &LA2[106].PerkProgress, &LA[107].PerkProgress, &LA2[107].PerkProgress,
                       &LA[108].PerkProgress, &LA2[108].PerkProgress, &LA[109].PerkProgress, &LA2[109].PerkProgress,
                       &LA[110].PerkProgress, &LA2[110].PerkProgress, &LA[111].PerkProgress, &LA2[111].PerkProgress,
                       &LA[112].PerkProgress, &LA2[112].PerkProgress, &LA[113].PerkProgress, &LA2[113].PerkProgress,
                       &LA[114].PerkProgress, &LA2[114].PerkProgress, &LA[115].PerkProgress, &LA2[115].PerkProgress,
                       &LA[116].PerkProgress, &LA2[116].PerkProgress, &LA[117].PerkProgress, &LA2[117].PerkProgress,
                       &LA[118].PerkProgress, &LA2[118].PerkProgress, &LA[119].PerkProgress, &LA2[119].PerkProgress,
                       &LA[120].PerkProgress, &LA2[120].PerkProgress, &LA[121].PerkProgress, &LA2[121].PerkProgress,
                       &LA[122].PerkProgress, &LA2[122].PerkProgress, &LA[123].PerkProgress, &LA2[123].PerkProgress,
                       &LA[124].PerkProgress, &LA2[124].PerkProgress, &LA[125].PerkProgress, &LA2[125].PerkProgress);
                for (int x = 0; x < PERKCOUNT; x++) {
...
void AddPerkTypes() {
    ...
    PerkTypeSystem.AddAPerkType(61, "To The Moon and Beyond", 26, false, false, true, PerkWeapon, 1,
                                "Your reward for defending Earth!");
    PerkTypeSystem.AddAPerkType(63, "Gamer", 10, false, false, false, PerkWeapon, 1,
                                "Buying Floppy Disks gives you Golden Floppy Disks instead.");
    PerkTypeSystem.AddAPerkType(105, "Extra Life Ability", 5, false, false, false, PerkUnusable, 0,
                                "You have unlocked the Extra Life ability.");
    PerkTypeSystem.AddAPerkType(106, "Hyperdrive Ability", 10, false, false, false, PerkUnusable, 0,
                                "You have unlocked the Hyperdrive ability.");
    PerkTypeSystem.AddAPerkType(107, "Double Points Ability", 25, false, false, false, PerkUnusable, 0,
                                "You have unlocked the Double Points ability.");
    PerkTypeSystem.AddAPerkType(108, "Rapid Energy Regen Ability", 25, false, false, false, PerkUnusable, 0,
                                "You have unlocked the Rapid Energy Regen ability.");
    PerkTypeSystem.AddAPerkType(109, "Weapons Upgrade Ability", 25, false, false, false, PerkUnusable, 0,
                                "You have unlocked the Weapons Upgrade ability.");
    PerkTypeSystem.AddAPerkType(110, "Drone Ability", 50, false, false, false, PerkUnusable, 0,
                                "You have unlocked the Drone ability.");
    PerkTypeSystem.AddAPerkType(111, "High Explosive Warhead Ability", 50, false, false, false, PerkUnusable, 0,
                                "You have unlocked the High Explosive Warhead ability.");
    PerkTypeSystem.AddAPerkType(112, "SOS Beacon Ability", 25, false, false, false, PerkUnusable, 0,
                                "You have unlocked the SOS Beacon ability.");
    PerkTypeSystem.AddAPerkType(113, "Drone Swarm Ability", 25, false, false, false, PerkUnusable, 0,
...
public:
    ...
    void SaveData() {
        ...
        switch (difficulty) {
            case 0:
                sprintf(FileName, "%sBetaCMBTPlayerRecordsEasy.txt", SavePath);
                break;
            case 1:
                sprintf(FileName, "%sBetaCMBTPlayerRecords.txt", SavePath);
                break;
            case 2:
                sprintf(FileName, "%sBetaCMBTPlayerRecordsHard.txt", SavePath);
                break;
            case 3:
                sprintf(FileName, "%sBetaCMBTPlayerRecordsDoomsday.txt", SavePath);
                break;
        };
        ...
        if (!SaveScores || !SaveScores2) {
            char debug[220];
            sprintf(debug,
                    "msg RenCometBustersScoreSystem ERROR: Could not open save files %sBetaCMBTPlayerRecords.tmp and %sCMBTPlayerRecords.txt for writting!",
                    SavePath, SavePath);
            Console_Input(debug);
            if (SaveScores)
                fclose(SaveScores);
        ...
        while (Current) {
            ...
            char EncryptString[2048];
            sprintf(EncryptString,
                    "%lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %d %d %lu %lu %lu %lu %lu %d %d %d %d %d %d %lu 0",
                    Current->PlayTime, Current->RoundsPlayed, Current->Deaths, Current->CometSmall,
                    Current->CometMedium, Current->CometLarge, Current->CometHuge, Current->TheMoon, Current->UFO,
                    Current->Mine, Current->OtherPlayers, Current->HighestScore, Current->TotalScore,
                    Current->HighestLevel, Current->TotalComets, Current->HEWPowerups, Current->HEWUsed,
                    Current->RoundsFired, Current->TeamHighestLevel, Current->GrantedOtherPlayersLives,
                    Current->ReceivedOtherPlayersLives, Current->CargoShip, Current->NewLivesAcquired,
                    Current->ObjectsRammed, Current->SOSBeacons, Current->PowerPowerups, Current->ExtraLifePowerups,
                    Current->UsedSOSBeacons, Current->PointPowerups, Current->PowerupPoints, Current->PickedUpDrone,
                    Current->UsedDrones, Current->DroneKills, Current->DronesKilled, Current->DronePoints,
                    Current->RegenPowerups, Current->DoublePointsPowerups, Current->DoublePointsPoints,
                    Current->DeerPowerups, Current->TimeCloaked, Current->ShipCloakedCount, Current->TimeShielded,
                    Current->ShieldRaisedCount, Current->RanOutOfPowerCount, Current->CargoShipScore,
                    Current->CargoShipKills, Current->JumpsUsed, Current->PickedUpDroneSwarm, Current->UsedDronesSwarm,
                    Current->TimeDisrupted, Current->UpgadedWeaponPowerups, Current->UpgadedWeaponTime,
                    Current->HighestCleanScore, Current->HighestCleanTeamScore, Current->HighestCleanLevel,
                    Current->HighestCleanTeamLevel, Current->HighestTeamScore, Current->LevelsPlayedWithPerks,
                    Current->LevelsPlayedWithOutPerks, Current->LevelsPlayedWithPerksAsATeam,
                    Current->LevelsPlayedWithOutPerksAsATeam, Current->LastPlayTime.day, Current->LastPlayTime.month,
        ...
        switch (difficulty) {
            case 0:
                sprintf(FileName, "%sBetaCMBTPlayerRecordsEasy.Rp2", SavePath);
                break;
            case 1:
                sprintf(FileName, "%sBetaCMBTPlayerRecords.Rp2", SavePath);
                break;
            case 2:
                sprintf(FileName, "%sBetaCMBTPlayerRecordsHard.Rp2", SavePath);
                break;
            case 3:
                sprintf(FileName, "%sBetaCMBTPlayerRecordsDoomsday.Rp2", SavePath);
                break;
        };
        remove(FileName);
        sprintf(FileNameTmp, "%sBetaCMBTPlayerRecords.tmp", SavePath);
        ...
        if (LoadScores) {
            while (!feof(LoadScores)) {
                ...
                sscanf(JmgUtility::Rp2Decrypt(DecryptString, Current->PlayerName[0], Current->PlayerName[1]),
                       "%lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %d %d %lu %lu %lu %lu %lu %d %d %d %d %d %d %lu",
                       &Current->PlayTime, &Current->RoundsPlayed, &Current->Deaths, &Current->CometSmall,
                       &Current->CometMedium, &Current->CometLarge, &Current->CometHuge, &Current->TheMoon,
                       &Current->UFO, &Current->Mine, &Current->OtherPlayers, &Current->HighestScore,
                       &Current->TotalScore, &Current->HighestLevel, &Current->TotalComets, &Current->HEWPowerups,
                       &Current->HEWUsed, &Current->RoundsFired, &Current->TeamHighestLevel,
                       &Current->GrantedOtherPlayersLives, &Current->ReceivedOtherPlayersLives, &Current->CargoShip,
                       &Current->NewLivesAcquired, &Current->ObjectsRammed, &Current->SOSBeacons,
                       &Current->PowerPowerups, &Current->ExtraLifePowerups, &Current->UsedSOSBeacons,
                       &Current->PointPowerups, &Current->PowerupPoints, &Current->PickedUpDrone, &Current->UsedDrones,
                       &Current->DroneKills, &Current->DronesKilled, &Current->DronePoints, &Current->RegenPowerups,
                       &Current->DoublePointsPowerups, &Current->DoublePointsPoints, &Current->DeerPowerups,
                       &Current->TimeCloaked, &Current->ShipCloakedCount, &Current->TimeShielded,
                       &Current->ShieldRaisedCount, &Current->RanOutOfPowerCount, &Current->CargoShipScore,
                       &Current->CargoShipKills, &Current->JumpsUsed, &Current->PickedUpDroneSwarm,
                       &Current->UsedDronesSwarm, &Current->TimeDisrupted, &Current->UpgadedWeaponPowerups,
                       &Current->UpgadedWeaponTime, &Current->HighestCleanScore, &Current->HighestCleanTeamScore,
                       &Current->HighestCleanLevel, &Current->HighestCleanTeamLevel, &Current->HighestTeamScore,
                       &Current->LevelsPlayedWithPerks, &Current->LevelsPlayedWithOutPerks,
                       &Current->LevelsPlayedWithPerksAsATeam, &Current->LevelsPlayedWithOutPerksAsATeam,
    ...
    CMTBHighScoresNode *CompareHighScoreNodes(CMTBHighScoresNode *High, CMTBHighScoresNode *Current, int CompVal) {
        ...
        switch (CompVal) {
            ...
            case 59:
                return (High->LevelsPlayedWithOutPerksAsATeam >= Current->LevelsPlayedWithOutPerksAsATeam ? High
                                                                                                          : Current);
            default:
    ...
    char *ReturnScore(CMTBHighScoresNode *High, int CompVal) {
        ...
        switch (CompVal) {
            case 0:
                sprintf(RetChar, "Server Record: %s has played %lu rounds of Renegade Comet Busters.", High->PlayerName,
                        High->RoundsPlayed);
                return RetChar;
            case 1:
                sprintf(RetChar, "Server Record: %s has lost %lu ships playing Renegade Comet Busters.",
                        High->PlayerName, High->Deaths);
                return RetChar;
            case 2:
                sprintf(RetChar, "Server Record: %s has destroyed %lu small comets.", High->PlayerName,
                        High->CometSmall);
                return RetChar;
            case 3:
                sprintf(RetChar, "Server Record: %s has destroyed %lu medium comets.", High->PlayerName,
                        High->CometMedium);
                return RetChar;
            case 4:
                sprintf(RetChar, "Server Record: %s has destroyed %lu large comets.", High->PlayerName,
                        High->CometLarge);
                return RetChar;
            case 5:
                sprintf(RetChar, "Server Record: %s has destroyed %lu huge comets.", High->PlayerName, High->CometHuge);
                return RetChar;
            case 6:
                sprintf(RetChar, "Server Record: %s has destroyed the moon %lu times.", High->PlayerName,
                        High->TheMoon);
                return RetChar;
            case 7:
                sprintf(RetChar, "Server Record: %s has destroyed %lu UFOs.", High->PlayerName, High->UFO);
                return RetChar;
            case 8:
                sprintf(RetChar, "Server Record: %s has destroyed %lu Mines.", High->PlayerName, High->Mine);
                return RetChar;
            case 9:
                sprintf(RetChar, "Server Record: %s has killed %lu other players.", High->PlayerName,
                        High->OtherPlayers);
                return RetChar;
            case 10:
                sprintf(RetChar,
                        "Server Record: %s has scored %lu points playing Renegade Comet Busters in a single round.",
                        High->PlayerName, High->HighestScore);
                return RetChar;
            case 11:
                sprintf(RetChar, "Server Record: %s has scored a total of %lu points playing Renegade Comet Busters.",
                        High->PlayerName, High->TotalScore);
                return RetChar;
            case 12:
                sprintf(RetChar, "Server Record: %s has made it to level %lu in Renegade Comet Busters.",
                        High->PlayerName, High->HighestLevel);
                return RetChar;
            case 13:
                sprintf(RetChar, "Server Record: %s has destroyed %lu comets total.", High->PlayerName,
                        High->TotalComets);
                return RetChar;
            case 14:
                sprintf(RetChar, "Server Record: %s has acquired %lu Highly Explosive Warhead powerups.",
                        High->PlayerName, High->HEWPowerups);
                return RetChar;
            case 15:
                sprintf(RetChar, "Server Record: %s has used %lu Highly Explosive Warheads.", High->PlayerName,
                        High->HEWUsed);
                return RetChar;
            case 16:
                sprintf(RetChar, "Server Record: %s has fired a total of %lu rounds.", High->PlayerName,
                        High->RoundsFired);
                return RetChar;
            case 17:
                sprintf(RetChar, "Server Record: %s has made it to level %lu through teamwork.", High->PlayerName,
                        High->TeamHighestLevel);
                return RetChar;
            case 18:
                sprintf(RetChar, "Server Record: %s has given %lu lives to other players.", High->PlayerName,
                        High->GrantedOtherPlayersLives);
                return RetChar;
            case 19:
                sprintf(RetChar, "Server Record: %s has received %lu lives from other players.", High->PlayerName,
                        High->ReceivedOtherPlayersLives);
                return RetChar;
            case 20:
                sprintf(RetChar, "Server Record: %s has destroyed %lu cargo ships.", High->PlayerName, High->CargoShip);
                return RetChar;
            case 21:
                sprintf(RetChar, "Server Record: %s has acquired %lu extra lives.", High->PlayerName,
                        High->NewLivesAcquired);
                return RetChar;
            case 22:
                sprintf(RetChar, "Server Record: %s has rammed %lu objects.", High->PlayerName, High->ObjectsRammed);
                return RetChar;
            case 23:
                sprintf(RetChar, "Server Record: %s has acquired %lu SOS Beacon powerups.", High->PlayerName,
                        High->SOSBeacons);
                return RetChar;
            case 24:
                sprintf(RetChar, "Server Record: %s has acquired %lu power cell powerups.", High->PlayerName,
                        High->PowerPowerups);
                return RetChar;
            case 25:
                sprintf(RetChar, "Server Record: %s has acquired %lu extra life powerups.", High->PlayerName,
                        High->ExtraLifePowerups);
                return RetChar;
            case 26:
                sprintf(RetChar, "Server Record: %s has deployed %lu SOS Beacons.", High->PlayerName,
                        High->UsedSOSBeacons);
                return RetChar;
            case 27:
                sprintf(RetChar, "Server Record: %s has acquired %lu points powerups.", High->PlayerName,
                        High->PointPowerups);
                return RetChar;
            case 28:
                sprintf(RetChar, "Server Record: %s has %lu points from powerups.", High->PlayerName,
                        High->PowerupPoints);
                return RetChar;
            case 29:
                sprintf(RetChar, "Server Record: %s has acquired %lu Drones.", High->PlayerName, High->PickedUpDrone);
                return RetChar;
            case 30:
                sprintf(RetChar, "Server Record: %s has launched %lu Drones.", High->PlayerName, High->UsedDrones);
                return RetChar;
            case 31:
                sprintf(RetChar, "Server Record: %s has destroyed %lu objects with Drones.", High->PlayerName,
                        High->DroneKills);
                return RetChar;
            case 32:
                sprintf(RetChar, "Server Record: %s has destroyed %lu Drones.", High->PlayerName, High->DronesKilled);
                return RetChar;
            case 33:
                sprintf(RetChar, "Server Record: %s has scored %lu points with Drones.", High->PlayerName,
                        High->DronePoints);
                return RetChar;
            case 34:
                sprintf(RetChar, "Server Record: %s has acquired %lu power regen powerups.", High->PlayerName,
                        High->RegenPowerups);
                return RetChar;
            case 35:
                sprintf(RetChar, "Server Record: %s has acquired %lu double points powerups.", High->PlayerName,
                        High->DoublePointsPowerups);
                return RetChar;
            case 36:
                sprintf(RetChar, "Server Record: %s has scored %lu points from double points powerups.",
                        High->PlayerName, High->DoublePointsPoints);
                return RetChar;
            case 37:
                sprintf(RetChar, "Server Record: %s has acquired %lu hyperspace recharges.", High->PlayerName,
                        High->DeerPowerups);
                return RetChar;
            case 38:
                sprintf(RetChar, "Server Record: %s has spent %.0lf minutes cloaked.", High->PlayerName,
                        High->TimeCloaked / 60.0f);
                return RetChar;
            case 39:
                sprintf(RetChar, "Server Record: %s has cloaked %lu times.", High->PlayerName, High->ShipCloakedCount);
                return RetChar;
            case 40:
                sprintf(RetChar, "Server Record: %s has spent %.0lf minutes with shields up.", High->PlayerName,
                        High->TimeShielded / 60.0f);
                return RetChar;
            case 41:
                sprintf(RetChar, "Server Record: %s has raised their shield %lu times.", High->PlayerName,
                        High->ShieldRaisedCount);
                return RetChar;
            case 42:
                sprintf(RetChar, "Server Record: %s has ran out of power %lu times.", High->PlayerName,
                        High->RanOutOfPowerCount);
                return RetChar;
            case 43:
                sprintf(RetChar, "Server Record: %s has scored %lu points by calling in Galatic Cargo Ships.",
                        High->PlayerName, High->CargoShipScore);
                return RetChar;
            case 44:
                sprintf(RetChar, "Server Record: %s has destroyed %lu objects with Galatic Cargo Ships.",
                        High->PlayerName, High->CargoShipKills);
                return RetChar;
            case 45:
                sprintf(RetChar, "Server Record: %s jumped out of danger %lu times.", High->PlayerName,
                        High->JumpsUsed);
                return RetChar;
            case 46:
                sprintf(RetChar, "Server Record: %s has acquired %lu Drones Swarm Transmission Codes.",
                        High->PlayerName, High->PickedUpDroneSwarm);
                return RetChar;
            case 47:
                sprintf(RetChar, "Server Record: %s has used %lu Drones Swarm Transmission Codes.", High->PlayerName,
                        High->UsedDronesSwarm);
                return RetChar;
            case 48:
                sprintf(RetChar, "Server Record: %s has used the disrupter for %.0lf minutes.", High->PlayerName,
                        High->TimeDisrupted / 60.0f);
                return RetChar;
            case 49:
                sprintf(RetChar, "Server Record: %s has used the disrupter for %lu minutes.", High->PlayerName,
                        High->UpgadedWeaponPowerups);
                return RetChar;
            case 50:
                sprintf(RetChar, "Server Record: %s has acquired %lu weapon upgrade powerups.", High->PlayerName,
                        High->UpgadedWeaponPowerups);
                return RetChar;
            case 51:
                sprintf(RetChar, "Server Record: %s has gained a total score of %lu without any special abilities.",
                        High->PlayerName, High->HighestCleanScore);
                return RetChar;
            case 52:
                sprintf(RetChar, "Server Record: %s has acquired a team score of %lu without any special abilities.",
                        High->PlayerName, High->HighestCleanTeamScore);
                return RetChar;
            case 53:
                sprintf(RetChar, "Server Record: %s has made it to level %lu without any special abilities.",
                        High->PlayerName, High->HighestCleanLevel);
                return RetChar;
            case 54:
                sprintf(RetChar,
                        "Server Record: %s has made it to level %lu with teamwork and without any special abilities.",
                        High->PlayerName, High->HighestCleanTeamLevel);
                return RetChar;
            case 55:
                sprintf(RetChar, "Server Record: %s has acquired a team score of %lu.", High->PlayerName,
                        High->HighestTeamScore);
                return RetChar;
            case 56:
                sprintf(RetChar, "Server Record: %s has played %lu levels with special abilities.", High->PlayerName,
                        High->LevelsPlayedWithPerks);
                return RetChar;
            case 57:
                sprintf(RetChar, "Server Record: %s has played %lu levels without special abilities.", High->PlayerName,
                        High->LevelsPlayedWithOutPerks);
                return RetChar;
            case 58:
                sprintf(RetChar, "Server Record: %s has played %lu levels with a team using perks.", High->PlayerName,
                        High->LevelsPlayedWithPerksAsATeam);
                return RetChar;
            case 59:
                sprintf(RetChar, "Server Record: %s has played %lu levels with a team not using perks.",
                        High->PlayerName, High->LevelsPlayedWithOutPerksAsATeam);
                return RetChar;
            default:
                sprintf(RetChar,
                        "Server Record: %s has played Renegade Comet Busters for %.0lf minutes on this server.",
                        High->PlayerName, High->PlayTime / 60.0f);
                return RetChar;
        }
    }
...
enum ObjectType {
    ...
    MineBoss = 11,
    PlayerDrone = 12,
    PlayerDroneShield = 13,
    PlayerShipJumpable = 14,
    PlayerShipJumping = 15,
    PlayerShipDisrupter = 16
};
...
public:
    ...
    bool DoesCollide(AnObject *Obj, AnObject *OtherObj) {
        ...
        if (Obj->Type == CargoShip && OtherObj->Type == TheMoon) {
            if (JmgUtility::SimpleDistance(Commands->Get_Position(Hitter), Commands->Get_Position(Other)) <=
                Obj->Size + OtherObj->Size - 225.0f) {
        ...
        if (JmgUtility::SimpleDistance(Commands->Get_Position(Hitter), Commands->Get_Position(Other)) <=
            ...
            if (Obj->Type == TheMoon || Obj->Type == CargoShip) {
                ...
                if (OtherObj->Type != PlayerShield && OtherObj->Type != PlayerSuper &&
                    OtherObj->Type != PlayerDroneShield && OtherObj->Type != TheMoon)
                    SpecialApplyDamage(Other, 99999.9f, "BlamoKiller", Hitter);
                else if (Obj->Type == NormalPlayerShip || Obj->Type == PlayerCloak || Obj->Type == PlayerShipJumpable ||
                         Obj->Type == PlayerShipDisrupter)
                    Commands->Send_Custom_Event(Other, Other, 7043453, 33, 0.0f);
                else
                    Commands->Send_Custom_Event(Other, Other, 7043453, 5, 0.0f);
                if (Obj->Type != PlayerShield && Obj->Type != PlayerSuper && Obj->Type != PlayerDroneShield &&
                    OtherObj->Type != TheMoon)
                    SpecialApplyDamage(Hitter, 99999.9f, "BlamoKiller", Other);
                else if (OtherObj->Type == NormalPlayerShip || OtherObj->Type == PlayerCloak ||
                         OtherObj->Type == PlayerShipJumpable || OtherObj->Type == PlayerShipDisrupter)
    ...
    void UpdateCollisions() {
        ...
        while (Current) {
            if (!Current->AllowReplaceTime) {
                if (Current->Type == CargoShip || Current->Type == TheMoon || Current->Type == NormalPlayerShip ||
                    Current->Type == PlayerShield || Current->Type == PlayerCloak || Current->Type == PlayerSuper ||
                    Current->Type == PlayerShipJumpable || Current->Type == PlayerShipDisrupter) {
                    AnObject *OtherObjs = ObjectsList;
                    while (OtherObjs) {
                        if (Current->Type == CargoShip && OtherObjs->Type == TheMoon)
                            DoesCollide(Current, OtherObjs);
                        else if (!OtherObjs->AllowReplaceTime &&
                                 (OtherObjs->Type != PlayerDrone && OtherObjs->Type != PlayerDroneShield) ||
                                 (Current->Type == CargoShip || Current->Type == TheMoon))
                            if (Current != OtherObjs && OtherObjs->Type != TheMoon && OtherObjs->Type != CargoShip &&
                                OtherObjs->Type != CMTPowerup)
                    ...
                    AnObject *OtherObjs = ObjectsList;
                    while (OtherObjs) {
                        if (!OtherObjs->AllowReplaceTime &&
                            (Current != OtherObjs && OtherObjs->Type != NormalPlayerShip &&
                             OtherObjs->Type != PlayerShipJumpable && OtherObjs->Type != PlayerShield &&
                             OtherObjs->Type != PlayerCloak && OtherObjs->Type != PlayerSuper &&
                             OtherObjs->Type != CMTPowerup && OtherObjs->Type != PlayerShipDisrupter))
                            if (DoesCollide(Current, OtherObjs)) {
                                Current = Current->next;
                    ...
                    while (OtherObjs) {
                        if (!OtherObjs->AllowReplaceTime &&
                            (OtherObjs->Type == NormalPlayerShip || OtherObjs->Type == PlayerShield ||
                             OtherObjs->Type == PlayerCloak || OtherObjs->Type == PlayerSuper ||
                             OtherObjs->Type == PlayerShipJumpable || OtherObjs->Type == PlayerShipDisrupter))
    ...
    float FindNearestCollidableObject(GameObject *Obj, const Vector3 &Position) {
        ...
        while (Current) {
            if (!Current->AllowReplaceTime && Obj != Current->Object && Current->Type != CMTPowerup &&
                Current->Type != PlayerDrone && Current->Type != PlayerDroneShield) {
                float Dist =
                        JmgUtility::SimpleDistance(Position, Commands->Get_Position(Current->Object)) - Current->Size;
                if (!Closest) {
                    Closest = Current;
                    MinDist = Dist;
    ...
    int AllowShipSpawn(int PlayerNumber, Vector3 SpawnSpots[MaxGamePlayerCount]) {
        ...
        while (Current) {
            if (!Current->AllowReplaceTime) {
                float Temp = JmgUtility::SimpleDistance(SpawnSpots[PlayerNumber],
                                                        Commands->Get_Position(Current->Object));
    ...
    bool CheckIfLevelComplete() {
        AnObject *Current = ObjectsList;
        while (Current) {
            if (Current->AllowReplaceTime <= 0 &&
                (Current->Type == Asteroid || Current->Type == UFOBoss || Current->Type == TheMoon ||
                 Current->Type == MineBoss))
                return false;
            Current = Current->next;
        }
        return true;
    ...
    void GrantScoreToKiller(GameObject *killer, float Score, ObjectType Type, int Size = 0) {
        ...
        if (!Commands->Is_A_Star(Driver) && !Commands->Is_A_Star(killer)) {
            ...
            if (PresetID == PLAYERDRONE_ID) {// Killer was a player's drone
                    ...
                    for (int y = 0; y < 2; y++)
                        if (MiniGamePlayerControlSystem[x].Drones[y] == ID) {
                            ...
                            RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                                    MiniGamePlayerControlSystem[x].PlayerID)->DroneKills++;
                            killer = Commands->Find_Object(MiniGamePlayerControlSystem[x].GamePlayerID);
                            x = MaxGamePlayerCount + 1;
                            break;
                        }
            } else if (PresetID == CARGOSHIPTURRET_ID) {// Killer was a Cargo Ships Turret
                int ID = Commands->Get_ID(killer);
                for (int x = 0; x < MaxGamePlayerCount; x++)
                    for (int y = 0; y < 6; y++)
                        if (MiniGamePlayerControlSystem[x].CargoShipIDs[y] == ID) {
                            ...
                            RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                                    MiniGamePlayerControlSystem[x].PlayerID)->CargoShipKills++;
                            killer = Commands->Find_Object(MiniGamePlayerControlSystem[x].GamePlayerID);
                            x = MaxGamePlayerCount + 1;
                            break;
                        }
            } else if (PresetID == CARGOSHIP_ID) {// Killer was a Cargo Ship
                int ID = Commands->Get_ID(killer);
                for (int x = 0; x < MaxGamePlayerCount; x++)
        ...
        for (int x = 0; x < MaxGamePlayerCount; x++) {
            ...
            if (Player == killer) {
                if (MiniGamePlayerControlSystem[x].DoublePointsTime) {
                    RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                            Get_Player_ID(Player))->DoublePointsPoints += (int) Score;
                    Score *= 2;
                }
                ...
                switch (Type) {
                    ...
                    case PlayerShipJumping:
                        RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                                Get_Player_ID(Player))->OtherPlayers++;
                        break;
                    case UFO:
                    case UFOBoss:
                        RenCometBustersScoreControl.Get_Current_Player_Score_Node(Get_Player_ID(Player))->UFO++;
                        break;
                    case Mine:
                    case MineBoss:
                        RenCometBustersScoreControl.Get_Current_Player_Score_Node(Get_Player_ID(Player))->Mine++;
                        break;
                    case Asteroid:
                        ...
                        switch (Size) {
                            case 0:
                                RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                                        Get_Player_ID(Player))->CometSmall++;
                                break;
                            case 1:
                                RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                                        Get_Player_ID(Player))->CometMedium++;
                                break;
                            case 2:
                                RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                                        Get_Player_ID(Player))->CometLarge++;
                                break;
                            default:
                                RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                                        Get_Player_ID(Player))->CometHuge++;
                                break;
                        }
                        break;
                    case TheMoon:
                        RenCometBustersScoreControl.Get_Current_Player_Score_Node(Get_Player_ID(Player))->TheMoon++;
                        break;
                    case CargoShip:
                        RenCometBustersScoreControl.Get_Current_Player_Score_Node(Get_Player_ID(Player))->CargoShip++;
                        break;
                    case PlayerDrone:
                    case PlayerDroneShield:
                        RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                                Get_Player_ID(Player))->DronesKilled++;
                        break;
                    case CMTPowerup:
                        break;
                }
            ...
            if (Player == Driver) {// shield or ram kill
                if (MiniGamePlayerControlSystem[x].DoublePointsTime) {
                    RenCometBustersScoreControl.Get_Current_Player_Score_Node(
                            Get_Player_ID(Player))->DoublePointsPoints += (int) Score;
                    Score *= 2;
    ...
    AnObject *FindMineTarget(GameObject *obj, int *MinDistance) {
        ...
        AnObject *Current = ObjectsList;
        while (Current) {
            if (!Current->AllowReplaceTime && Current->Object != obj &&
                (Current->Type != PlayerCloak && Current->Type != Asteroid && Current->Type != TheMoon &&
                 Current->Type != CMTPowerup)) {
                ...
                if (TempDistance <= 22500) {
                    if (!Target) {
                        ...
                        if (TempPriority > PrioritizeTargets[TargetType]) {
                            ...
                            if ((Current->Type == Mine || Current->Type == MineBoss) &&
                                TempDistance > NearestDistance) {
                                Target = Current;
                                TargetType = Current->Type;
                                NearestDistance = TempDistance;
                            } else if ((Current->Type != Mine && Current->Type != MineBoss) &&
                                       TempDistance < NearestDistance) {
                                Target = Current;
                                TargetType = Current->Type;
                                NearestDistance = TempDistance;
    ...
    void KillInRange(GameObject *Player, const Vector3 &Position, float MinRange, float MaxRange) {
        ...
        while (Current) {
            if (!Current->AllowReplaceTime &&
                (Current->Type == Asteroid || Current->Type == UFO || Current->Type == UFOBoss ||
                 Current->Type == PlayerDrone || Current->Type == Mine || Current->Type == MineBoss ||
                 Current->Type == PlayerCloak || Current->Type == NormalPlayerShip ||
                 Current->Type == PlayerShipJumpable || Current->Type == PlayerShipDisrupter)) {
    ...
    int FindDroneAvoidObjectInRange(GameObject *Obj, Vector3 *Position, float Range, float *_MinDist) {
        ...
        while (Current) {
            ...
            if (Target && !Current->AllowReplaceTime &&
                (Obj != Target && Current->Type != PlayerDrone && Current->Type != PlayerDroneShield &&
                 Current->Type != CMTPowerup && Current->Type != NormalPlayerShip && Current->Type != PlayerShield &&
                 Current->Type != PlayerCloak && Current->Type != PlayerSuper && Current->Type != PlayerShipJumpable &&
    ...
    GameObject *CheckForDroneTarget(GameObject *Obj, const Vector3 &Position, float *TargetSize) {
        ...
        AnObject *Current = ObjectsList, *Closest = NULL;
        while (Current) {
            if (!Current->AllowReplaceTime && Obj != Current->Object && Current->Type != TheMoon &&
                Current->Type != CMTPowerup && Current->Type != CargoShip && Current->Type != PlayerDrone &&
                Current->Type != PlayerDroneShield && Current->Type != NormalPlayerShip &&
                Current->Type != PlayerShield && Current->Type != PlayerCloak && Current->Type != PlayerSuper &&
                Current->Type != PlayerShipJumpable && Current->Type != PlayerShipDisrupter) {
                float Dist =
                        JmgUtility::SimpleDistance(Position, Commands->Get_Position(Current->Object)) - Current->Size;
...
Vector3 Random_Map_Position() {
    ...
    return Vector3((!Random ? (Commands->Get_Random(0.0, 1.0f) < 0.5 ? 1 : -1) * Commands->Get_Random(75.0f, 80.0f)
                            : Commands->Get_Random(-80.0f, 80.0f)),
                   (Random ? (Commands->Get_Random(0.0, 1.0f) < 0.5 ? 1 : -1) * Commands->Get_Random(75.0f, 80.0f)
                           : Commands->Get_Random(-80.0f, 80.0f)), 0.5);
}

class JMG_CMTB_Main_Game_Control : public ScriptImpClass {
    enum MusicType {
        MusicNone = 0, MusicGameOver = 1, MusicNormal = 2, MusicBoss = 3
    };
    int NextLevelDelay;
    int UFOSpawnTime;
...
class JMG_CMTB_Player_Drone : public ScriptImpClass {
    enum AI_State {
        DroneIdle = 0, DroneGuarding = 1, DroneAvoiding = 2, DroneAttacking = 3, DroneReturning = 4
    };
