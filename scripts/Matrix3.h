...
operator*(const Matrix3 &a, float d) {
    return Matrix3(a.Row[0] * d, a.Row[1] * d, a.Row[2] * d);
}

TT_INLINE Matrix3

operator*(float d, const Matrix3 &a) {
    return a * d;
}
...
Create_X_Rotation_Matrix3(float s, float c) {
    Matrix3 mat;
    mat[0][0] = 1.0f;
    mat[0][1] = 0.0f;
    mat[0][2] = 0.0f;
...
Create_Y_Rotation_Matrix3(float s, float c) {
    Matrix3 mat;
    mat[0][0] = c;
    mat[0][1] = 0.0f;
    mat[0][2] = s;
...
Create_Y_Rotation_Matrix3(float rad) {
    return Create_Y_Rotation_Matrix3(sinf(rad), cosf(rad));
}

TT_INLINE Matrix3

Create_Z_Rotation_Matrix3(float s, float c) {
    Matrix3 mat;
    mat[0][0] = c;
    mat[0][1] = -s;
    mat[0][2] = 0.0f;
...
Create_Z_Rotation_Matrix3(float rad) {
