...
#else
REF_DEF3(PointerRemapClass, SaveLoadSystemClass::PointerRemapper,
0x00830398, 0x0082F580, 0x008B5D70);
REF_DEF3(PersistFactoryClass
*, SaveLoadSystemClass::_FactoryListHead, 0x008303E8, 0x0082F5D0, 0x008B5DC0);
REF_DEF3(SaveLoadSubSystemClass
*, SaveLoadSystemClass::_SubSystemListHead, 0x008303E4, 0x0082F5CC, 0x008B5DBC);
#endif
