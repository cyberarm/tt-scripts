...
inline const char *GetCollisionGroupName(Collision_Group_Type group) {
    switch (group) {
        case DEFAULT_COLLISION_GROUP:
            return "Default";
        case UNCOLLIDEABLE_GROUP:
            return "Uncollideable";
        case TERRAIN_ONLY_COLLISION_GROUP:
            return "Terrain-only";
        case BULLET_COLLISION_GROUP:
            return "Bullet";
        case TERRAIN_AND_BULLET_COLLISION_GROUP:
            return "Terrain and Bullet";
        case BULLET_ONLY_COLLISION_GROUP:
            return "Bullet-only";
        case SOLDIER_COLLISION_GROUP:
            return "Soldier";
        case SOLDIER_GHOST_COLLISION_GROUP:
            return "Soldier-ghost";
        case UNDERGROUND_COLLISION_GROUP:
            return "Underground";
        case SOLDIER_ONLY_COLLISION_GROUP:
            return "Soldier-only";
        case SOLDIER_BULLET_COLLISION_GROUP:
            return "Soldier-bullet";
        case TERRAIN_COLLISION_GROUP:
            return "Terrain";
        case WATER_SURFACE_COLLISION_GROUP:
            return "Water Surface";
        case WATER_EDGE_COLLISION_GROUP:
            return "Water Edge (Block)";
        case WATER_EDGE_ALT_COLLISION_GROUP:
            return "Water Edge (Allow)";
        case BEACH_EDGE_COLLISION_GROUP:
            return "Beach Edge";
        case NAVAL_UNIT_COLLISION_GROUP:
            return "Naval Unit";
        case BEACHING_UNIT_COLLISION_GROUP:
            return "Beaching Unit";
        case HOVER_UNIT_COLLISION_GROUP:
            return "Hover Unit";
        case AMPHIBIOUS_UNIT_COLLISION_GROUP:
            return "Amphibious Unit";
        case AMPHIBIOUS_UNIT_FLOOR_COLLISION_GROUP:
            return "Amphibious Unit Floor";
        case UNDERGROUND_TRANSITION_COLLISION_GROUP:
            return "Underground Transition";
        case DEFAULT_AND_SOLDIER_ONLY_COLLISION_GROUP:
            return "Default and Soldier only";
        case PLAYER_BUILDING_COLLISION_GROUP:
            return "Player Building";
        case PLAYER_BUILDING_GHOST_COLLISION_GROUP:
            return "Player Building Ghost";
        case TRAIN_COLLISION_GROUP:
            return "Train";
        case TRAIN_TRACK_COLLISION_GROUP:
            return "Train Track";
        default:
            return NULL; // NULL == do not add to friendly name list
    };
};
