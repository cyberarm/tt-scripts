...
public:
    ...
    const PhysicalGameObjDef SCRIPTS_API
    &
    ...
    *
    ...
    virtual DamageableGameObj *
    As_DamageableGameObj(void) { return this; }        // Re-implement for CombatPhysObserverClass
    ...
    void Clear_Animation() {
        if (AnimControl) {
            AnimControl->Set_Animation((const char *) NULL, 0, 0);
    ...
    void Set_Team_Visibility(TeamVisibilitySetting setting) {
        TeamVisibility = (char) setting;
        Set_Object_Dirty_Bit(NetworkObjectClass::BIT_RARE, true);
    }
