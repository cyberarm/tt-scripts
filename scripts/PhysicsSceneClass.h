...
public:
    ...
    SCRIPTS_API void
    Collect_Objects(const OBBoxClass &box, bool static_objs, bool dynamic_objs, MultiListClass<PhysClass> *list);

    void
    Collect_Objects(const FrustumClass &frustum, bool static_objs, bool dynamic_objs, MultiListClass<PhysClass> *list);
    ...
    void
    Collect_Lights(const AABoxClass &bounds, bool static_lights, bool dynamic_lights, MultiListClass<PhysClass> *list);
    ...
    VisSampleClass Update_Vis(const Vector3 &sample_point, const Matrix3D &camera, VisDirBitsType direction_bits,
...
protected:
    ...
    void Render_Objects(RenderInfoClass &rinfo, RefMultiListClass<PhysClass> *static_ws_list,
                        RefMultiListClass<PhysClass> *static_list, RefMultiListClass<PhysClass> *dyn_list);

    void Render_Object(RenderInfoClass &context, PhysClass *obj);

    void Render_Backface_Occluders(RenderInfoClass &context, RefMultiListClass<PhysClass> *static_ws_list,
                                   RefMultiListClass<PhysClass> *static_list);

    void Optimize_LODs(CameraClass &camera, RefMultiListClass<PhysClass> *dyn_obj_list,
                       RefMultiListClass<PhysClass> *static_obj_list,
                       RefMultiListClass<PhysClass> *static_ws_mesh_list);
...
protected:
    ...
    float
    Compute_Projector_Attenuation(TexProjectClass *dynamic_projector, const Vector3 &view_pos, const Vector3 &view_dir);
