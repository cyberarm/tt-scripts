...
class PurchaseSettingsDefClass abstract

: public DefinitionClass, public NetworkObjectClass  {
public:
enum TEAM {
    TEAM_GDI,
    TEAM_NOD,
...
static SCRIPTS_API PurchaseSettingsDefClass
*
Find_Definition(TYPE
type,
TEAM team
);
#ifdef DDBEDIT
