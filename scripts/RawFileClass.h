    ...
    int Open(int mode) {
        ...
        switch (Rights) {
            case 2:
                ...
                break;
            case 1:
                Handle = CreateFileA(Filename, GENERIC_READ, FILE_SHARE_READ, 0, OPEN_EXISTING,
                                     FILE_ATTRIBUTE_NORMAL | FILE_FLAG_SEQUENTIAL_SCAN, 0);
                break;
            case 0:
                Handle = CreateFileA(Filename, GENERIC_READ | GENERIC_WRITE, 0, 0, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL,
                                     0);
                break;
            default:
                errno = EINVAL;
