...
public:
    ...
    const ScriptableGameObjDef SCRIPTS_API
    &
    ...
    void SCRIPTS_API
    Add_Observer( GameObjObserverClass
    * observer );
    void SCRIPTS_API
    Remove_Observer( GameObjObserverClass
    * observer );
    SCRIPTS_API GameObjObserverClass
    *

    Find_Observer(const char *Name);
    ...
    void SCRIPTS_API
    Insert_Observer( GameObjObserverClass
    * observer );
