...
public:
    ...
    const SmartGameObjDef SCRIPTS_API
    &
    ...
    bool SCRIPTS_API
    Is_Obj_Visible( PhysicalGameObj
    *obj );
    bool SCRIPTS_API
    Is_Splash_Possible( PhysicalGameObj
    *obj );
    ...
    void Set_Stealth_Active(bool active) {
