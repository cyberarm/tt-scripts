...
void TDBObjClass::Set_ID(uint32
ID)
{
...
const WideStringClass &TDBObjClass::Get_String(uint32
language)
{
...
void TDBObjClass::Set_String(uint32
language,
const wchar_t *string
)
{
while (TranslatedStrings.
...
bool TDBObjClass::Contains_Translation(uint32
language)
{
if ((int)language<TranslatedStrings.

Count()

)
{
return TranslatedStrings[language].
