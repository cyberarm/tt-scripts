...
TT_INLINE TDBObjClass
*

TranslateDBClass::Find_Object(const char *id) {
    TT_ASSERT(Is_Loaded());
...
TT_INLINE TDBObjClass
*
TranslateDBClass::Find_Object(uint32
id)
{
TT_ASSERT (Is_Loaded());

int index = id - ID_MIN;
if (index >= 0 && index<m_ObjectList.
