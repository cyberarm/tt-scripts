...
public:
    ...
    void Update_Muzzle_Flash(bool flashA0, bool flashA1, bool flashB0, bool flashB1) {
        MuzzleFlash.Update(flashA0, flashA1, flashB0, flashB1);
    }
...
private:
    ...
    void sendClientAmmoAcrossNetwork(int originalPlayerId, int reloadingObjectId, int weaponId, int clipRounds,
                                     int backpackRounds);
