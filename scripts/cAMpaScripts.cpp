...
void cAMpa_Teleport_Zone_Small::Entered(GameObject *obj, GameObject *enterer) {
    if (The_Game()->Get_Current_Players() < 11) {
        ...
        char input[256];
        sprintf(input, "ppage %d There are currently more then 10 Players, please use the other Teleporter.",
                Get_Player_ID(enterer));
        Console_Input(input);
    }
}
...
void cAMpa_Teleport_Zone_Large::Entered(GameObject *obj, GameObject *enterer) {
    if (The_Game()->Get_Current_Players() >= 11) {
        ...
        char input[256];
        sprintf(input, "ppage %d There are currently less then 10 Players, please use the other Teleporter.",
                Get_Player_ID(enterer));
        Console_Input(input);
    }
}

ScriptRegistrant<cAMpa_Teleport_Zone_Large> cAMpa_Teleport_Zone_Large_Registrant("cAMpa_Teleport_Zone_Large",
                                                                                 "Location1:vector3,Location2:vector3,Location3:vector3,Location4:vector3,Location5:vector3,Location6:vector3,Location7:vector3,Location8:vector3,Location9:vector3,Location10:vector3");
ScriptRegistrant<cAMpa_Teleport_Zone_Small> cAMpa_Teleport_Zone_Small_Registrant("cAMpa_Teleport_Zone_Small",
                                                                                 "Location1:vector3,Location2:vector3,Location3:vector3,Location4:vector3,Location5:vector3");
