...
public:
    ...
    RayCollisionTestClass(const LineSegClass &ray, CastResultStruct *res,
                          Collision_Type collision_type = COLLISION_TYPE_0, bool ignore_translucent_meshes = false);
...
inline RayCollisionTestClass::RayCollisionTestClass(const LineSegClass &ray, CastResultStruct *res,
                                                    Collision_Type collision_type, bool ignore_translucent_meshes) :
...
class SCRIPTS_API AABoxCollisionTestClass
...
AABoxCollisionTestClass(const AABoxClass &aabox, const Vector3 &move, CastResultStruct *res,
                        Collision_Type collision_type = COLLISION_TYPE_0);
...
class SCRIPTS_API OBBoxCollisionTestClass
...
OBBoxCollisionTestClass(const OBBoxClass &obbox, const Vector3 &move, CastResultStruct *res,
                        Collision_Type type = COLLISION_TYPE_0);
