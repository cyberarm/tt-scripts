...
public:
    ...
    SCRIPTS_API static DataSafeEntryClass
    *
    Get_Entry(DataSafeHandleClass
    handle);
    SCRIPTS_API static

    int Get_Entry_Type(DataSafeHandleClass handle);
    ...
    void Dump_Safe_Stats(char *dump_buffer, int buffer_size);

    SCRIPTS_API static

    void Print_Safe_Stats_To_Debug_Output(void);
...
protected:
    ...
    *
    ...
    Get_Entry_By_Index(int list, int index);

    SCRIPTS_API static

    void Shuffle(bool forced = false);

    SCRIPTS_API static

    void Swap_Entries(DataSafeEntryClass *first, DataSafeEntryClass *second, int type);

    SCRIPTS_API static

    void Encrypt(void *data, int size, unsigned long key = SimpleKey, bool do_checksum = true);

    SCRIPTS_API static

    void Decrypt(void *data, int size, unsigned long key = SimpleKey, bool do_checksum = true);

    SCRIPTS_API static

    void Mem_Copy_Encrypt(void *dest, void *src, int size, bool do_checksum);

    SCRIPTS_API static

    void Mem_Copy_Decrypt(void *dest, void *src, int size, bool do_checksum);
    ...
    void Say_Security_Fault(void);

    SCRIPTS_API static

    int Get_Random_List_For_Insertion(int type);

    SCRIPTS_API static

    void Random_Insertion(DataSafeEntryClass *entry, int list, int type, bool is_slop = false);

    SCRIPTS_API static

    int Create_Safe_List(int type);

    SCRIPTS_API static

    int Get_Handle_ID(int list);

    SCRIPTS_API static

    void Remove_From_List(int list, DataSafeEntryClass *entry_ptr);

    SCRIPTS_API static

    void Free_Handle_ID(int list, int id);
