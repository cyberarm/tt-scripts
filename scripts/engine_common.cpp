...
Console_Output(const char *Output, ...)
...
Console_Input(const char *Input) {
    if (strlen(Input) > 255) {
        return;
    }
...
const unsigned char Code[19] = {0x6A, 0x40, 0xFF, 0x74, 0x24, 0x0C, 0xFF, 0x74, 0x24, 0x0C, 0xE8, 0xC0, 0xFF, 0xFF,
                                0xFF, 0x83, 0xC4, 0x0C, 0xC3};
