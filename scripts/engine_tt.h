...
typedef int (*_Create_3D_WAV_Sound_At_Bone_Player)(GameObject *obj, const char *soundname, GameObject *obj2,
                                                   const char *bonename);

typedef int (*_Create_3D_Sound_At_Bone_Player)(GameObject *obj, const char *soundname, GameObject *obj2,
                                               const char *bonename);
...
typedef void (*dghi)(GameObject *obj, int EventID, const char *Sound, int TitleID, int TextID, int TextID2, int TextID3,
...
typedef cScTextObj *(*sct)(const WideStringClass &message, TextMessageEnum type, bool popup, int senderId,
                           int receiverId, bool dodirtybit, bool doact);

typedef SCAnnouncement *(*sca)(int _receiptientId, int _senderId, int _translationId, AnnouncementEnum _type,
                               int _emoticonId, bool dodirtybit, bool doact);
...
typedef bool (*trc)(const Vector3 &pos1, const Vector3 &pos2, const bool checkDynamicObjects, Vector3 *contactPoint,
...
typedef void (*grw)(GameObject *object, const char *GrantWeaponName, bool GrantWeapon, int GrantWeaponRounds,
...
typedef uint32(*gpd)(const Vector3 &start, const Vector3 &dest, PathfindDistanceCallback callback,
                     SmartGameObj *pathObj, void *data);

typedef uint32 (*gpda)(SmartGameObj *pathObj, const Vector3 &dest, PathfindDistanceCallback callback, void *data);

typedef bool(*gpdb)(SmartGameObj *pathObj, const Vector3 &dest, float &distanceResult,
                    PathfindDistanceResult &pathfindResult);
...
typedef int (*ssa)(GameObject *obj, const char *animation, bool looping, const char *subobject, float startFrame,
                   float endFrame, bool blended);

typedef void (*sts)(float scale);

typedef int (*ssap)(GameObject *player, GameObject *obj, const char *animation, bool looping, const char *subobject,
                    float startFrame, float endFrame, bool blended);

typedef int (*wfa)(const char *_FileName, const char *_Text);

SCRIPTS_API extern gpl
Get_Player_List;
SCRIPTS_API extern gcmi
Get_Current_Map_Index;
SCRIPTS_API extern gm
Get_Map;
SCRIPTS_API extern gmc
Get_Map_Count;
SCRIPTS_API extern smx
Set_Map;
SCRIPTS_API extern ggd
Get_Game_Definitions;
SCRIPTS_API extern ec
Evict_Client;
SCRIPTS_API extern gcsh
Get_Client_Serial_Hash;
SCRIPTS_API extern ggobpn
Get_GameObj_By_Player_Name;
SCRIPTS_API extern scap
Send_Custom_All_Players;
SCRIPTS_API extern stc
Steal_Team_Credits;
SCRIPTS_API extern gtc
Get_Team_Credits;
SCRIPTS_API extern sclb
Set_Current_Bullets;
SCRIPTS_API extern sclb
Set_Current_Clip_Bullets;
SCRIPTS_API extern spb
Set_Position_Bullets;
SCRIPTS_API extern spb
Set_Position_Clip_Bullets;
SCRIPTS_API extern sb
Set_Bullets;
SCRIPTS_API extern sb
Set_Clip_Bullets;
SCRIPTS_API extern dgh
Display_Game_Hint;
SCRIPTS_API extern dghi
Display_Game_Hint_Image;
SCRIPTS_API extern asn
AddShaderNotify;
SCRIPTS_API extern rsn
RemoveShaderNotify;
SCRIPTS_API extern ach
AddChatHook;
SCRIPTS_API extern ahh
AddHostHook;
SCRIPTS_API extern arh
AddRefillHook;
SCRIPTS_API extern ss
Set_Scope;
SCRIPTS_API extern aoch
AddObjectCreateHook;
SCRIPTS_API extern roch
RemoveObjectCreateHook;
SCRIPTS_API extern akh
AddKeyHook;
SCRIPTS_API extern rkh
RemoveKeyHook;
SCRIPTS_API extern gcmt
GetCurrentMusicTrack;
SCRIPTS_API extern allh
AddLoadLevelHook;
SCRIPTS_API extern allh
AddPreLoadLevelHook;
SCRIPTS_API extern allh
...
SCRIPTS_API extern allh
AddThinkHook;
SCRIPTS_API extern apjh
AddPlayerJoinHook;
SCRIPTS_API extern arch
AddRadioHook;
SCRIPTS_API extern asdh
AddStockDamageHook;
SCRIPTS_API extern atdh
AddTtDamageHook;
SCRIPTS_API extern aplh
AddPlayerLeaveHook;
SCRIPTS_API extern aph
AddPowerupPurchaseHook;
SCRIPTS_API extern aph
AddVehiclePurchaseHook;
SCRIPTS_API extern aph
AddCharacterPurchaseHook;
SCRIPTS_API extern apmh
AddPowerupPurchaseMonHook;
SCRIPTS_API extern apmh
AddVehiclePurchaseMonHook;
SCRIPTS_API extern apmh
AddCharacterPurchaseMonHook;
SCRIPTS_API extern rph
RemovePowerupPurchaseHook;
SCRIPTS_API extern rph
RemoveVehiclePurchaseHook;
SCRIPTS_API extern rph
RemoveCharacterPurchaseHook;
SCRIPTS_API extern rph
RemovePowerupPurchaseMonHook;
SCRIPTS_API extern rph
RemoveVehiclePurchaseMonHook;
SCRIPTS_API extern rph
RemoveCharacterPurchaseMonHook;
SCRIPTS_API extern sit
Set_Info_Texture;
SCRIPTS_API extern cit
Clear_Info_Texture;
SCRIPTS_API extern _Enable_Stealth_Player
Enable_Stealth_Player;
SCRIPTS_API extern _Set_Fog_Enable_Player
Set_Fog_Enable_Player;
SCRIPTS_API extern _Set_Fog_Range_Player
Set_Fog_Range_Player;
SCRIPTS_API extern _Set_Background_Music_Player
Set_Background_Music_Player;
SCRIPTS_API extern _Fade_Background_Music_Player
Fade_Background_Music_Player;
SCRIPTS_API extern _Stop_Background_Music_Player
Stop_Background_Music_Player;
SCRIPTS_API extern _Enable_Radar_Player
Enable_Radar_Player;
SCRIPTS_API extern _Display_GDI_Player_Terminal_Player
Display_GDI_Player_Terminal_Player;
SCRIPTS_API extern _Display_NOD_Player_Terminal_Player
Display_NOD_Player_Terminal_Player;
SCRIPTS_API extern _Set_Screen_Fade_Color_Player
Set_Screen_Fade_Color_Player;
SCRIPTS_API extern _Set_Screen_Fade_Opacity_Player
Set_Screen_Fade_Opacity_Player;
SCRIPTS_API extern _Force_Camera_Look_Player
Force_Camera_Look_Player;
SCRIPTS_API extern _Enable_HUD_Player
Enable_HUD_Player;
SCRIPTS_API extern _Create_Sound_Player
Create_Sound_Player;
SCRIPTS_API extern _Create_2D_Sound_Player
Create_2D_Sound_Player;
SCRIPTS_API extern _Create_2D_WAV_Sound_Player
Create_2D_WAV_Sound_Player;
SCRIPTS_API extern _Create_3D_WAV_Sound_At_Bone_Player
Create_3D_WAV_Sound_At_Bone_Player;
SCRIPTS_API extern _Create_3D_Sound_At_Bone_Player
Create_3D_Sound_At_Bone_Player;
SCRIPTS_API extern svl
Set_Vehicle_Limit;
SCRIPTS_API extern gvl
Get_Vehicle_Limit;
SCRIPTS_API extern svl
Set_Air_Vehicle_Limit;
SCRIPTS_API extern gvl
Get_Air_Vehicle_Limit;
SCRIPTS_API extern svl
Set_Naval_Vehicle_Limit;
SCRIPTS_API extern gvl
Get_Naval_Vehicle_Limit;
SCRIPTS_API extern sm
Send_Message;
SCRIPTS_API extern smp
Send_Message_Player;
SCRIPTS_API extern lnhi
Load_New_HUD_INI;
SCRIPTS_API extern rw
Remove_Weapon;
SCRIPTS_API extern crm
Change_Radar_Map;
SCRIPTS_API extern gbm
Get_Build_Time_Multiplier;
SCRIPTS_API extern scb
Set_Currently_Building;
SCRIPTS_API extern icb
Is_Currently_Building;
SCRIPTS_API extern acoh
AddConsoleOutputHook;
SCRIPTS_API extern acoh
AddLogFileHook;
SCRIPTS_API extern sfc
Set_Fog_Color;
SCRIPTS_API extern sfcp
Set_Fog_Color_Player;
SCRIPTS_API extern sfm
Set_Fog_Mode;
SCRIPTS_API extern sfmp
Set_Fog_Mode_Player;
SCRIPTS_API extern sfd
Set_Fog_Density;
SCRIPTS_API extern sfdp
Set_Fog_Density_Player;
SCRIPTS_API extern ctr
Change_Time_Remaining;
SCRIPTS_API extern ctl
Change_Time_Limit;
SCRIPTS_API extern dps
Display_Security_Dialog;
SCRIPTS_API extern shn
Send_HUD_Number;
SCRIPTS_API extern geo
GetExplosionObj;
SCRIPTS_API extern seo
SetExplosionObj;
SCRIPTS_API extern uno
Update_Network_Object;
SCRIPTS_API extern unop
Update_Network_Object_Player;
SCRIPTS_API extern sct
Send_Client_Text;
SCRIPTS_API extern sca
Send_Client_Announcement;
SCRIPTS_API extern spkm
Send_Player_Kill_Message;
SCRIPTS_API extern spr
Send_Purchase_Response;
SCRIPTS_API extern dod
Do_Objectives_Dlg;
SCRIPTS_API extern sl
Set_Player_Limit;
SCRIPTS_API extern gl
Get_Player_Limit;
SCRIPTS_API extern _Get_Fog_Range
Get_Fog_Range;
SCRIPTS_API extern sspp
Send_Shader_Param_Player; //dont use, use the other calls below instead
SCRIPTS_API extern ssp
Send_Shader_Param; //dont use, use the other calls below instead
SCRIPTS_API extern sspop
Send_Shader_Param_Obj_Player; //dont use, use the other calls below instead
SCRIPTS_API extern sspo
Send_Shader_Param_Obj; //dont use, use the other calls below instead
SCRIPTS_API extern ssn
Set_GDI_Soldier_Name;
SCRIPTS_API extern ssn
Set_Nod_Soldier_Name;
SCRIPTS_API extern gsnx
Get_GDI_Soldier_Name;
SCRIPTS_API extern gsnx
Get_Nod_Soldier_Name;
SCRIPTS_API extern Get_IP_Addressx
Get_IP_Address;
SCRIPTS_API extern Get_IP_Portx
Get_IP_Port;
SCRIPTS_API extern Get_IPx
Get_IP;
SCRIPTS_API extern Get_Bandwidthx
Get_Bandwidth;
SCRIPTS_API extern Get_Pingx
Get_Ping;
SCRIPTS_API extern Get_Kbitsx
Get_Kbits;
SCRIPTS_API extern sfop
Set_Fog_Override_Player;
SCRIPTS_API extern cfop
Clear_Fog_Override_Player;
SCRIPTS_API extern smie
Set_Moon_Is_Earth;
SCRIPTS_API extern smie
Set_Global_Stealth_Disable;
SCRIPTS_API extern gml
Get_Mine_Limit;
SCRIPTS_API extern sbd
Set_Special_Base_Destruction;
SCRIPTS_API extern gpv
Get_Client_Version;
SCRIPTS_API extern gpr
Get_Client_Revision;
SCRIPTS_API extern gpr
Get_Revision;
SCRIPTS_API extern gdw
Get_Damage_Warhead;
SCRIPTS_API extern gdie
Get_Damage_Is_Explosion;
SCRIPTS_API extern addConnectionAcceptanceFilterType
addConnectionAcceptanceFilter;
SCRIPTS_API extern removeConnectionAcceptanceFilterType
removeConnectionAcceptanceFilter;
SCRIPTS_API extern iwu
Is_WOL_User;
SCRIPTS_API extern gml
Get_Tech_Level;
SCRIPTS_API extern sw
Set_Tech_Level;
SCRIPTS_API extern cee
Create_Explosion_Extended;
SCRIPTS_API extern rwpa
Retrieve_Waypaths;
SCRIPTS_API extern rwpo
Retrieve_Waypoints;
SCRIPTS_API extern gwp
Get_Waypoint_Position;
SCRIPTS_API extern trc
Test_Raycast_Collision;
SCRIPTS_API extern iib
Is_Inside_AABox;
SCRIPTS_API extern cgst
Can_Generic_Soldier_Teleport;
SCRIPTS_API extern cl
Create_Lightning;
SCRIPTS_API extern gc
Get_Clouds;
SCRIPTS_API extern gli
Get_Lightning;
SCRIPTS_API extern gw
Get_Wind;
SCRIPTS_API extern gp
Get_Rain;
SCRIPTS_API extern gp
Get_Snow;
SCRIPTS_API extern gp
Get_Ash;
SCRIPTS_API extern ugo
Update_Game_Options;
SCRIPTS_API extern gttv
GetTTVersion;
SCRIPTS_API extern gttr
GetTTRevision;
SCRIPTS_API extern htp
Set_HUD_Help_Text_Player;
SCRIPTS_API extern csp
Change_String_Player;
SCRIPTS_API extern fpu
Force_Position_Update;
SCRIPTS_API extern grps
Get_Random_Pathfind_Spot;
SCRIPTS_API extern htpt
Set_HUD_Help_Text_Player_Text;
SCRIPTS_API extern grw
Grant_Weapon;
SCRIPTS_API extern sovfp
Set_Object_Visibility_For_Player;
SCRIPTS_API extern sov
Set_Object_Visibility;
SCRIPTS_API extern lscg
Lock_Soldier_Collision_Group;
SCRIPTS_API extern ulscg
Unlock_Soldier_Collision_Group;
SCRIPTS_API extern iea
Is_Engine_Enabled;
SCRIPTS_API extern ss
Stop_Timer;
SCRIPTS_API extern cwsdp
Create_2D_Wave_Sound_Dialog_Player;
SCRIPTS_API extern fpup
Force_Position_Update_Player;
SCRIPTS_API extern ss2
Stop_Timer2;
SCRIPTS_API extern htm
Has_Timer;
SCRIPTS_API extern sbgmo
Set_Background_Music_Player_Offset;
SCRIPTS_API extern setcam
Set_Camera_Player;
SCRIPTS_API extern settran
Set_Definition_TranslationID_Player;
SCRIPTS_API extern setnur
Set_Net_Update_Rate_Player;
SCRIPTS_API extern fou
Force_Orientation_Update;
SCRIPTS_API extern foup
Force_Orientation_Update_Player;
SCRIPTS_API extern cwscp
Create_2D_Wave_Sound_Cinematic_Player;
SCRIPTS_API extern ftu
Force_Turret_Update;
SCRIPTS_API extern ftup
Force_Turret_Update_Player;
SCRIPTS_API extern fvu
Force_Velocity_Update;
SCRIPTS_API extern fvup
Force_Velocity_Update_Player;
SCRIPTS_API extern schn
Set_Camera_Host_Network;
SCRIPTS_API extern gpd
Get_Pathfind_Distance; // Deprecated, use Get_Pathfind_Distance_Async in stead
SCRIPTS_API extern gpda
Get_Pathfind_Distance_Async; // Returns > 0 when succusful. pathObj must be a vehicle or a soldier
SCRIPTS_API extern cgpd
Cancel_Get_Pathfind_Distance; // Cancels a pathfind distance request. Use the result from Get_Pathfind_Distance_Async/Get_Pathfind_Distance to cancel
SCRIPTS_API extern gpdb
Get_Pathfind_Distance_Blocking; // Returns > 0 when succesful. Solves distances immediately. pathObj must be a vehicle or a soldier
SCRIPTS_API extern gmsl
Get_Multiplayer_Spawn_Location;
SCRIPTS_API extern esbn
Enable_Spawners_By_Name;
SCRIPTS_API extern ipg
Is_Pathfind_Generated;
SCRIPTS_API extern gcps
Get_Closest_Pathfind_Spot;
SCRIPTS_API extern gcpss
Get_Closest_Pathfind_Spot_Size;
SCRIPTS_API extern grcs
Get_Radio_Command_String;
SCRIPTS_API extern sei
Set_Emot_Icon;
SCRIPTS_API extern kmd
Kill_Messages_Disabled;
SCRIPTS_API extern ise
Is_Sidebar_Enabled;
SCRIPTS_API extern iee
Is_Extras_Enabled;
SCRIPTS_API extern cbg
Can_Build_Ground;
SCRIPTS_API extern cba
Can_Build_Air;
SCRIPTS_API extern cbn
Can_Build_Naval;
SCRIPTS_API extern isb
Is_Soldier_Busy;
SCRIPTS_API extern ioep
Is_On_Enemy_Pedestal;
SCRIPTS_API extern fcpp
Find_Closest_Poly_Position;
SCRIPTS_API extern sdd
Say_Dynamic_Dialogue;
SCRIPTS_API extern sddp
Say_Dynamic_Dialogue_Player;
SCRIPTS_API extern sddt
Say_Dynamic_Dialogue_Team;
SCRIPTS_API extern elp
Enable_Letterbox_Player;
SCRIPTS_API extern cst
Create_Sound_Team;
SCRIPTS_API extern c2dst
Create_2D_Sound_Team;
SCRIPTS_API extern c2dwst
Create_2D_WAV_Sound_Team;
SCRIPTS_API extern c2dwstd
Create_2D_WAV_Sound_Team_Dialog;
SCRIPTS_API extern c2dwstc
Create_2D_WAV_Sound_Team_Cinematic;
SCRIPTS_API extern c3dwsbt
Create_3D_WAV_Sound_At_Bone_Team;
SCRIPTS_API extern c3dsbt
Create_3D_Sound_At_Bone_Team;
SCRIPTS_API extern _Stop_Sound_Player
Stop_Sound_Player;
SCRIPTS_API extern _Stop_Sound_Team
Stop_Sound_Team;
SCRIPTS_API extern ssa
Set_Subobject_Animation;
SCRIPTS_API extern sts
Set_Time_Scale;
SCRIPTS_API extern ssap
Set_Subobject_Animation_Player;
SCRIPTS_API extern wfa
Write_File_Async;
...
*/
class SCRIPTS_API MultiKeyHookScriptImpClass
...
class SCRIPTS_API JFW_Object_Created_Hook_Base
...
SCRIPTS_API void Kill_All_Buildings_By_Team(
        int Team); //kill all buildings of the specified team,ending the game with the other team winning,0 = Nod,1 = GDI
SCRIPTS_API void Set_Occupants_Fade(GameObject *obj, float red, float green, float blue,
                                    float opacity); //sets the screen fade of all the occupants of a vehicle
SCRIPTS_API void Enable_Team_Radar(int Team, bool Enable); //enable radar for a given team
SCRIPTS_API void Send_Message_Team(int team, unsigned int red, unsigned int green, unsigned int blue,
                                   const char *msg); //send a message to a team
SCRIPTS_API void
Send_Message_With_Obj_Color(GameObject *obj, const char *Msg); //send a messages in a given objects color
...
SCRIPTS_API void
Ranged_Stealth_On_Team(Gap_ListNode *FirstNode); //Apply stealth to all units in the range of this on the relavent team
SCRIPTS_API bool Can_Team_Build_Vehicle(int Team); //Can this team build vehicles
SCRIPTS_API DynamicVectorClass<int>

Get_Enlisted_Purchase_Items(int team);//Get all defined IDs of enlisted characters
SCRIPTS_API DynamicVectorClass<int>

Get_Purchase_Items(int team, int defType);//Get all defined IDs in the given purchase list
SCRIPTS_API bool Is_Infantry_Purchaseable(const char *preset,
                                          int team); //is this infantry preset purchaseable? (i.e. it would appear on the sidebar and not be hidden or greyed out. Does not do the cost check but does check unit limits)
SCRIPTS_API bool Is_Vehicle_Purchaseable(const char *preset,
                                         int team); //is this vehicle preset purchaseable? (i.e. it would appear on the sidebar and not be hidden or greyed out. Does not do the cost check but does check unit limits)
...
SCRIPTS_API void
SendShaderParamObjPlayer(GameObject *player, const char *parameter, const char *value, GameObject *object);

SCRIPTS_API void SendShaderParamObjPlayer(GameObject *player, const char *parameter, int value, GameObject *object);

SCRIPTS_API void
SendShaderParamObjPlayer(GameObject *player, const char *parameter, unsigned int value, GameObject *object);
...
*/
SCRIPTS_API void
Send_Translated_Message_Team(unsigned long ID, int team, int red, int green, int blue, bool bPlaySound = true);
