...
WeaponClass *_Get_Position_Weapon(GameObject * obj, int
position )
{
if (!obj)
return
...
if (
ArmedGameObj *pArmedObj = pPhysObjo2->As_ArmedGameObj()
)
{
WeaponBagClass *w = pArmedObj->Get_Weapon_Bag();
...
SCRIPTS_API int Get_Position_Bullets(GameObject * obj, int
position)
{
if (
WeaponClass *wc = _Get_Position_Weapon(obj, position)
)
return wc->
...
SCRIPTS_API int Get_Position_Max_Bullets(GameObject * obj, int
position)
{
if (
WeaponClass *wc = _Get_Position_Weapon(obj, position)
...
SCRIPTS_API int Get_Position_Clip_Bullets(GameObject * obj, int
position)
{
if (
WeaponClass *wc = _Get_Position_Weapon(obj, position)
...
Get_Inventory_Rounds();

return 0;
}

SCRIPTS_API int Get_Position_Clip_Max_Bullets(GameObject * obj, int
position)
{
if (
WeaponClass *wc = _Get_Position_Weapon(obj, position)
...
SCRIPTS_API int Get_Position_Total_Bullets(GameObject * obj, int
position)
{
if (
WeaponClass *wc = _Get_Position_Weapon(obj, position)
...
SCRIPTS_API int Get_Position_Total_Max_Bullets(GameObject * obj, int
position)
{
if (
WeaponClass *wc = _Get_Position_Weapon(obj, position)
...
WeaponClass *_Get_Weapon(GameObject * obj,
const char *weapon
)
{
if (!obj)
...
SCRIPTS_API int Get_Bullets(GameObject * obj,
const char *weapon
)
{
if (
WeaponClass *wc = _Get_Weapon(obj, weapon)
)
return wc->
...
SCRIPTS_API int Get_Max_Bullets(GameObject * obj,
const char *weapon
)
{
if (
...
SCRIPTS_API int Get_Clip_Bullets(GameObject * obj,
const char *weapon
)
{
if (
...
SCRIPTS_API int Get_Max_Clip_Bullets(GameObject * obj,
const char *weapon
)
{
if (
...
SCRIPTS_API int Get_Total_Bullets(GameObject * obj,
const char *weapon
)
{
if (
...
SCRIPTS_API int Get_Max_Total_Bullets(GameObject * obj,
const char *weapon
)
{
if (
...
Get_Weapon_Ammo_Definition(const char *weapon, bool PrimaryFire) {
...
Get_Weapon_Definition(const char *weapon) {
...
Get_Explosion(const char *explosion) {
...
Find_Nearest_Beacon(const Vector3 &position, int team) {
...
Find_Beacon(int Number, int Team) {
    if (Number < 0) {
        Number = 0;
    }
    if (!Number) {
...
SCRIPTS_API WeaponClass
*

ArmedGameObj::Get_Weapon() {
