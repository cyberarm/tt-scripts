...
SCRIPTS_API const char *
Get_Powerup_Weapon(const char *Powerup); //Get the weapon name that a powerup will grant if collected
SCRIPTS_API const AmmoDefinitionClass
*

Get_Weapon_Ammo_Definition(const char *weapon,
                           bool PrimaryFire); //Get the AmmoDefinitionClass of a weapon given its preset name
SCRIPTS_API const WeaponDefinitionClass
*

Get_Weapon_Definition(const char *weapon); //Get the WeaponDefinitionClass of a weapon given its preset name
SCRIPTS_API const WeaponDefinitionClass
*
Get_Current_Weapon_Definition(GameObject
*obj); //Get the WeaponDefinitionClass of an objects current weapon
SCRIPTS_API const WeaponDefinitionClass
*
Get_Position_Weapon_Definition(GameObject
*obj,
int position
); //Get the WeaponDefinitionClass of an objects weapon at the specified position
SCRIPTS_API const ExplosionDefinitionClass
*

Get_Explosion(const char *explosion); //Get the ExplosionDefinitionClass of an explosion given its preset name
SCRIPTS_API const char *Get_Powerup_Weapon_By_Obj(
        GameObject * Powerup); //Get the name of a powerup weapon given a PowerUpGameObj
SCRIPTS_API int Get_Current_Weapon_Style(GameObject * obj); //Get weapon style for an objects current gun
SCRIPTS_API int Get_Position_Weapon_Style(GameObject * obj, int
position); //Get weapon style for an objects gun at a specific position
SCRIPTS_API int Get_Weapon_Style(GameObject * obj,
const char *weapon
); //Get weapon style for a specific gun (if the object doesnt have the gun, return is zero)
...
SCRIPTS_API const char *Get_Weapon(GameObject * obj, int
position); //get the specified position in the weapon bag
SCRIPTS_API bool Has_Weapon(GameObject * obj,
const char *weapon
); //does the object have the weapon
SCRIPTS_API GameObject
*

Find_Beacon(int Number, int Team); //find a beacon
...
SCRIPTS_API void
Defuse_Owned_C4(int player_id, int type = 0); // defuse all C4 owned by a player of a certain type (or 0 for all types)
SCRIPTS_API void Defuse_Attached_C4(
        GameObject * attached_object); // defuse all C4 attached to an object or (use nullptr for all unattached C4)
...
SCRIPTS_API GameObject
*
Get_C4_Planter(GameObject
*obj); //Gets the planter of a C4GameObj
SCRIPTS_API GameObject
*
Get_C4_Attached(GameObject
*obj); //Gets the object a C4GameObj is attached to (if any)
SCRIPTS_API GameObject
*
Get_Beacon_Planter(GameObject
*obj); //Gets the planter of a BeaconGameObj
SCRIPTS_API BeaconGameObj
*

Find_Nearest_Beacon(const Vector3 &position, int team); //Find the nearest beacon to a position
#endif
