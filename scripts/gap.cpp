...
void RA_Global_Gap_Controller::Add_Generator(unsigned long ObjectID, float Range, int Team) {
    ...
    } else //List exists, add node
    {
        ...
        while (Current->Next != NULL) {
            if (Current->unitID == ObjectID) {    //Same ID, replace current node
                Current->range = Range;
                Current->teamID = Team;
...
/********************************************************************/
ScriptRegistrant<RA_Global_Gap_Controller> RA_Global_Gap_Controller_Registrant("RA_Global_Gap_Controller",
                                                                               "Update_Delay=2.0:float,Timer_Number=687:int");
ScriptRegistrant<RA_Gap_Generator_Building> RA_Gap_Generator_Building_Registrant("RA_Gap_Generator_Building",
                                                                                 "Timer_Number=876:int,Stealth_Range=50:int,Gap_Controller=RA_Game_Manager:string,Team=1:int,ShroudPreset:string,SizePreset:string");
ScriptRegistrant<RA_Gap_Generator_Vehicle> RA_Gap_Generator_Vehicle_Registrant("RA_Gap_Generator_Vehicle",
                                                                               "Stealth_Range=50:int,Gap_Controller=RA_Game_Manager:string,ShroudPreset:string,SizePreset:string");
