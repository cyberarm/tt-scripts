...
void Iran_Beaconing_Prevention_Zone::Timer_Expired(GameObject *obj, int number) {
    ...
    if (IsInsideZone(obj, checkplayerobj)) {
        if (Get_Total_Bullets(checkplayerobj, "CnC_Weapon_NukeBeacon_Player")) {
            ...
            const char *currentweapon = Get_Current_Weapon(checkplayerobj);
            if (strcmp(currentweapon, "CnC_Weapon_IonCannonBeacon_Player") == 0 &&
                Get_Current_Bullets(checkplayerobj) > 0) {
                Commands->Select_Weapon(checkplayerobj, "");
...
ScriptRegistrant<Iran_Beaconing_Prevention_Zone> Iran_Beaconing_Prevention_Zone_Registrant(
        "Iran_Beaconing_Prevention_Zone", "");
...
ScriptRegistrant<Iran_Vehicle_All_Kill_Zone> Iran_Vehicle_All_Kill_Zone_Registrant("Iran_Vehicle_All_Kill_Zone",
                                                                                   "Time:float");
ScriptRegistrant<Iran_Vehicle_Ground_Kill_Zone> Iran_Vehicle_Ground_Kill_Zone_Registrant(
        "Iran_Vehicle_Ground_Kill_Zone", "Time:float");
ScriptRegistrant<Iran_Vehicle_Flying_Kill_Zone> Iran_Vehicle_Flying_Kill_Zone_Registrant(
        "Iran_Vehicle_Flying_Kill_Zone", "Time:float");

ScriptRegistrant<Iran_Invisible_Blocker> Iran_Invisible_Blocker_Registrant("Iran_Invisible_Blocker", "");
ScriptRegistrant<Iran_Invisible_Blocker_Visible> Iran_Invisible_Blocker_Visible_Registrant(
        "Iran_Invisible_Blocker_Visible", "");
