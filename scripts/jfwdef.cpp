...
void JFW_Base_Defence_Animated_No_Aircraft::Enemy_Seen(GameObject *obj, GameObject *enemy) {
    ...
    if ((_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset1"))) &&
        ...
        if (!popup) {
            popup = true;
            Commands->Start_Timer(obj, this, Get_Float_Parameter("PopupTime"), 2);
            Commands->Set_Animation(obj, Get_Parameter("Animation"), false, 0, 0, Get_Float_Parameter("LastFrame"),
                                    false);
            Stop_Timer2(obj, this, 1);
            Commands->Start_Timer(obj, this, Get_Float_Parameter("AttackTimer"), 1);
        } else if (attack) {
...
void JFW_Base_Defence_No_VTOL_No_Stealth::Enemy_Seen(GameObject *obj, GameObject *enemy) {
    ...
    if (!Is_VTOL(enemy)) {
        ...
        if (!obj1
            || !obj1->Is_Stealthed()
            || Commands->Get_Distance(Commands->Get_Position(obj), Commands->Get_Position(enemy)) <=
               Get_Float_Parameter("MaxStealthAttackDistance")) {
            ActionParamsStruct params;
            Vector3 pos, pos2;
            float distance;
            float minattack, maxattack;
...
void
JFW_Base_Defence_Animated_Sound_No_Aircraft_Swap::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    if (type == Get_Int_Parameter("SwapMessage")) {
        if (primary) {
            primary = false;
        } else {
...
void
JFW_Base_Defence_Animated_Sound_Aircraft_Only_Swap::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    if (type == Get_Int_Parameter("SwapMessage")) {
        if (primary) {
            primary = false;
        } else {
...
ScriptRegistrant<JFW_User_Controllable_Base_Defence> JFW_User_Controllable_Base_Defence_Registrant(
        "JFW_User_Controllable_Base_Defence",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float");
ScriptRegistrant<JFW_Base_Defence> JFW_Base_Defence_Registrant("JFW_Base_Defence",
                                                               "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float");
ScriptRegistrant<JFW_Base_Defence> M00_Base_Defense_Registrant("M00_Base_Defense",
                                                               "MinAttackDistance=0:int,MaxAttackDistance=300:int,AttackTimer=10:int");
ScriptRegistrant<JFW_Base_Defence_No_Aircraft> JFW_Base_Defence_No_Aircraft_Registrant("JFW_Base_Defence_No_Aircraft",
...
ScriptRegistrant<JFW_Base_Defence_Aircraft_Only> JFW_Base_Defence_Aircraft_Only_Registrant(
        "JFW_Base_Defence_Aircraft_Only",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string");
ScriptRegistrant<JFW_Base_Defence_Secondary> JFW_Base_Defence_Secondary_Registrant("JFW_Base_Defence_Secondary",
                                                                                   "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float");
ScriptRegistrant<JFW_Base_Defence_No_Aircraft_Secondary> JFW_Base_Defence_No_Aircraft_Secondary_Registrant(
        "JFW_Base_Defence_No_Aircraft_Secondary",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string");
ScriptRegistrant<JFW_Base_Defence_Aircraft_Only_Secondary> JFW_Base_Defence_Aircraft_Only_Secondary_Registrant(
        "JFW_Base_Defence_Aircraft_Only_Secondary",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string");
ScriptRegistrant<JFW_Base_Defence_Animated> JFW_Base_Defence_Animated_Registrant("JFW_Base_Defence_Animated",
                                                                                 "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_No_Aircraft> JFW_Base_Defence_Animated_No_Aircraft_Registrant(
        "JFW_Base_Defence_Animated_No_Aircraft",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_Aircraft_Only> JFW_Base_Defence_Animated_Aircraft_Only_Registrant(
        "JFW_Base_Defence_Animated_Aircraft_Only",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_Secondary> JFW_Base_Defence_Animated_Secondary_Registrant(
        "JFW_Base_Defence_Animated_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_No_Aircraft_Secondary> JFW_Base_Defence_Animated_No_Aircraft_Secondary_Registrant(
        "JFW_Base_Defence_Animated_No_Aircraft_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_Aircraft_Only_Secondary> JFW_Base_Defence_Animated_Aircraft_Only_Secondary_Registrant(
        "JFW_Base_Defence_Animated_Aircraft_Only_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_No_VTOL> JFW_Base_Defence_No_VTOL_Registrant("JFW_Base_Defence_No_VTOL",
                                                                               "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float");
ScriptRegistrant<JFW_Base_Defence_No_VTOL_No_Stealth> JFW_Base_Defence_No_VTOL_No_Stealth_Registrant(
        "JFW_Base_Defence_No_VTOL_No_Stealth",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,MaxStealthAttackDistance=0.0:float");
ScriptRegistrant<JFW_Base_Defence_VTOL_Only> JFW_Base_Defence_VTOL_Only_Registrant("JFW_Base_Defence_VTOL_Only",
                                                                                   "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float");
ScriptRegistrant<JFW_Base_Defence_No_VTOL_Secondary> JFW_Base_Defence_No_VTOL_Secondary_Registrant(
        "JFW_Base_Defence_No_VTOL_Secondary",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float");
ScriptRegistrant<JFW_Base_Defence_VTOL_Only_Secondary> JFW_Base_Defence_VTOL_Only_Secondary_Registrant(
        "JFW_Base_Defence_VTOL_Only_Secondary",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float");
ScriptRegistrant<JFW_Base_Defence_Animated_No_VTOL> JFW_Base_Defence_Animated_No_VTOL_Registrant(
        "JFW_Base_Defence_Animated_No_VTOL",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_VTOL_Only> JFW_Base_Defence_Animated_VTOL_Only_Registrant(
        "JFW_Base_Defence_Animated_VTOL_Only",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_No_VTOL_Secondary> JFW_Base_Defence_Animated_No_VTOL_Secondary_Registrant(
        "JFW_Base_Defence_Animated_No_VTOL_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_VTOL_Only_Secondary> JFW_Base_Defence_Animated_VTOL_Only_Secondary_Registrant(
        "JFW_Base_Defence_Animated_VTOL_Only_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound> JFW_Base_Defence_Animated_Sound_Registrant(
        "JFW_Base_Defence_Animated_Sound",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_No_Aircraft> JFW_Base_Defence_Animated_Sound_No_Aircraft_Registrant(
        "JFW_Base_Defence_Animated_Sound_No_Aircraft",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_Aircraft_Only> JFW_Base_Defence_Animated_Sound_Aircraft_Only_Registrant(
        "JFW_Base_Defence_Animated_Sound_Aircraft_Only",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_Secondary> JFW_Base_Defence_Animated_Sound_Secondary_Registrant(
        "JFW_Base_Defence_Animated_Sound_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_No_Aircraft_Secondary> JFW_Base_Defence_Animated_Sound_No_Aircraft_Secondary_Registrant(
        "JFW_Base_Defence_Animated_Sound_No_Aircraft_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_Aircraft_Only_Secondary> JFW_Base_Defence_Animated_Sound_Aircraft_Only_Secondary_Registrant(
        "JFW_Base_Defence_Animated_Sound_Aircraft_Only_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_No_VTOL> JFW_Base_Defence_Animated_Sound_No_VTOL_Registrant(
        "JFW_Base_Defence_Animated_Sound_No_VTOL",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_VTOL_Only> JFW_Base_Defence_Animated_Sound_VTOL_Only_Registrant(
        "JFW_Base_Defence_Animated_Sound_VTOL_Only",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_No_VTOL_Secondary> JFW_Base_Defence_Animated_Sound_No_VTOL_Secondary_Registrant(
        "JFW_Base_Defence_Animated_Sound_No_VTOL_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_VTOL_Only_Secondary> JFW_Base_Defence_Animated_Sound_VTOL_Only_Secondary_Registrant(
        "JFW_Base_Defence_Animated_Sound_VTOL_Only_Secondary",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,Sound:string");
ScriptRegistrant<JFW_Base_Defence_Swap> JFW_Base_Defence_Swap_Registrant("JFW_Base_Defence_Swap",
                                                                         "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_No_Aircraft_Swap> JFW_Base_Defence_No_Aircraft_Swap_Registrant(
        "JFW_Base_Defence_No_Aircraft_Swap",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Aircraft_Only_Swap> JFW_Base_Defence_Aircraft_Only_Swap_Registrant(
        "JFW_Base_Defence_Aircraft_Only_Swap",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_Swap> JFW_Base_Defence_Animated_Swap_Registrant(
        "JFW_Base_Defence_Animated_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_No_Aircraft_Swap> JFW_Base_Defence_Animated_No_Aircraft_Swap_Registrant(
        "JFW_Base_Defence_Animated_No_Aircraft_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_Aircraft_Only_Swap> JFW_Base_Defence_Animated_Aircraft_Only_Swap_Registrant(
        "JFW_Base_Defence_Animated_Aircraft_Only_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_No_VTOL_Swap> JFW_Base_Defence_No_VTOL_Swap_Registrant(
        "JFW_Base_Defence_No_VTOL_Swap",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_VTOL_Only_Swap> JFW_Base_Defence_VTOL_Only_Swap_Registrant(
        "JFW_Base_Defence_VTOL_Only_Swap",
        "MinAttackDistance=0.0:float,MaxAttackDistance=300.0:float,AttackTimer=10.0:float,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_No_VTOL_Swap> JFW_Base_Defence_Animated_No_VTOL_Swap_Registrant(
        "JFW_Base_Defence_Animated_No_VTOL_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_VTOL_Only_Swap> JFW_Base_Defence_Animated_VTOL_Only_Swap_Registrant(
        "JFW_Base_Defence_Animated_VTOL_Only_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_Swap> JFW_Base_Defence_Animated_Sound_Swap_Registrant(
        "JFW_Base_Defence_Animated_Sound_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,Sound:string,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_No_Aircraft_Swap> JFW_Base_Defence_Animated_Sound_No_Aircraft_Swap_Registrant(
        "JFW_Base_Defence_Animated_Sound_No_Aircraft_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float,Sound:string,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_Aircraft_Only_Swap> JFW_Base_Defence_Animated_Sound_Aircraft_Only_Swap_Registrant(
        "JFW_Base_Defence_Animated_Sound_Aircraft_Only_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Preset1:string,Preset2:string,Preset3:string,Preset4:string,Preset5:string,Preset6:string,Preset7:string,Preset8:string,Animation:string,LastFrame:float,PopupTime:float,Sound:string,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_No_VTOL_Swap> JFW_Base_Defence_Animated_Sound_No_VTOL_Swap_Registrant(
        "JFW_Base_Defence_Animated_Sound_No_VTOL_Swap",
        "MaxAttackDistance:float,AttackTimer:float,Animation:string,LastFrame:float,PopupTime:float,Sound:string,SwapMessage:int");
ScriptRegistrant<JFW_Base_Defence_Animated_Sound_VTOL_Only_Swap> JFW_Base_Defence_Animated_Sound_VTOL_Only_Swap_Registrant(
