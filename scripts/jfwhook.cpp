...
void ObjectCreateHookBaseHook(void *data, GameObject *obj) {
    JFW_Object_Created_Hook_Base *base = (JFW_Object_Created_Hook_Base * )
    data;
...
void KeyHookBaseHook(void *data) {
    JFW_Key_Hook_Base *base = (JFW_Key_Hook_Base * )
    data;
    base->KeyHook();
}
...
void JFW_Dplbl_Vhcls_Keyboard::KeyHook() {
    ...
    TempCalcul = (int) (Commands->Get_Max_Health(Animation) *
                        (Commands->Get_Health(Owner()) / Commands->Get_Max_Health(Owner())));
    Commands->Set_Health(Animation, (float) TempCalcul);
    TempCalcul = (int) (Commands->Get_Max_Shield_Strength(Animation) *
                        (Commands->Get_Shield_Strength(Owner()) / Commands->Get_Max_Shield_Strength(Owner())));
...
void JFW_Underground_Logic::KeyHook() {
    if (enable) {
        if (underground) {
            ...
            underground = true;
            Set_Occupants_Fade(Owner(), Get_Float_Parameter("DigRed"), Get_Float_Parameter("DigBlue"),
                               Get_Float_Parameter("DigGreen"), Get_Float_Parameter("DigOpacity"));
            Vector3 v = Commands->Get_Position(Owner());
            Commands->Create_Sound(Get_Parameter("DigSound"), v, Owner());
...
ScriptRegistrant<JFW_Attach_Script_Preset_Created> JFW_Attach_Script_Preset_Created_Registrant(
        "JFW_Attach_Script_Preset_Created", "Script:string,Params:string,Delim:string,Preset:string,Player_Type:int");
ScriptRegistrant<JFW_Attach_Script_Type_Created> JFW_Attach_Script_Type_Created_Registrant(
        "JFW_Attach_Script_Type_Created", "Script:string,Params:string,Delim:string,Type:int,Player_Type:int");
ScriptRegistrant<JFW_Attach_Script_Player_Created> JFW_Attach_Script_Player_Created_Registrant(
        "JFW_Attach_Script_Player_Created", "Script:string,Params:string,Delim:string,Player_Type:int");
ScriptRegistrant<JFW_Attach_Script_Vehicle_Created> JFW_Attach_Script_Vehicle_Created_Registrant(
        "JFW_Attach_Script_Vehicle_Created", "Script:string,Params:string,Delim:string,Player_Type:int");
ScriptRegistrant<JFW_Dplbl_Vhcls_Keyboard> JFW_Dplbl_Vhcls_Keyboard_Registrant("JFW_Dplbl_Vhcls_Keyboard",
                                                                               "Animation_Preset:string,oldTnk_Warhead:string,oldTnk_Dammage:float,Explosion_preset:string");
ScriptRegistrant<JFW_Underground_Logic> JFW_Underground_Logic_Registrant("JFW_Underground_Logic",
                                                                         "UpZOffset:float,DownZOffset:float,DigEffectObj:string,SurfaceEffectObj:string,DisableMessage:int,EnableMessage:int,IndicatorMessage:int,IndicatorObject:string,IndicatorZOffset:float,DigRed:float,DigGreen:float,DigBlue:float,DigOpacity:float,DigSound:string");
ScriptRegistrant<JFW_Jetpack> JFW_Jetpack_Registrant("JFW_Jetpack",
                                                     "DisableMessage:int,EnableMessage:int,OnAnimation=null.null:string");
ScriptRegistrant<JFW_Jetpack_Timer> JFW_Jetpack_Timer_Registrant("JFW_Jetpack_Timer",
                                                                 "DisableMessage:int,EnableMessage:int,OnAnimation=null.null:string,timer:float,Message:string");
ScriptRegistrant<JFW_Limited_Jetpack_Timer> JFW_Limited_Jetpack_Timer_Registrant("JFW_Limited_Jetpack_Timer",
                                                                                 "DisableMessage:int,EnableMessage:int,OnAnimation=null.null:string,TimerOff:float,TimerOn:Float,TimerUse:float,Message:string");
ScriptRegistrant<JFW_Jetpack_Model> JFW_Jetpack_Model_Registrant("JFW_Jetpack_Model",
                                                                 "DisableMessage:int,EnableMessage:int,OnModel:string,OffModel:string,OnAnimation=null.null:string");
ScriptRegistrant<JFW_Suicide_Bomber> JFW_Suicide_Bomber_Registrant("JFW_Suicide_Bomber", "Explosion:string");
ScriptRegistrant<JFW_Sidebar_Key_2> JFW_Sidebar_Key_2_Registrant("JFW_Sidebar_Key_2",
                                                                 "Key=Sidebar:string,Enable_Custom=0:int,Disable_Custom=0:int,Sound:string");
ScriptRegistrant<JFW_Jetpack_Timer_No_Fly> JFW_Jetpack_Timer_No_Fly_Registrant("JFW_Jetpack_Timer_No_Fly",
                                                                               "DisableMessage:int,EnableMessage:int,OnAnimation=null.null:string,timer:float,Message:string,NoFlyOn:int,NoFlyOff:int,NoFlyMessage:string");
ScriptRegistrant<JFW_Limited_Jetpack_Timer_No_Fly> JFW_Limited_Jetpack_Timer_No_Fly_Registrant(
        "JFW_Limited_Jetpack_Timer_No_Fly",
        "DisableMessage:int,EnableMessage:int,OnAnimation=null.null:string,TimerOff:float,TimerOn:Float,TimerUse:float,Message:string,NoFlyOn:int,NoFlyOff:int,NoFlyMessage:string");
