...
void JFW_Debug_Text_File::Sound_Heard(GameObject *obj, const CombatSound &sound) {
    ...
    timediff = (float) difftime(t2, t);
    id = Commands->Get_ID(obj);
    fprintf(f, "%s [ID %d] heard sound %d at position %f %f %f object %d. %f sec.\n", description, id, sound.sound,
            sound.Position.X, sound.Position.Y, sound.Position.Z, Commands->Get_ID(sound.Creator), timediff);
    fflush(f);
}
...
void JFW_Play_Animation_Destroy_Object::Created(GameObject *obj) {
    ...
    Commands->Set_Animation(obj, Get_Parameter("Animation"), false, subobject, firstframe,
...
void JFW_Animated_Effect::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    if (type == Get_Int_Parameter("Message")) {
        ...
        float firstframe = Get_Float_Parameter("FirstFrame");
        Commands->Set_Animation(object, Get_Parameter("Animation"), false, subobject, firstframe,
                                Get_Float_Parameter("LastFrame"), Get_Bool_Parameter("Blended"));
    }
}
...
void JFW_Goto_Object_On_Startup::Created(GameObject *obj) {
    ...
    params.Set_Movement(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Float_Parameter("Speed"),
...
void JFW_Screen_Fade_On_Custom::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    if (type == Get_Int_Parameter("Message")) {
        ...
        Set_Screen_Fade_Color_Player(obj, Get_Float_Parameter("Red"), Get_Float_Parameter("Green"),
                                     Get_Float_Parameter("Blue"), 0.0f);
    }
}
...
void JFW_Screen_Fade_On_Enter::Entered(GameObject *obj, GameObject *enterer) {
    ...
    Set_Screen_Fade_Color_Player(enterer, Get_Float_Parameter("Red"), Get_Float_Parameter("Green"),
                                 Get_Float_Parameter("Blue"), 0.0f);
}
...
void JFW_Screen_Fade_On_Exit::Exited(GameObject *obj, GameObject *exiter) {
    ...
    Set_Screen_Fade_Color_Player(exiter, Get_Float_Parameter("Red"), Get_Float_Parameter("Green"),
                                 Get_Float_Parameter("Blue"), 0.0f);
}
...
void JFW_Screen_Fade_Custom_Timer::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    if (type == Get_Int_Parameter("Message")) {
        ...
        Commands->Set_Screen_Fade_Color(Get_Float_Parameter("Red"), Get_Float_Parameter("Green"),
                                        Get_Float_Parameter("Blue"), 0);
...
void JFW_Change_Radar_Map::Created(GameObject *obj) {
    Change_Radar_Map(Get_Float_Parameter("Scale"), Get_Float_Parameter("OffsetX"), Get_Float_Parameter("OffsetY"),
...
void JFW_Game_Hint_Soldier::Timer_Expired(GameObject *obj, int number) {
    Display_Game_Hint(obj, Get_Int_Parameter("EventID"), Get_Parameter("Sound"), Get_Int_Parameter("TitleID"),
                      Get_Int_Parameter("TextID"), Get_Int_Parameter("TextID2"), Get_Int_Parameter("TextID3"));
}
...
void JFW_Game_Hint_Vehicle::Timer_Expired(GameObject *obj, int number) {
    Display_Game_Hint(Commands->Find_Object(number), Get_Int_Parameter("EventID"), Get_Parameter("Sound"),
                      Get_Int_Parameter("TitleID"), Get_Int_Parameter("TextID"), Get_Int_Parameter("TextID2"),
...
void JFW_Game_Hint_Zone::Entered(GameObject *obj, GameObject *enterer) {
    ...
    Display_Game_Hint(enterer, Get_Int_Parameter("EventID"), Get_Parameter("Sound"), Get_Int_Parameter("TitleID"),
                      Get_Int_Parameter("TextID"), Get_Int_Parameter("TextID2"), Get_Int_Parameter("TextID3"));
}
...
void JFW_Game_Hint_Image_Soldier::Timer_Expired(GameObject *obj, int number) {
    Display_Game_Hint_Image(obj, Get_Int_Parameter("EventID"), Get_Parameter("Sound"), Get_Int_Parameter("TitleID"),
                            Get_Int_Parameter("TextID"), Get_Int_Parameter("TextID2"), Get_Int_Parameter("TextID3"),
                            Get_Parameter("Texture"));
}
...
void JFW_Game_Hint_Image_Vehicle::Timer_Expired(GameObject *obj, int number) {
    Display_Game_Hint_Image(Commands->Find_Object(number), Get_Int_Parameter("EventID"), Get_Parameter("Sound"),
                            Get_Int_Parameter("TitleID"), Get_Int_Parameter("TextID"), Get_Int_Parameter("TextID2"),
...
void JFW_Game_Hint_Image_Zone::Entered(GameObject *obj, GameObject *enterer) {
    ...
    Display_Game_Hint_Image(enterer, Get_Int_Parameter("EventID"), Get_Parameter("Sound"), Get_Int_Parameter("TitleID"),
                            Get_Int_Parameter("TextID"), Get_Int_Parameter("TextID2"), Get_Int_Parameter("TextID3"),
                            Get_Parameter("Texture"));
}
    ...
    if (obj->As_BuildingGameObj() && obj->As_BuildingGameObj()->As_VehicleFactoryGameObj()) {
        if (type == Get_Int_Parameter("Disable_Custom")) {
            if (count == 0) {
                ...
                PurchaseSettingsDefClass::Find_Definition(PurchaseSettingsDefClass::TYPE_VEHICLES,
                                                          (PurchaseSettingsDefClass::TEAM) PTTEAM(
                                                                  Get_Object_Type(obj)))->Set_Page_Disabled(true);
                PurchaseSettingsDefClass::Find_Definition(PurchaseSettingsDefClass::TYPE_SECRET_VEHICLES,
                                                          (PurchaseSettingsDefClass::TEAM) PTTEAM(
                                                                  Get_Object_Type(obj)))->Set_Page_Disabled(true);
            }
            count++;
        ...
        if (type == Get_Int_Parameter("Enable_Custom")) {
            ...
            if (count == 0) {
                ...
                PurchaseSettingsDefClass::Find_Definition(PurchaseSettingsDefClass::TYPE_VEHICLES,
                                                          (PurchaseSettingsDefClass::TEAM) PTTEAM(
                                                                  Get_Object_Type(obj)))->Set_Page_Disabled(false);
                PurchaseSettingsDefClass::Find_Definition(PurchaseSettingsDefClass::TYPE_SECRET_VEHICLES,
                                                          (PurchaseSettingsDefClass::TEAM) PTTEAM(
                                                                  Get_Object_Type(obj)))->Set_Page_Disabled(false);
            }
    ...
    if (obj->As_BuildingGameObj() && obj->As_BuildingGameObj()->As_AirFactoryGameObj()) {
        if (type == Get_Int_Parameter("Disable_Custom")) {
            if (count == 0) {
                ...
                PurchaseSettingsDefClass::Find_Definition(PurchaseSettingsDefClass::TYPE_AIR,
                                                          (PurchaseSettingsDefClass::TEAM) PTTEAM(
                                                                  Get_Object_Type(obj)))->Set_Page_Disabled(true);
            }
            count++;
    ...
    if (obj->As_BuildingGameObj() && obj->As_BuildingGameObj()->As_NavalFactoryGameObj()) {
        if (type == Get_Int_Parameter("Disable_Custom")) {
            if (count == 0) {
                ...
                PurchaseSettingsDefClass::Find_Definition(PurchaseSettingsDefClass::TYPE_NAVAL,
                                                          (PurchaseSettingsDefClass::TEAM) PTTEAM(
                                                                  Get_Object_Type(obj)))->Set_Page_Disabled(true);
            }
            count++;
...
void JFW_Engineer_Hack::Created(GameObject *obj) {
    ...
    IndcatorID = Commands->Get_ID(
            Find_Nearest_Preset(Commands->Get_Position(obj), Get_Parameter("Hack_Indicator_Preset")));
...
void JFW_Engineer_Hack::Apply_Damage(GameObject *obj, float damage) {
    ...
    if (oldhealth > offline && HackHealth <= offline) {
        ...
        Commands->Send_Custom_Event(Commands->Find_Object(IndcatorID), obj, Get_Int_Parameter("Hack_Offline_Custom"), 0,
                                    0);
    }
}
...
void JFW_Engineer_Hack::Apply_Repair(GameObject *obj, float repair) {
    ...
    if (oldhealth <= offline && HackHealth > offline) {
        ...
        Commands->Send_Custom_Event(Commands->Find_Object(IndcatorID), obj, Get_Int_Parameter("Hack_Online_Custom"), 0,
                                    0);
    }
}
...
void JFW_Ion_Storm::Timer_Expired(GameObject *obj, int number) {
    if (number == 1) //start storm
    {
        ...
        if (Find_Building_By_Type(0, BuildingConstants::TYPE_COM_CENTER)) {
            ...
            Commands->Send_Custom_Event(obj, Find_Building_By_Type(0, BuildingConstants::TYPE_COM_CENTER),
                                        Get_Int_Parameter("Disable_Custom"), 0, 0);
        }
        if (Find_Building_By_Type(1, BuildingConstants::TYPE_COM_CENTER)) {
            //fprintf(f,"Disable GDI Radar\n");
            Commands->Send_Custom_Event(obj, Find_Building_By_Type(1, BuildingConstants::TYPE_COM_CENTER),
                                        Get_Int_Parameter("Disable_Custom"), 0, 0);
        }
        if (Find_Building_By_Type(0, BuildingConstants::TYPE_POWER_PLANT)) {
            //fprintf(f,"Disable Nod Power\n");
            Commands->Send_Custom_Event(obj, Find_Building_By_Type(0, BuildingConstants::TYPE_POWER_PLANT),
                                        Get_Int_Parameter("Disable_Custom"), 0, 0);
        }
        if (Find_Building_By_Type(1, BuildingConstants::TYPE_POWER_PLANT)) {
            //fprintf(f,"Disable GDI Power\n");
            Commands->Send_Custom_Event(obj, Find_Building_By_Type(1, BuildingConstants::TYPE_POWER_PLANT),
                                        Get_Int_Parameter("Disable_Custom"), 0, 0);
        }
    ...
    } else if (number == 2) //storm ended
    {
        ...
        if (Find_Building_By_Type(0, BuildingConstants::TYPE_COM_CENTER)) {
            ...
            Commands->Send_Custom_Event(obj, Find_Building_By_Type(0, BuildingConstants::TYPE_COM_CENTER),
                                        Get_Int_Parameter("Enable_Custom"), 0, 0);
        }
        if (Find_Building_By_Type(1, BuildingConstants::TYPE_COM_CENTER)) {
...
void JFW_Ion_Storm_Weather::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    if (type == Get_Int_Parameter("Message")) {
        Commands->Set_Lightning(Get_Float_Parameter("Lightning_Intensity"),
                                Get_Float_Parameter("Lightning_Start_Distance"),
                                Get_Float_Parameter("Lightning_End_Distance"), Get_Float_Parameter("Lightning_Heading"),
        ...
        Commands->Set_Screen_Fade_Color(Get_Float_Parameter("Screen_Red"), Get_Float_Parameter("Screen_Green"),
                                        Get_Float_Parameter("Screen_Blue"), 0);
...
void JFW_Ion_Storm_Weather_2::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    if (type == Get_Int_Parameter("Enable_Message")) {
        Get_Lightning(Lightning_Intensity, Lightning_Start_Distance, Lightning_End_Distance, Lightning_Heading,
                      Lightning_Distribution);
        ...
        Commands->Set_Lightning(Lightning_Intensity, Lightning_Start_Distance, Lightning_End_Distance,
                                Lightning_Heading, Lightning_Distribution, 0);
            ...
            if (Vector3::Dot_Product(res.Normal, ray.Get_Dir()) <= 0) {
                ...
                if (coltest.CollidedPhysObj) {
                    ...
                    if (old_observer && old_observer->As_BuildingGameObj()) {
                        Commands->Apply_Damage(old_observer->As_BuildingGameObj(), def->Damage,
                                               ArmorWarheadManager::Get_Warhead_Name(def->Warhead), 0);
                    }
                }
            }
        }
...
void JFW_Building_Zone::Created(GameObject *obj) {
    Commands->Send_Custom_Event(obj, Find_Closest_Preset_By_Team(2, Commands->Get_Position(obj),
                                                                 Get_Parameter("ParentPreset")), 0x123456, 0, 0.5f);
}
...
void JFW_EMP_Indicator::Damaged(GameObject *obj, GameObject *damager, float amount) {
    if (Warhead == Get_Damage_Warhead() && !DisableEmp) {
        ...
        if (o && o->Get_Is_Scripts_Visible() && o->Get_Scripts_Can_Fire() && o->Can_Drive()) {
            ...
            o->Set_Stealth_Active(false);
            Commands->Start_Timer(obj, this, Get_Float_Parameter("Time"), 1);
            GameObject * indicator = Commands->Create_Object_At_Bone(obj, Get_Parameter("Preset"),
                                                                     Get_Parameter("Bone"));
...
ScriptRegistrant<JFW_Tech_Level_Timer> JFW_Tech_Level_Timer_Registrant("JFW_Tech_Level_Timer",
...
ScriptRegistrant<JFW_Tech_Level_Custom> JFW_Tech_Level_Custom_Registrant("JFW_Tech_Level_Custom",
                                                                         "Message:int,Tech_Level:int");

ScriptRegistrant<JFW_Stealthable_Object> JFW_Stealthable_Object_Registrant("JFW_Stealthable_Object", "Message:int");
ScriptRegistrant<JFW_Object_Counter> JFW_Object_Counter_Registrant("JFW_Object_Counter",
                                                                   "Count:int,IncrementMessage:int,DecrementMessage:int");
ScriptRegistrant<JFW_Fog_Create> JFW_Fog_Create_Registrant("JFW_Fog_Create",
...
ScriptRegistrant<JFW_War_Blitz_Create> JFW_War_Blitz_Create_Registrant("JFW_War_Blitz_Create",
...
ScriptRegistrant<JFW_Goto_Object_On_Startup> JFW_Goto_Object_On_Startup_Registrant("JFW_Goto_Object_On_Startup",
                                                                                   "ID:int,Speed:float,ArriveDistance:float");
ScriptRegistrant<JFW_Animated_Effect> JFW_Animated_Effect_Registrant("JFW_Animated_Effect",
                                                                     "Animation:string,Subobject:string,FirstFrame:float,LastFrame:float,Blended:int,Model:string,Message:int,Location:vector3");
ScriptRegistrant<JFW_Animated_Effect_2> JFW_Animated_Effect_2_Registrant("JFW_Animated_Effect_2",
                                                                         "Animation:string,Subobject:string,FirstFrame:float,LastFrame:float,Blended:int,Model:string,Message:int");
ScriptRegistrant<JFW_Random_Animated_Effect> JFW_Random_Animated_Effect_Registrant("JFW_Random_Animated_Effect",
...
ScriptRegistrant<JFW_Random_Animated_Effect_2> JFW_Random_Animated_Effect_2_Registrant("JFW_Random_Animated_Effect_2",
                                                                                       "Animation:string,Subobject:string,FirstFrame:float,LastFrame:float,Blended:int,Model:string,Message:int,Offset:vector3");
ScriptRegistrant<JFW_Object_Draw_In_Order> JFW_Object_Draw_In_Order_Registrant("JFW_Object_Draw_In_Order",
                                                                               " Location:vector3,Custom:int,BaseName:string,Count:int,Facing:float");
ScriptRegistrant<JFW_Object_Draw_In_Order_2> JFW_Object_Draw_In_Order_2_Registrant("JFW_Object_Draw_In_Order_2",
                                                                                   " Location:vector3,Custom:int,BaseName:string,Count:int,Facing:float,Start_Number:int");
ScriptRegistrant<JFW_Object_Draw_Random> JFW_Object_Draw_Random_Registrant("JFW_Object_Draw_Random",
                                                                           " Location:vector3,Custom:int,BaseName:string,Count:int,Facing:float");
ScriptRegistrant<JFW_Play_Animation_Destroy_Object> JFW_Play_Animation_Destroy_Object_Registrant(
...
ScriptRegistrant<JFW_Debug_Text_File> JFW_Debug_Text_File_Registrant("JFW_Debug_Text_File",
                                                                     "Log_File:string,Description:string");
...
ScriptRegistrant<JFW_User_Settable_Parameters> JFW_User_Settable_Parameters_Registrant("JFW_User_Settable_Parameters",
                                                                                       "File_Name:string,Script_Name:string");
ScriptRegistrant<JFW_Change_Spawn_Character> JFW_Change_Spawn_Character_Registrant("JFW_Change_Spawn_Characher",
...
ScriptRegistrant<JFW_Screen_Fade_On_Enter> JFW_Screen_Fade_On_Enter_Registrant("JFW_Screen_Fade_On_Enter",
                                                                               "Red:float,Green:float,Blue:float,Opacity:float");
ScriptRegistrant<JFW_Screen_Fade_On_Exit> JFW_Screen_Fade_On_Exit_Registrant("JFW_Screen_Fade_On_Exit",
                                                                             "Red:float,Green:float,Blue:float,Opacity:float");
ScriptRegistrant<JFW_Screen_Fade_On_Custom> JFW_Screen_Fade_On_Custom_Registrant("JFW_Screen_Fade_On_Custom",
                                                                                 "Message:int,Red:float,Green:float,Blue:float,Opacity:float");
ScriptRegistrant<JFW_Screen_Fade_Custom_Timer> JFW_Screen_Fade_Custom_Timer_Registrant("JFW_Screen_Fade_Custom_Timer",
...
ScriptRegistrant<JFW_Show_Info_Texture> JFW_Show_Info_Texture_Registrant("JFW_Show_Info_Texture",
                                                                         "Time:float,TimerNum:int,Texture:string");
ScriptRegistrant<JFW_Wireframe_Mode> JFW_Wireframe_Mode_Registrant("JFW_Wireframe_Mode", "Mode:int");
ScriptRegistrant<JFW_Change_Radar_Map> JFW_Change_Radar_Map_Registrant("JFW_Change_Radar_Map",
                                                                       "Scale:float,OffsetX:float,OffsetY:float,Texture:string");
ScriptRegistrant<JFW_Goto_Player_Timer> JFW_Goto_Player_Timer_Registrant("JFW_Goto_Player_Timer",
                                                                         "Time:float,TimerNum:int,Speed:float,ArriveDistance:float");
...
ScriptRegistrant<JFW_PT_Hide_Custom> JFW_PT_Hide_Custom_Registrant("JFW_PT_Hide_Custom",
                                                                   "Player_Type:int,Preset:string,Message:int");
ScriptRegistrant<JFW_PT_Hide_Timer> JFW_PT_Hide_Timer_Registrant("JFW_PT_Hide_Timer",
                                                                 "Player_Type:int,Preset:string,Time:float");
...
ScriptRegistrant<JFW_PT_Show_Custom> JFW_PT_Show_Custom_Registrant("JFW_PT_Show_Custom",
                                                                   "Player_Type:int,Preset:string,Message:int");
ScriptRegistrant<JFW_PT_Show_Timer> JFW_PT_Show_Timer_Registrant("JFW_PT_Show_Timer",
                                                                 "Player_Type:int,Preset:string,Time:float");
ScriptRegistrant<JFW_Follow_Waypath_Zone> JFW_Follow_Waypath_Zone_Registrant("JFW_Follow_Waypath_Zone",
                                                                             "Waypathid:int,Speed:float,Preset:string");
ScriptRegistrant<JFW_Set_Info_Texture> JFW_Set_Info_Texture_Registrant("JFW_Set_Info_Texture",
                                                                       "Message:int,Texture:string");
...
ScriptRegistrant<JFW_Set_Time_Limit_Custom> JFW_Set_Time_Limit_Custom_Registrant("JFW_Set_Time_Limit_Custom",
                                                                                 "Message:int,TimeLimit:int");
ScriptRegistrant<JFW_Radar_Low_Power> JFW_Radar_Low_Power_Registrant("JFW_Radar_Low_Power", "");
ScriptRegistrant<JFW_Game_Hint_Soldier> JFW_Game_Hint_Soldier_Registrant("JFW_Game_Hint_Soldier",
                                                                         "EventID:int,Sound:string,TitleID:int,TextID:int,TextID2:int,TextID3:int");
ScriptRegistrant<JFW_Game_Hint_Vehicle> JFW_Game_Hint_Vehicle_Registrant("JFW_Game_Hint_Vehicle",
                                                                         "EventID:int,Sound:string,TitleID:int,TextID:int,TextID2:int,TextID3:int");
ScriptRegistrant<JFW_Game_Hint_Zone> JFW_Game_Hint_Zone_Registrant("JFW_Game_Hint_Zone",
                                                                   "Player_Type:int,EventID:int,Sound:string,TitleID:int,TextID:int,TextID2:int,TextID3:int");
ScriptRegistrant<JFW_Game_Hint_Image_Soldier> JFW_Game_Hint_Image_Soldier_Registrant("JFW_Game_Hint_Image_Soldier",
                                                                                     "EventID:int,Sound:string,TitleID:int,TextID:int,TextID2:int,TextID3:int,Texture:string");
ScriptRegistrant<JFW_Game_Hint_Image_Vehicle> JFW_Game_Hint_Image_Vehicle_Registrant("JFW_Game_Hint_Image_Vehicle",
                                                                                     "EventID:int,Sound:string,TitleID:int,TextID:int,TextID2:int,TextID3:int,Texture:string");
ScriptRegistrant<JFW_Game_Hint_Image_Zone> JFW_Game_Hint_Image_Zone_Registrant("JFW_Game_Hint_Image_Zone",
...
ScriptRegistrant<JFW_Points_Custom> JFW_Points_Custom_Registrant("JFW_Points_Custom",
                                                                 "Message:int,Points:int,Team:int");
ScriptRegistrant<JFW_Engineer_Hack> JFW_Engineer_Hack_Registrant("JFW_Engineer_Hack",
...
ScriptRegistrant<JFW_Double_Animation> JFW_Double_Animation_Registrant("JFW_Double_Animation",
                                                                       "End_Frame:float,First_Custom:int,Second_Custom:int");
ScriptRegistrant<JFW_Display_String_Custom> JFW_Display_String_Custom_Registrant("JFW_Display_String_Custom",
                                                                                 "Message:int,Team:int,String:string,Sound:string,Red:int,Green:int,Blue:int");
ScriptRegistrant<JFW_Preset_Disable> JFW_Preset_Disable_Registrant("JFW_Preset_Disable",
                                                                   "Preset:string,Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_Power_Disable> JFW_Power_Disable_Registrant("JFW_Power_Disable",
                                                                 "Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_Radar_Disable> JFW_Radar_Disable_Registrant("JFW_Radar_Disable",
                                                                 "Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_Conyard_Disable> JFW_Conyard_Disable_Registrant("JFW_Conyard_Disable",
                                                                     "Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_Refinery_Disable> JFW_Refinery_Disable_Registrant("JFW_Refinery_Disable",
                                                                       "Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_VehicleFactory_Disable> JFW_VehicleFactory_Disable_Registrant("JFW_VehicleFactory_Disable",
                                                                                   "Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_AirFactory_Disable> JFW_AirFactory_Disable_Registrant("JFW_AirFactory_Disable",
                                                                           "Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_NavalFactory_Disable> JFW_NavalFactory_Disable_Registrant("JFW_NavalFactory_Disable",
                                                                               "Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_SoldierFactory_Disable> JFW_SoldierFactory_Disable_Registrant("JFW_SoldierFactory_Disable",
                                                                                   "Disable_Custom:int,Enable_Custom:int");
ScriptRegistrant<JFW_EMP> JFW_EMP_Registrant("JFW_EMP", "Warhead:string,Time:float,Animation:string");
ScriptRegistrant<JFW_EMP_Mine> JFW_EMP_Mine_Registrant("JFW_EMP_Mine",
                                                       "Mine_Manager_ID:int,Explosion:string,Time:float");
ScriptRegistrant<JFW_EMP_Mine_Manager> JFW_EMP_Mine_Manager_Registrant("JFW_EMP_Mine_Manager",
                                                                       "Mine_Preset:string,Mine_Limit:int,Mine_Reload:string,Mine_Z_Offset:float,Mine_Distance:float");
ScriptRegistrant<JFW_EMP_Mine_Manager_2> JFW_EMP_Mine_Manager_2_Registrant("JFW_EMP_Mine_Manager_2",
                                                                           "Mine_Preset:string,Mine_Limit:int,Mine_Reload:string,Throw_Velocity:float");
ScriptRegistrant<JFW_EMP_Mine_Layer> JFW_EMP_Mine_Layer_Registrant("JFW_EMP_Mine_Layer",
                                                                   "Mine_Manager_ID:int,Warhead:string");
...
ScriptRegistrant<JFW_Forward_Custom_Object> JFW_Forward_Custom_Object_Registrant("JFW_Forward_Custom_Object",
                                                                                 "Object_ID:int");
ScriptRegistrant<JFW_Death_Send_Custom_Self> JFW_Death_Send_Custom_Self_Registrant("JFW_Death_Send_Custom_Self",
                                                                                   "Message:int");
ScriptRegistrant<JFW_Hunter_Seeker> JFW_Hunter_Seeker_Registrant("JFW_Hunter_Seeker", "Key:string,Explosion:string");
ScriptRegistrant<JFW_Ion_Storm> JFW_Ion_Storm_Registrant("JFW_Ion_Storm",
...
ScriptRegistrant<JFW_Ion_Storm_2> JFW_Ion_Storm_2_Registrant("JFW_Ion_Storm_2",
...
ScriptRegistrant<JFW_Ion_Storm_3> JFW_Ion_Storm_3_Registrant("JFW_Ion_Storm_3",
...
ScriptRegistrant<JFW_Ion_Storm_Weather> JFW_Ion_Storm_Weather_Registrant("JFW_Ion_Storm_Weather",
...
ScriptRegistrant<JFW_Ion_Storm_Weather_2> JFW_Ion_Storm_Weather_2_Registrant("JFW_Ion_Storm_Weather_2",
...
ScriptRegistrant<JFW_Change_Character_Created> JFW_Change_Character_Created_Registrant("JFW_Change_Character_Created",
                                                                                       "Character:string");
ScriptRegistrant<JFW_Change_Model_Created> JFW_Change_Model_Created_Registrant("JFW_Change_Model_Created",
                                                                               "Model1:string,Model2:string,Model3:string,Model4:string,Model5:string");
ScriptRegistrant<JFW_Spawn_Object_Created> JFW_Spawn_Object_Created_Registrant("JFW_Spawn_Object_Created",
                                                                               "Object:string");
ScriptRegistrant<JFW_Killed_String_Sound> JFW_Killed_String_Sound_Registrant("JFW_Killed_String_Sound",
...
ScriptRegistrant<JFW_Custom_Create_Object_At_Bone> JFW_Custom_Create_Object_At_Bone_Registrant(
        "JFW_Custom_Create_Object_At_Bone", "Message:int,Object:string,Bone:string,Time:float");
ScriptRegistrant<JFW_MSA> JFW_MSA_Registrant("JFW_MSA", "Time:float,Message:int,Range:float,SizePreset:string");
ScriptRegistrant<JFW_Ion_Lightning> JFW_Ion_Lightning_Registrant("JFW_Ion_Lightning",
                                                                 "MinTime:float,MaxTime:float,OnMessage:int,OffMessage:int,Ammo:string");
ScriptRegistrant<JFW_Vehicle_Zone> JFW_Vehicle_Zone_Registrant("JFW_Vehicle_Zone",
                                                               "BoneName:string,ZoneSize:vector3,ZonePreset:string");
ScriptRegistrant<JFW_Building_Zone> JFW_Building_Zone_Registrant("JFW_Building_Zone", "ParentPreset:string");
ScriptRegistrant<JFW_Building_Zone_Controller> JFW_Building_Zone_Controller_Registrant("JFW_Building_Zone_Controler",
                                                                                       "ZoneSize:vector3,ZonePreset:string");
ScriptRegistrant<JFW_Send_Message_Preset_Death> JFW_Send_Message_Preset_Death_Registrant(
        "JFW_Send_Message_Preset_Death", "Preset:string,Message:int");
ScriptRegistrant<JMG_Send_Custom_To_Self_On_Timer> JMG_Send_Custom_To_Self_On_Timer_Registrant(
        "JMG_Send_Custom_To_Self_On_Timer", "Message:int,Param:int,Time:float,Timer_Number:int,Repeat:int");
ScriptRegistrant<JFW_Vehicle_Crate> JFW_Vehicle_Crate_Registrant("JFW_Vehicle_Crate", "Preset:string,Offset:vector3");
ScriptRegistrant<JFW_Airstrike_Cinematic> JFW_Airstrike_Cinematic_Registrant("JFW_Airstrike_Cinematic",
                                                                             "Script_Name:string,Message:int");
ScriptRegistrant<JFW_Spy_Disguise_Target> JFW_Spy_Disguise_Target_Registrant("JFW_Spy_Disguise_Target",
                                                                             "Model:string,Warhead:string");
ScriptRegistrant<JFW_Spawner_Delay> JFW_Spawner_Delay_Registrant("JFW_Spawner_Delay", "ID:int,time:float");
ScriptRegistrant<JFW_EMP_Indicator> JFW_EMP_Indicator_Registrant("JFW_EMP_Indicator",
                                                                 "Warhead:string,Time:float,Preset:string,Bone:string");
