...
class JFW_Tutorial_Conversation : public ScriptImpClass {
    ...
    void Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason) {
        ...
        if (action_id == Get_Int_Parameter("ActionID") && complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
            Commands->Send_Custom_Event(obj, obj, Get_Int_Parameter("CompleteMessage"),
                                        Get_Int_Parameter("CompleteParam"), 0);
        }
    }
};

REGISTER_SCRIPT(JFW_Tutorial_Conversation,
                "Conversation:string,ActionID:int,StartMessage:int,StopMessage:int,CompleteMessage:int,CompleteParam:int,DisableControls:int,LookID:int");
...
class JFW_Add_Objective_Startup : public ScriptImpClass {
    void Created(GameObject *obj) {
        Commands->Add_Objective(Get_Int_Parameter("ObjectiveID"), Get_Int_Parameter("ObjectiveType"),
                                OBJECTIVE_STATUS_HIDDEN, Get_Int_Parameter("ShortDescription"),
                                (char *) Get_Parameter("Sound"), Get_Int_Parameter("LongDescription"));
    }
};

REGISTER_SCRIPT(JFW_Add_Objective_Startup,
...
class JFW_Set_Objective_Radar_Blip_Object_Custom : public ScriptImpClass {
    void Custom(GameObject *obj, int type, int param, GameObject *sender) {
        if (type == Get_Int_Parameter("Message")) {
            Commands->Set_Objective_Radar_Blip_Object(Get_Int_Parameter("ObjectiveID"),
                                                      Commands->Find_Object(Get_Int_Parameter("ID")));
        }
    }
};
...
class JFW_Set_Objective_HUD_Info_Custom : public ScriptImpClass {
    void Custom(GameObject *obj, int type, int param, GameObject *sender) {
        if (type == Get_Int_Parameter("Message")) {
            Commands->Set_Objective_HUD_Info(Get_Int_Parameter("ObjectiveID"), Get_Float_Parameter("Priority"),
                                             Get_Parameter("Texture"), Get_Int_Parameter("StringID"));
        }
    }
};

REGISTER_SCRIPT(JFW_Set_Objective_HUD_Info_Custom,
...
class JFW_Set_Objective_HUD_Info_Position_Custom : public ScriptImpClass {
    void Custom(GameObject *obj, int type, int param, GameObject *sender) {
        if (type == Get_Int_Parameter("Message")) {
            Commands->Set_Objective_HUD_Info_Position(Get_Int_Parameter("ObjectiveID"), Get_Float_Parameter("Priority"),
                                                      Get_Parameter("Texture"), Get_Int_Parameter("StringID"),
...
REGISTER_SCRIPT(JFW_Set_Objective_HUD_Info_Position_Custom,
...
class JFW_Add_Radar_Marker : public ScriptImpClass {
    void Custom(GameObject *obj, int type, int param, GameObject *sender) {
        if (type == Get_Int_Parameter("Message")) {
            Commands->Add_Radar_Marker(Get_Int_Parameter("MarkerID"), Get_Vector3_Parameter("Position"),
                                       Get_Int_Parameter("BlipShape"), Get_Int_Parameter("BlipColor"));
        }
    }
};
...
REGISTER_SCRIPT(JFW_Tutorial_Conversation_2,
                "Conversation:string,ActionID:int,StartMessage:int,StopMessage:int,CompleteMessage:int,CompleteParam:int,DisableControls:int,LookID:int");
...
REGISTER_SCRIPT(JFW_Goto_Object,
                "Message:int,ActionID:int,ID:int,Speed:float,ArriveDistance:float,WaypathID:int,CompleteMessage:int,CompleteParam:int");
...
class JFW_Goto_Location : public ScriptImpClass {
    void Custom(GameObject *obj, int type, int param, GameObject *sender) {
        if (type == Get_Int_Parameter("Message")) {
            ActionParamsStruct params;
            params.Set_Basic(this, 100, Get_Int_Parameter("ActionID"));
            params.Set_Movement(Get_Vector3_Parameter("Location"), Get_Float_Parameter("Speed"),
                                Get_Float_Parameter("ArriveDistance"));
            params.WaypathID = Get_Int_Parameter("WaypathID");
            Commands->Action_Goto(obj, params);
        }
...
REGISTER_SCRIPT(JFW_Goto_Location,
                "Message:int,ActionID:int,Location:vector3,Speed:float,ArriveDistance:float,WaypathID:int,CompleteMessage:int,CompleteParam:int");
...
REGISTER_SCRIPT(JFW_Innate_AI_Flags,
                "Message:int,HibernateEnable:int,EnemySeenEnable:int,InnateEnable:int,LoitersAllowed:int,InnateIsStationary:int");
...
class JFW_Attack_Object : public ScriptImpClass {
    void Custom(GameObject *obj, int type, int param, GameObject *sender) {
        if (type == Get_Int_Parameter("Message")) {
            ...
            params.Set_Movement(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Float_Parameter("Speed"),
                                Get_Float_Parameter("ArriveDistance"));
            params.Set_Attack(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Float_Parameter("Range"),
...
REGISTER_SCRIPT(JFW_Attack_Object,
                "Message:int,ActionID:int,ID:int,Speed:float,ArriveDistance:float,WaypathID:int,CompleteMessage:int,CompleteParam:int,Range:float,Error:float,Primary:int");
...
class JFW_Attack_Location : public ScriptImpClass {
    void Custom(GameObject *obj, int type, int param, GameObject *sender) {
        if (type == Get_Int_Parameter("Message")) {
            ...
            params.Set_Movement(Get_Vector3_Parameter("Location"), Get_Float_Parameter("Speed"),
                                Get_Float_Parameter("ArriveDistance"));
            params.Set_Attack(Get_Vector3_Parameter("Location"), Get_Float_Parameter("Range"),
                              Get_Float_Parameter("Error"), Get_Bool_Parameter("Primary"));
            params.WaypathID = Get_Int_Parameter("WaypathID");
            params.AttackCheckBlocked = false;
            params.AttackErrorOverride = true;
...
REGISTER_SCRIPT(JFW_Attack_Location,
                "Message:int,ActionID:int,Location:vector3,Speed:float,ArriveDistance:float,WaypathID:int,CompleteMessage:int,CompleteParam:int,Range:float,Error:float,Primary:int");
...
class JFW_Apply_Damage_Custom : public ScriptImpClass {
    void Custom(GameObject *obj, int type, int param, GameObject *sender) {
        if (type == Get_Int_Parameter("Message")) {
            Commands->Apply_Damage(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Float_Parameter("Amount"),
...
class JFW_Damage_All_Objects_Area : public ScriptImpClass {
    ...
    void Timer_Expired(GameObject *obj, int number) {
        if (number == 1) {
            Damage_All_Objects_Area_By_Team(Get_Float_Parameter("Damage"), Get_Parameter("Warhead"),
                                            Commands->Get_Position(obj), Get_Float_Parameter("Distance"), obj,
                                            Get_Bool_Parameter("Soldiers"), Get_Bool_Parameter("Vehicles"),
                                            Get_Int_Parameter("Team"));
            Commands->Start_Timer(obj, this, Get_Float_Parameter("Time"), 1);
        }
    }
};

REGISTER_SCRIPT(JFW_Damage_All_Objects_Area,
    ...
    void Timer_Expired(GameObject *obj, int number) {
        ...
        if (number == 3) {
            ...
            for (SLNode<SoldierGameObj> *node = GameObjManager::SoldierGameObjList.Head(); node; node = node->Next()) {
                ...
                if ((object->Get_Defense_Object()->Get_Health() == object->Get_Defense_Object()->Get_Health_Max()) &&
                    (object->Get_Defense_Object()->Get_Shield_Strength() ==
                     object->Get_Defense_Object()->Get_Shield_Strength())) {
                    continue;
                }
...
public:
    ...
    void Killed(GameObject *obj, GameObject *killer) {
        Commands->Attach_Script(Commands->Create_Object("Invisible_Object", Vector3(0, 0, 0)), "Test_Cinematic",
                                "X3C_Bigguns2.txt");
...
REGISTER_SCRIPT(JFW_Deployable_Vehicle,
                "Model_Rookie:string,Model_Veteran:string,Model_Elite:string,Last_Deploy_Frame:float,DeploySound:string,UndeploySound:string");
...
REGISTER_SCRIPT(JFW_Veteran_Weapon_Deploy,
                "Weapon_Rookie:string,Weapon_Veteran:string,Weapon_Elite:string,Weapon_Rookie_Deployed:string,Weapon_Veteran_Deployed:string,Weapon_Elite_Deployed:string");
...
REGISTER_SCRIPT(JFW_Veteran_Armor,
                "Shield_Rookie:string,Shield_Veteran:string,Shield_Elite:string,Skin_Rookie:string,Skin_Veteran:string,Skin_Elite:string");
...
REGISTER_SCRIPT(JFW_Veteran_Armor_Deploy,
                "Shield_Rookie:string,Shield_Veteran:string,Shield_Elite:string,Shield_Rookie_Deployed:string,Shield_Veteran_Deployed:string,Shield_Elite_Deployed:string,Skin_Rookie:string,Skin_Veteran:string,Skin_Elite:string,Skin_Rookie_Deployed:string,Skin_Veteran_Deployed:string,Skin_Elite_Deployed:string");
        ...
        if (number == 4) {
            ...
            if (dist > 0.1) {
                ...
                if (Get_Animation_Frame(obj)) {
                    if (forward) {
                        LastDir = 1;
                        Commands->Set_Animation(obj, moveanim, true, 0, Get_Animation_Frame(obj),
                                                Get_Animation_Frame(obj), 0);
                        state = 1;
                    }
                    if (backward) {
                        LastDir = 2;
                        Commands->Set_Animation(obj, movebanim, true, 0, Get_Animation_Frame(obj),
                                                Get_Animation_Frame(obj), 0);
                        state = 3;
                    }
                    enabled = true;
...
REGISTER_SCRIPT(JFW_Deployable_Mech,
...
REGISTER_SCRIPT(JFW_Sabotage_Beacon_Layer,
...
REGISTER_SCRIPT(JFW_Veteran_Help_Text,
...
REGISTER_SCRIPT(JFW_Veteran_Custom,
                "Custom_Rookie_In:string,Custom_Veteran_In:string,Custom_Elite_In:string,Custom_Rookie_Out:string,Custom_Veteran_Out:string,Custom_Elite_Out:string");
...
REGISTER_SCRIPT(JFW_Veteran_Weapon_Switch,
                "Weapon1:string,Weapon2:string,Keyhook:string,Model1:string,Model2:string,VeteranLevel:int,Sound1:string,Sound2:string,SwitchTime:float");
    ...
    void Timer_Expired(GameObject *obj, int number) {
        if (number == 1) {
            ...
            if (o) {
                ...
                int param = 0;
                if (active && (Commands->Get_Distance(Commands->Get_Position(o), Commands->Get_Position(obj)) <
                               Get_Float_Parameter("Range"))) {
                    param = 1;
                }
        ...
        if (number == 1) {
            ...
            if (o) {
                ...
                if (Get_Vehicle_Occupant_Count(obj) &&
                    (Commands->Get_Distance(Commands->Get_Position(o), Commands->Get_Position(obj)) <
                     Get_Float_Parameter("Range"))) {
                    param = 1;
                }
                if (Jamming != param || param == 1) {
...
ScriptRegistrant<JFW_Add_Objective> JFW_Add_Objective_Registrant("JFW_Add_Objective",
                                                                 "Type:int,TypeVal:int,Objective_Num:int,Objective_Type:int,Title_ID:int,Unknown:int,Sound_Name:string,Description_ID:int,Timer_Custom:int,Trigger:int");
ScriptRegistrant<JFW_Remove_Objective> JFW_Remove_Objective_Registrant("JFW_Remove_Objective",
                                                                       "Type:int,TypeVal:int,Objective_Num:int,Timer_Custom:int");
ScriptRegistrant<JFW_Set_Objective_Status> JFW_Set_Objective_Status_Registrant("JFW_Set_Objective_Status",
                                                                               "Type:int,TypeVal:int,Objective_Num:int,Status:int,Timer_Custom:int");
ScriptRegistrant<JFW_Change_Objective_Type> JFW_Change_Objective_Type_Registrant("JFW_Change_Objective_Type",
                                                                                 "Type:int,TypeVal:int,Objective_Num:int,Objective_Type:int,Timer_Custom:int");
ScriptRegistrant<JFW_Set_Objective_Radar_Blip> JFW_Set_Objective_Radar_Blip_Registrant("JFW_Set_Objective_Radar_Blip",
                                                                                       "Type:int,TypeVal:int,Objective_Num:int,Pos:vector3,Timer_Custom:int");
ScriptRegistrant<JFW_Set_Objective_Radar_Blip_Object> JFW_Set_Objective_Radar_Blip_Object_Registrant(
        "JFW_Set_Objective_Radar_Blip_Object", "Type:int,TypeVal:int,Objective_Num:int,Object:int,Timer_Custom:int");
ScriptRegistrant<JFW_Set_Objective_HUD_Info> JFW_Set_Objective_HUD_Info_Registrant("JFW_Set_Objective_HUD_Info",
                                                                                   "Type:int,TypeVal:int,Objective_Num:int,Priority:float,Pog_File:string,Pog_Title_ID:int,Timer_Custom:int");
ScriptRegistrant<JFW_Set_Objective_HUD_Info_Position> JFW_Set_Objective_HUD_Info_Position_Registrant(
        "JFW_Set_Objective_HUD_Info_Position",
        "Type:int,TypeVal:int,Objective_Num:int,Priority:float,Pog_File:string,Pog_Title_ID:int,Position:vector3,Timer_Custom:int");
ScriptRegistrant<JFW_Set_Num_Tertary_Objectives> JFW_Set_Num_Tertary_Objectives_Registrant(
        "JFW_Set_Num_Tertary_Objectives", "Type:int,TypeVal:int,Count:int,Timer_Custom:int");
ScriptRegistrant<JFW_Mission_Complete> JFW_Mission_Complete_Registrant("JFW_Mission_Complete",
                                                                       "Type:int,TypeVal:int,Won:int,Timer_Custom:int");
ScriptRegistrant<JFW_Start_Timer> JFW_Start_Timer_Registrant("JFW_Start_Timer",
                                                             "Type:int,TypeVal:int,Timer_Object:int,Timer_Number:int,Timer_Time:float,Repeat:int,Timer_Custom:int");
