...
void JFW_Switch_Door::Poked(GameObject *obj, GameObject *poker) {
    ...
    Commands->Set_Animation(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Parameter("Animation"), false, 0, 0, -1,
                            false);
}

void JFW_Switch_Door::Timer_Expired(GameObject *obj, int number) {
    Commands->Set_Animation(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Parameter("Animation"), false, 0,
                            Get_Animation_Frame(Commands->Find_Object(Get_Int_Parameter("ID"))), 0, false);
}

void JFW_Switch_Lock_Door::Poked(GameObject *obj, GameObject *poker) {
    if (Commands->Has_Key(poker, Get_Int_Parameter("key"))) {
        Commands->Start_Timer(obj, this, Get_Float_Parameter("Time"), Get_Int_Parameter("TimerNum"));
        Commands->Set_Animation(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Parameter("Animation"), false, 0, 0,
                                -1, false);
    }
}
...
void JFW_Toggle_Lock_Door::Poked(GameObject *obj, GameObject *poker) {
    if (Commands->Has_Key(poker, Get_Int_Parameter("key"))) {
        if (!open) {
            open = true;
            Commands->Set_Animation(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Parameter("Animation"), false,
                                    0, 0, -1, false);
        } else {
            open = false;
            Commands->Set_Animation(Commands->Find_Object(Get_Int_Parameter("ID")), Get_Parameter("Animation"), false,
                                    0, Get_Animation_Frame(Commands->Find_Object(Get_Int_Parameter("ID"))), 0, false);
        }
    }
}
...
void JFW_Switch_Door_Team_2::Timer_Expired(GameObject *obj, int number) {
    Commands->Set_Animation(obj, Get_Parameter("Animation"), false, 0,
                            Get_Animation_Frame(Commands->Find_Object(Get_Int_Parameter("ID"))), 0, false);
}
...
ScriptRegistrant<JFW_Poke_Send_Custom> JFW_Poke_Send_Custom_Registrant("JFW_Poke_Send_Custom",
...
ScriptRegistrant<JFW_Character_Buy_Poke> JFW_Character_Buy_Poke_Registrant("JFW_Character_Buy_Poke",
...
ScriptRegistrant<JFW_Vehicle_Buy_Poke> JFW_Vehicle_Buy_Poke_Registrant("JFW_Vehicle_Buy_Poke",
                                                                       "Preset_Name:string,Cost:int,Player_Type:int");
ScriptRegistrant<JFW_Powerup_Buy_Poke> JFW_Powerup_Buy_Poke_Registrant("JFW_Powerup_Buy_Poke",
                                                                       "Preset_Name:string,Cost:int,Player_Type:int");
ScriptRegistrant<JFW_Preset_Buy_Poke> JFW_Preset_Buy_Poke_Registrant("JFW_Preset_Buy_Poke",
                                                                     "Preset_Name:string,Cost:int,location:vector3,Player_Type:int");
ScriptRegistrant<JFW_Group_Purchase_Poke> JFW_Group_Purchase_Poke_Registrant("JFW_Group_Purchase_Poke",
                                                                             "CashPerPerson:float,TotalCash:float,ID:int,Custom:int");
ScriptRegistrant<JFW_Gate_Poke> JFW_Gate_Poke_Registrant("JFW_Gate_Poke",
                                                         "Player_Type:int,Time:float,TimerNum:int,ID:int,Animation:string");
ScriptRegistrant<JFW_Poke_Send_Custom_2> JFW_Poke_Send_Custom_2_Registrant("JFW_Poke_Send_Custom_2",
                                                                           "Player_Type:int,ID:int,Message:int,Param:int");
ScriptRegistrant<JFW_Poke_Send_Custom_Preset> JFW_Poke_Send_Custom_Preset_Registrant("JFW_Poke_Send_Custom_Preset",
                                                                                     "Player_Type:int,ID:int,Message:int,Param:int,Preset:string");
ScriptRegistrant<JFW_Poke_Send_Custom_Keycard> JFW_Poke_Send_Custom_Keycard_Registrant("JFW_Poke_Send_Custom_Keycard",
                                                                                       "Player_Type:int,ID:int,Message:int,Param:int,Key:int");
ScriptRegistrant<JFW_Poke_Send_Custom_Cost> JFW_Poke_Send_Custom_Cost_Registrant("JFW_Poke_Send_Custom_Cost",
                                                                                 "Player_Type:int,ID:int,Message:int,Param:int,Cost:float");
ScriptRegistrant<JFW_Poke_Play_2D_Sound> JFW_Poke_Play_2D_Sound_Registrant("JFW_Poke_Play_2D_Sound",
                                                                           "Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Poke_Play_3D_Sound> JFW_Poke_Play_3D_Sound_Registrant("JFW_Poke_Play_3D_Sound",
                                                                           "Player_Type:int,Sound:string,Position:vector3");
ScriptRegistrant<JFW_Powerup_Buy_Poke_Timer> JFW_Powerup_Buy_Poke_Timer_Registrant("JFW_Powerup_Buy_Poke_Timer",
                                                                                   "Preset_Name:string,Cost:int,Player_Type:int,Time:float,TimerNum:int");
ScriptRegistrant<JFW_Poke_Play_2D_Sound_Team> JFW_Poke_Play_2D_Sound_Team_Registrant("JFW_Poke_Play_2D_Sound_Team",
                                                                                     "Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Poke_Play_3D_Sound_Team> JFW_Poke_Play_3D_Sound_Team_Registrant("JFW_Poke_Play_3D_Sound_Team",
                                                                                     "Player_Type:int,Sound:string,Position:vector3");
ScriptRegistrant<JFW_Poke_Play_2D_Sound_Player> JFW_Poke_Play_2D_Sound_Player_Registrant(
        "JFW_Poke_Play_2D_Sound_Player", "Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Poke_Play_3D_Sound_Player> JFW_Poke_Play_3D_Sound_Player_Registrant(
        "JFW_Poke_Play_3D_Sound_Player", "Player_Type:int,Sound:string,Position:vector3");
ScriptRegistrant<JFW_Look_At_Location_Poke> JFW_Look_At_Location_Poke_Registrant("JFW_Look_At_Location_Poke",
                                                                                 "Player_Type:int,Location:vector3");
ScriptRegistrant<JFW_Look_At_Object_Poke> JFW_Look_At_Object_Poke_Registrant("JFW_Look_At_Object_Poke",
                                                                             "Player_Type:int,ObjectID:int");
ScriptRegistrant<JFW_PCT> JFW_PCT_Registrant("JFW_PCT", "Player_Type:int");
ScriptRegistrant<JFW_Weapon_Buy_Poke> JFW_Weapon_Buy_Poke_Registrant("JFW_Weapon_Buy_Poke",
                                                                     "Weapon_Name:string,Cost:int,Player_Type:int");
ScriptRegistrant<JFW_Preset_Buy_Poke_Timer> JFW_Preset_Buy_Poke_Timer_Registrant("JFW_Preset_Buy_Poke_Timer",
                                                                                 "Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Time:float,TimerNum:int");
ScriptRegistrant<JFW_Preset_Buy_Poke_Custom> JFW_Preset_Buy_Poke_Custom_Registrant("JFW_Preset_Buy_Poke_Custom",
                                                                                   "Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Message:int");
ScriptRegistrant<JFW_Slot_Machine> JFW_Slot_Machine_Registrant("JFW_Slot_Machine",
                                                               "Cost:int,Winnings:int,Percent:int,Player_Type:int");
ScriptRegistrant<JFW_Slot_Machine_2> JFW_Slot_Machine_2_Registrant("JFW_Slot_Machine_2",
                                                                   "Cost:int,Winnings:int,Percent:int,Player_Type:int,Animation:string,Sound:string");
ScriptRegistrant<JFW_Switch_Door> JFW_Switch_Door_Registrant("JFW_Switch_Door",
                                                             "ID:int,Animation:string,Time:float,TimerNum:int");
ScriptRegistrant<JFW_Switch_Lock_Door> JFW_Switch_Lock_Door_Registrant("JFW_Switch_Lock_Door",
                                                                       "ID:int,Animation:string,Time:float,TimerNum:int,Key:int");
ScriptRegistrant<JFW_Toggle_Door> JFW_Toggle_Door_Registrant("JFW_Toggle_Door", "ID:int,Animation:string");
ScriptRegistrant<JFW_Toggle_Lock_Door> JFW_Toggle_Lock_Door_Registrant("JFW_Toggle_Lock_Door",
                                                                       "ID:int,Animation:string,Key:int");
ScriptRegistrant<JFW_Switch_Door_Team> JFW_Switch_Door_Team_Registrant("JFW_Switch_Door_Team",
                                                                       "ID:int,Animation:string,Time:float,TimerNum:int,Player_Type:int");
ScriptRegistrant<JFW_Toggle_Door_Team> JFW_Toggle_Door_Team_Registrant("JFW_Toggle_Door_Team",
                                                                       "ID:int,Animation:string,Player_Type:int");
ScriptRegistrant<JFW_Character_Buy_Poke_Sound> JFW_Character_Buy_Poke_Sound_Registrant("JFW_Character_Buy_Poke_Sound",
                                                                                       "Preset_Name:string,Cost:int,Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Refill_Buy_Poke_Sound> JFW_Refill_Buy_Poke_Sound_Registrant("JFW_Refill_Buy_Poke_Sound",
                                                                                 "Cost:int,Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Vehicle_Buy_Poke_Sound> JFW_Vehicle_Buy_Poke_Sound_Registrant("JFW_Vehicle_Buy_Poke_Sound",
                                                                                   "Preset_Name:string,Cost:int,Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Powerup_Buy_Poke_Sound> JFW_Powerup_Buy_Poke_Sound_Registrant("JFW_Powerup_Buy_Poke_Sound",
                                                                                   "Preset_Name:string,Cost:int,Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Preset_Buy_Poke_Sound> JFW_Preset_Buy_Poke_Sound_Registrant("JFW_Preset_Buy_Poke_Sound",
                                                                                 "Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Group_Purchase_Poke_Sound> JFW_Group_Purchase_Poke_Sound_Registrant(
        "JFW_Group_Purchase_Poke_Sound", "CashPerPerson:float,TotalCash:float,ID:int,Custom:int,Sound:string");
ScriptRegistrant<JFW_Powerup_Buy_Poke_Timer_Sound> JFW_Powerup_Buy_Poke_Timer_Sound_Registrant(
        "JFW_Powerup_Buy_Poke_Timer_Sound",
        "Preset_Name:string,Cost:int,Player_Type:int,Time:float,TimerNum:int,Sound:string");
ScriptRegistrant<JFW_Weapon_Buy_Poke_Sound> JFW_Weapon_Buy_Poke_Sound_Registrant("JFW_Weapon_Buy_Poke_Sound",
                                                                                 "Weapon_Name:string,Cost:int,Player_Type:int,Sound:string");
ScriptRegistrant<JFW_Preset_Buy_Poke_Timer_Sound> JFW_Preset_Buy_Poke_Timer_Sound_Registrant(
        "JFW_Preset_Buy_Poke_Timer_Sound",
        "Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Time:float,TimerNum:int,Sound:string");
ScriptRegistrant<JFW_Preset_Buy_Poke_Custom_Sound> JFW_Preset_Buy_Poke_Custom_Sound_Registrant(
        "JFW_Preset_Buy_Poke_Custom_Sound",
        "Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Message:int,Sound:string");
ScriptRegistrant<JFW_Switch_Door_2> JFW_Switch_Door_2_Registrant("JFW_Switch_Door_2",
                                                                 "Animation:string,Time:float,TimerNum:int");
ScriptRegistrant<JFW_Switch_Lock_Door_2> JFW_Switch_Lock_Door_2_Registrant("JFW_Switch_Lock_Door_2",
                                                                           "Animation:string,Time:float,TimerNum:int,Key:int");
ScriptRegistrant<JFW_Toggle_Door_2> JFW_Toggle_Door_2_Registrant("JFW_Toggle_Door_2", "Animation:string");
ScriptRegistrant<JFW_Toggle_Lock_Door_2> JFW_Toggle_Lock_Door_2_Registrant("JFW_Toggle_Lock_Door_2",
                                                                           "Animation:string,Key:int");
ScriptRegistrant<JFW_Switch_Door_Team_2> JFW_Switch_Door_Team_2_Registrant("JFW_Switch_Door_Team_2",
                                                                           "Animation:string,Time:float,TimerNum:int,Player_Type:int");
ScriptRegistrant<JFW_Toggle_Door_Team_2> JFW_Toggle_Door_Team_2_Registrant("JFW_Toggle_Door_Team_2",
                                                                           "Animation:string,Player_Type:int");
ScriptRegistrant<JFW_Lock_Sound> JFW_Lock_Sound_Registrant("JFW_Lock_Sound",
                                                           "Key:int,LockSound:string,UnlockSound:string");
ScriptRegistrant<JFW_Poke_Send_Custom_Toggle> JFW_Poke_Send_Custom_Toggle_Registrant("JFW_Poke_Send_Custom_Toggle",
                                                                                     "Player_Type:int,ID:int,Message1:int,Message2:int");
ScriptRegistrant<JFW_Poke_Play_2D_Sound_Timer> JFW_Poke_Play_2D_Sound_Timer_Registrant("JFW_Poke_Play_2D_Sound_Timer",
                                                                                       "Player_Type:int,Sound:string,Time:float,TimerNum:int");
ScriptRegistrant<JFW_Poke_Play_3D_Sound_Timer> JFW_Poke_Play_3D_Sound_Timer_Registrant("JFW_Poke_Play_3D_Sound_Timer",
                                                                                       "Player_Type:int,Sound:string,Position:vector3,Time:float,TimerNum:int");
ScriptRegistrant<JFW_Sidebar_PT> JFW_Sidebar_PT_Registrant("JFW_Sidebar_PT", "Player_Type:int");
ScriptRegistrant<JFW_Escort_Poke> JFW_Escort_Poke_Registrant("JFW_Escort_Poke",
                                                             "Shield:string,Shield2:string,Player_Type:int");
