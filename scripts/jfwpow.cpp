...
void JFW_Spawn_Timer::Timer_Expired(GameObject *obj, int number) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(Get_Int_Parameter("TriggerID")),
...
void JFW_Powerup_Send_Custom_Team::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    if (type == CUSTOM_EVENT_POWERUP_GRANTED) {
        if (!Get_Object_Type(sender)) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(Get_Int_Parameter("NodID")),
                                        Get_Int_Parameter("NodMessage"), 0, 0);
        } else {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(Get_Int_Parameter("GDIID")),
...
ScriptRegistrant<JFW_Give_Powerup_Create> JFW_Give_Powerup_Create_Registrant("JFW_Give_Powerup_Create",
                                                                             "Powerup:string");
ScriptRegistrant<JFW_Clear_Money_Create> JFW_Clear_Money_Create_Registrant("JFW_Clear_Money_Create", "");
ScriptRegistrant<JFW_Spawn_Timer> JFW_Spawn_Timer_Registrant("JFW_Spawn_Timer",
                                                             "Time:float,TimerNum:int,SpawnCustom:int,TriggerCustom:int,TriggerID:int,SpawnPreset:string,SpawnLocation:vector3");
ScriptRegistrant<JFW_Warp_On_Pickup_Team> JFW_Warp_On_Pickup_Team_Registrant("JFW_Warp_On_Pickup_Team",
                                                                             "Position:vector3,Player_Type:int");
...
ScriptRegistrant<JFW_Vehicle_Powerup_Preset> JFW_Vehicle_Powerup_Preset_Registrant("JFW_Vehicle_Powerup_Preset",
                                                                                   "Message:int,Preset:string");
ScriptRegistrant<JFW_Powerup_Send_Custom> JFW_Powerup_Send_Custom_Registrant("JFW_Powerup_Send_Custom",
                                                                             "ID:int,Message:int");
ScriptRegistrant<JFW_Powerup_Send_Custom_Team> JFW_Powerup_Send_Custom_Team_Registrant("JFW_Powerup_Send_Custom_Team",
                                                                                       "GDIID:int,GDIMessage:int,NodID:int,NodMessage:int");
ScriptRegistrant<JFW_Change_Character_Powerup> JFW_Change_Character_Powerup_Registrant("JFW_Change_Character_Powerup",
                                                                                       "Preset:string");
ScriptRegistrant<JFW_Change_Character_Powerup_2> JFW_Change_Character_Powerup_2_Registrant(
        "JFW_Change_Character_Powerup_2", "GDI_Preset:string,Nod_Preset:string");
