...
ScriptRegistrant<JFW_Set_Background_Music_On_Custom> JFW_Set_Background_Music_On_Custom_Registrant(
        "JFW_Set_Background_Music_On_Custom", "Message:int,Music:string");
ScriptRegistrant<JFW_Fade_Background_Music_On_Custom> JFW_Fade_Background_Music_On_Custom_Registrant(
        "JFW_Fade_Background_Music_On_Custom", "Message:int,Music:string,unk1:int,unk2:int");
ScriptRegistrant<JFW_Stop_Background_Music_On_Custom> JFW_Stop_Background_Music_On_Custom_Registrant(
        "JFW_Stop_Background_Music_On_Custom", "Message:int");
ScriptRegistrant<JFW_Set_Background_Music_On_Enter> JFW_Set_Background_Music_On_Enter_Registrant(
        "JFW_Set_Background_Music_On_Enter", "Music:string");
ScriptRegistrant<JFW_Fade_Background_Music_On_Enter> JFW_Fade_Background_Music_On_Enter_Registrant(
        "JFW_Fade_Background_Music_On_Enter", "Music:string,unk1:int,unk2:int");
ScriptRegistrant<JFW_Stop_Background_Music_On_Enter> JFW_Stop_Background_Music_On_Enter_Registrant(
        "JFW_Stop_Background_Music_On_Enter", "");
ScriptRegistrant<JFW_2D_Sound_Damage_Range> JFW_2D_Sound_Damage_Range_Registrant("JFW_2D_Sound_Damage_Range",
                                                                                 "Sound:string,MinHealth:float,MaxHealth:float");
ScriptRegistrant<JFW_2D_Sound_Damage_Range_Team> JFW_2D_Sound_Damage_Range_Team_Registrant(
        "JFW_2D_Sound_Damage_Range_Team", "Sound:string,MinHealth:float,MaxHealth:float");
ScriptRegistrant<JFW_2D_Sound_Damage_Range_Team_String> JFW_2D_Sound_Damage_Range_Team_String_Registrant(
        "JFW_2D_Sound_Damage_Range_Team_String", "Sound:string,MinHealth:float,MaxHealth:float,String:string");
ScriptRegistrant<JFW_3D_Sound_Damage_Range> JFW_3D_Sound_Damage_Range_Registrant("JFW_3D_Sound_Damage_Range",
                                                                                 "Sound:string,MinHealth:float,MaxHealth:float,Offset:vector3");
ScriptRegistrant<JFW_3D_Sound_Timer> JFW_3D_Sound_Timer_Registrant("JFW_3D_Sound_Timer",
                                                                   "Time:float,TimerNum:int,Repeat:int,Sound:string,Offset:vector3");
ScriptRegistrant<JFW_2D_Sound_Damage> JFW_2D_Sound_Damage_Registrant("JFW_2D_Sound_Damage",
                                                                     "Sound:string,Health:float");
ScriptRegistrant<JFW_3D_Sound_Damage> JFW_3D_Sound_Damage_Registrant("JFW_3D_Sound_Damage",
                                                                     "Sound:string,Health:float,Offset:vector3");
ScriptRegistrant<JFW_2D_Sound_Timer_Random> JFW_2D_Sound_Timer_Random_Registrant("JFW_2D_Sound_Timer_Random",
                                                                                 "Time_Min:float,Time_Max:float,TimerNum:int,Repeat:int,Sound:string");
ScriptRegistrant<JFW_3D_Sound_Timer_Random> JFW_3D_Sound_Timer_Random_Registrant("JFW_3D_Sound_Timer_Random",
                                                                                 "Time_Min:float,Time_Max:float,TimerNum:int,Repeat:int,Sound:string,Position:vector3");
ScriptRegistrant<JFW_2D_Sound_Timer_Health> JFW_2D_Sound_Timer_Health_Registrant("JFW_2D_Sound_Timer_Health",
                                                                                 "Time:float,TimerNum:int,Repeat:int,Sound:string,Min_Health:float,Max_Health:float");
ScriptRegistrant<JFW_2D_Sound_Timer> JFW_2D_Sound_Timer_Registrant("JFW_2D_Sound_Timer",
                                                                   "Time:float,TimerNum:int,Repeat:int,Sound:string");
...
ScriptRegistrant<JFW_Time_Remaining_Sounds> JFW_Time_Remaining_Sounds_Registrant("JFW_Time_Remaining_Sounds",
                                                                                 "ConfigFile:string");
ScriptRegistrant<JFW_Time_Remaining_Sounds_2> JFW_Time_Remaining_Sounds_2_Registrant("JFW_Time_Remaining_Sounds_2",
                                                                                     "ConfigFile:string,Team:int");
ScriptRegistrant<JFW_Vehicle_Full_Sound> JFW_Vehicle_Full_Sound_Registrant("JFW_Vehicle_Full_Sound",
                                                                           "Time:float,TimerNum:int,Sound:string");
...
ScriptRegistrant<JFW_Repair_Complete_Sound> JFW_Repair_Complete_Sound_Registrant("JFW_Repair_Complete_Sound",
                                                                                 "GDISound:string,NodSound:string");
