...
void JFW_Char_Weapon_Switcher::KeyHook() {
    ...
    if (time(NULL) - LastSwitch < Get_Float_Parameter("SwitchTime")) {
        StringClass str;
        str.Format("You cannot switch weapons yet, you must wait at least %f seconds after switching to switch again.",
                   Get_Float_Parameter("SwitchTime"));
...
ScriptRegistrant<JFW_Advanced_Guard_Tower_2> JFW_Advanced_Guard_Tower_2_Registrant("JFW_Advanced_Guard_Tower_2",
                                                                                   "Gun1Offset:vector3,Gun2Offset:vector3,Gun3Offset:vector3,Gun4Offset:vector3,MissileOffset:vector3");
ScriptRegistrant<JFW_Advanced_Guard_Tower_Missile> JFW_Advanced_Guard_Tower_Missile_Registrant(
...
ScriptRegistrant<JFW_Advanced_Guard_Tower_Gun> JFW_Advanced_Guard_Tower_Gun_Registrant("JFW_Advanced_Guard_Tower_Gun",
                                                                                       "");
ScriptRegistrant<JFW_Guard_Duty_Helper> JFW_Guard_Duty_Helper_Registrant("JFW_Guard_Duty_Helper",
                                                                         "ID:int,Helper_Msg:int");
ScriptRegistrant<JFW_Guard_Duty> JFW_Guard_Duty_Registrant("JFW_Guard_Duty",
                                                           "Helper_Obj:string,Helper_Bone:string,Range:float,Dummy_Object:int,Helper_Msg:int,Waypathid:int,Attack_Time:float,Wait_Time:float");
ScriptRegistrant<JFW_Hunt_Attack> JFW_Hunt_Attack_Registrant("JFW_Hunt_Attack", "Attack_Range:float");
ScriptRegistrant<JFW_Hunt_Blow_Up> JFW_Hunt_Blow_Up_Registrant("JFW_Hunt_Blow_Up",
                                                               "Speed:float,Distance:float,Explosion:string");
...
ScriptRegistrant<JFW_Weapon_Change_On_Custom> JFW_Weapon_Change_On_Custom_Registrant("JFW_Weapon_Change_On_Custom",
                                                                                     "Message:int,Powerup:string,Weapon:string");
ScriptRegistrant<JFW_Weapon_Change_On_Custom_Sender> JFW_Weapon_Change_On_Custom_Sender_Registrant(
        "JFW_Weapon_Change_On_Custom_Sender", "Message:int,Powerup:string,Weapon:string");
ScriptRegistrant<JFW_Clear_Weapons_On_Custom> JFW_Clear_Weapons_On_Custom_Registrant("JFW_Clear_Weapons_On_Custom",
                                                                                     "Message:int,Powerup:string,Weapon:string");
ScriptRegistrant<JFW_Vehicle_Weapon_Preset> JFW_Vehicle_Weapon_Preset_Registrant("JFW_Vehicle_Weapon_Preset",
                                                                                 "Powerup:string,Weapon:string,Preset:string");
ScriptRegistrant<JFW_Vehicle_Weapon_Weapon> JFW_Vehicle_Weapon_Weapon_Registrant("JFW_Vehicle_Weapon_Weapon",
                                                                                 "Powerup:string,Weapon:string,CharWeapon:string");
ScriptRegistrant<JFW_Clear_Weapons_Create> JFW_Clear_Weapons_Create_Registrant("JFW_Clear_Weapons_Create", "");
ScriptRegistrant<JFW_Weapon_Change_On_Custom_Multiple> JFW_Weapon_Change_On_Custom_Multiple_Registrant(
        "JFW_Weapon_Change_On_Custom_Multiple",
        "Message:int,Powerup1:string,Powerup2:string,Powerup3:string,Powerup4:string,Powerup5:string,Weapon:string");
ScriptRegistrant<JFW_Weapon_Change_On_Custom_Multiple_Sender> JFW_Weapon_Change_On_Custom_Multiple_Sender_Registrant(
        "JFW_Weapon_Change_On_Custom_Multiple_Sender",
        "Message:int,Powerup1:string,Powerup2:string,Powerup3:string,Powerup4:string,Powerup5:string,Weapon:string");
ScriptRegistrant<JFW_Fire_Weapon_Custom> JFW_Fire_Weapon_Custom_Registrant("JFW_Fire_Weapon_Custom",
                                                                           "Target:vector3,Custom:int");
ScriptRegistrant<JFW_Vehicle_Weapon_Switcher> JFW_Vehicle_Weapon_Switcher_Registrant("JFW_Vehicle_Weapon_Switcher",
                                                                                     "Powerup:string,Keyhook=VDeploy:string,SwitchTime:float,OldSound:string,NewSound:string");
ScriptRegistrant<JFW_Char_Weapon_Switcher> JFW_Char_Weapon_Switcher_Registrant("JFW_Char_Weapon_Switcher",
