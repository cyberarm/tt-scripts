...
bool PerkSystemIncreasePlayerPerkUnlockAmount(GameObject * obj, int
PerkID,
...
void FindPlayerPerkList(GameObject * obj, bool
Display){
};

void ClearPlayerSelectedPerks(GameObject * obj) {};
bool CheckIfPlayerHasPerkUnlocked(GameObject * obj, int
PerkID);
...
public:
    ...
    void SaveData() {
        ...
        while (Current) {
            ...
            sprintf(EncryptString,
                    "%.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %.2lf %lu %lu %.2lf %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %d %d %d %d %d %d %lu 0",
                    Current->PlayTime, Current->IdleTime, Current->Points, Current->MostPointsInARound,
                    Current->HealthPackPoints, Current->RechargePoints, Current->DefenseGunPoints,
                    Current->TeleportPoints, Current->ShieldUpgradePoints, Current->WeaponSpawnPoints, Current->Deaths,
                    Current->DeathFromElectrifiedWater, Current->DeathFromSpikePit,
                    Current->DeathFromFallingOffTheTrain, Current->DeathInLava, Current->DeathInRadioactivePit,
                    Current->DeathFromReactorRadiation, Current->DeathInFire, Current->DeathFromMiniBoss,
                    Current->KilledMiniBoss, Current->DeathFromDefenseCameras, Current->DeathFromAliens,
                    Current->DeathFromRobots, Current->DeathFromTraitors, Current->DeathFromAttackCameras,
                    Current->DeathFromGunEmplacements, Current->DeathFromShredderTurret, Current->DeathFromBansheeBoss,
                    Current->DeathFromMineBoss, Current->DeathFromMineBossSquish, Current->DeathFromMineBossResources,
                    Current->Kills, Current->Suicides, Current->KilledPlayers, Current->KilledDefenseCameras,
                    Current->KilledAliens, Current->KilledRobots, Current->KilledTraitors,
                    Current->KilledSecurityCameras, Current->KilledAttackCameras, Current->KilledGunEmplacements,
                    Current->KilledTurretBoss, Current->KilledBansheeBoss, Current->KilledMineBoss,
                    Current->Chapter1Completed, Current->Chapter2Completed, Current->Chapter3Completed,
                    Current->Chapter4Completed, Current->Chapter5Completed, Current->Chapter6Completed,
                    Current->Chapter7Completed, Current->Chapter8Completed, Current->Chapter9Completed,
                    Current->Chapter10Completed, Current->TriggeredLockdown0, Current->TriggeredLockdown1,
                    Current->TriggeredLockdown2, Current->TriggeredLockdown3, Current->TriggeredLockdown4,
                    Current->TriggeredLockdown5, Current->TriggeredLockdown6, Current->TriggeredLockdown7,
                    Current->TriggeredLockdown8, Current->TriggeredLockdown9, Current->PickedUpPlayerPlacedWeapon,
                    Current->PickedUpLaser, Current->PickedUpShotgun, Current->PickedUpSniper, Current->PickedUpFlame,
                    Current->PickedUpShockCoil, Current->PickedUpMachineGun, Current->PickedUpRoboticLaser,
                    Current->PickedUpRoboticShotgun, Current->PickedUpRoboticSniper, Current->PickedUpRoboticFlame,
                    Current->PickedUpRoboticShockCoil, Current->PickedUpRoboticMachineGun, Current->PickedUpGlitchGun,
                    Current->PickedUpHealthPack, Current->PickedUpPlayerPlacedHealthPack,
                    Current->PickedUpShieldUpgrade, Current->PickedUpPlayerShieldUpgrade, Current->PlacedMedPacks,
                    Current->PlacedRechargers, Current->PlacedTurrets, Current->PlacedTeleports,
                    Current->PlacedShieldUpgrades, Current->PlacedWeaponSpawners, Current->UsedPlayerPlacedTeleport,
                    Current->PlayTimeAsClass0, Current->PlayTimeAsClass1, Current->PlayTimeAsClass2,
                    Current->PlayTimeAsClass3, Current->PlayTimeAsClass4, Current->PlayTimeAsClass5,
                    Current->PlayTimeAsClass6, Current->PlayTimeAsClass7, Current->PlayTimeAsClass8,
                    Current->PlayTimeAsClass9, Current->PlayTimeAsClass10, Current->PlayTimeAsClass11,
                    Current->PlayTimeInSpawnRoom, Current->CompletedPlayThroughs, Current->DeathFromPlayers,
                    Current->LongestPlayTimeInARound, Current->SpawnedAsCharacter0, Current->SpawnedAsCharacter1,
                    Current->SpawnedAsCharacter2, Current->SpawnedAsCharacter3, Current->SpawnedAsCharacter4,
                    Current->SpawnedAsCharacter5, Current->SpawnedAsCharacter6, Current->SpawnedAsCharacter7,
                    Current->SpawnedAsCharacter8, Current->SpawnedAsCharacter9, Current->KilledCrates,
                    Current->PickedUpGrenadeLaunchers, Current->ElevatorButtonsPressed, Current->ElevatorLockdownButton,
                    Current->KilledBrokenDoors, Current->GlitchModeFound, Current->GlitchModeCompleted,
                    Current->FoundCheatGun, Current->OpenedFirstDoor, Current->GotKeycard, Current->KilledByRapids,
                    Current->KilledByFall, Current->TurnedOffLaserFence, Current->BackLaserFence,
                    Current->ReactorPowerRestored, Current->ComputerConsolesDeactivated, Current->CityShieldLowered,
                    Current->ElectrifiedWaterTurnedOff, Current->TunnelEntryLowered, Current->KillsWithDefenseGun,
                    Current->KillsWithCheatGun, Current->KillsWithFlameUpgrade, Current->KillsWithRoboticFlameUpgrade,
                    Current->KillsWithGlitchGun, Current->KillsWithImperialist, Current->KillsWithRoboticImperialist,
                    Current->KillsWithLaserShotgun, Current->KillsWithRoboticLaserShotgun, Current->KillsWithMachineGun,
                    Current->KillsWithRoboticMachineGun, Current->KillsWithShockCoil,
                    Current->KillsWithRoboticShockCoil, Current->KillsWithLaser, Current->KillsWithRoboticLaser,
                    Current->KillsWithHyperdeath, Current->KillsWithSuperHyperdeath, Current->KillsWithKnife,
                    Current->KillsWithGrenade, Current->KillsWithRoboticGrenade, Current->KillsWithUnknownWeapon,
                    Current->LastPlayTime.day, Current->LastPlayTime.month, Current->LastPlayTime.year,
                    Current->LastPlayTime.second, Current->LastPlayTime.minute, Current->LastPlayTime.hour,
                    Current->LastPlayTime.lTime);
            fprintf(SaveScores2, "%s\n%s\n", Current->PlayerName, EncryptString);
            fprintf(SaveScores, "%s\n%s", JmgUtility::Rp2Encrypt(Current->PlayerName, 25, 5),
                    JmgUtility::Rp2Encrypt2(EncryptString, Current->PlayerName[0], Current->PlayerName[1]));
            if (Current->next)
                fprintf(SaveScores, "\n");
            Current = Current->next;
        }
    ...
    void LoadData() {
        ...
        while (!feof(LoadScores)) {
            ...
            MetroidHighScoresNode *Current = FindOrAddPlayerMetroidHighScoreNode(
                    JmgUtility::Rp2Decrypt(PlayerName, 25, 5));
            char DecryptString[4096];
            fgets(DecryptString, 4096, LoadScores);
            sscanf(JmgUtility::Rp2Decrypt(DecryptString, Current->PlayerName[0], Current->PlayerName[1]),
                   "%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lu %lu %lf %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %d %d %d %d %d %d %lu ",
                   &Current->PlayTime, &Current->IdleTime, &Current->Points, &Current->MostPointsInARound,
                   &Current->HealthPackPoints, &Current->RechargePoints, &Current->DefenseGunPoints,
                   &Current->TeleportPoints, &Current->ShieldUpgradePoints, &Current->WeaponSpawnPoints,
                   &Current->Deaths, &Current->DeathFromElectrifiedWater, &Current->DeathFromSpikePit,
                   &Current->DeathFromFallingOffTheTrain, &Current->DeathInLava, &Current->DeathInRadioactivePit,
                   &Current->DeathFromReactorRadiation, &Current->DeathInFire, &Current->DeathFromMiniBoss,
                   &Current->KilledMiniBoss, &Current->DeathFromDefenseCameras, &Current->DeathFromAliens,
                   &Current->DeathFromRobots, &Current->DeathFromTraitors, &Current->DeathFromAttackCameras,
                   &Current->DeathFromGunEmplacements, &Current->DeathFromShredderTurret,
                   &Current->DeathFromBansheeBoss, &Current->DeathFromMineBoss, &Current->DeathFromMineBossSquish,
                   &Current->DeathFromMineBossResources, &Current->Kills, &Current->Suicides, &Current->KilledPlayers,
                   &Current->KilledDefenseCameras, &Current->KilledAliens, &Current->KilledRobots,
                   &Current->KilledTraitors, &Current->KilledSecurityCameras, &Current->KilledAttackCameras,
                   &Current->KilledGunEmplacements, &Current->KilledTurretBoss, &Current->KilledBansheeBoss,
                   &Current->KilledMineBoss, &Current->Chapter1Completed, &Current->Chapter2Completed,
                   &Current->Chapter3Completed, &Current->Chapter4Completed, &Current->Chapter5Completed,
                   &Current->Chapter6Completed, &Current->Chapter7Completed, &Current->Chapter8Completed,
                   &Current->Chapter9Completed, &Current->Chapter10Completed, &Current->TriggeredLockdown0,
                   &Current->TriggeredLockdown1, &Current->TriggeredLockdown2, &Current->TriggeredLockdown3,
                   &Current->TriggeredLockdown4, &Current->TriggeredLockdown5, &Current->TriggeredLockdown6,
                   &Current->TriggeredLockdown7, &Current->TriggeredLockdown8, &Current->TriggeredLockdown9,
                   &Current->PickedUpPlayerPlacedWeapon, &Current->PickedUpLaser, &Current->PickedUpShotgun,
                   &Current->PickedUpSniper, &Current->PickedUpFlame, &Current->PickedUpShockCoil,
                   &Current->PickedUpMachineGun, &Current->PickedUpRoboticLaser, &Current->PickedUpRoboticShotgun,
                   &Current->PickedUpRoboticSniper, &Current->PickedUpRoboticFlame, &Current->PickedUpRoboticShockCoil,
                   &Current->PickedUpRoboticMachineGun, &Current->PickedUpGlitchGun, &Current->PickedUpHealthPack,
                   &Current->PickedUpPlayerPlacedHealthPack, &Current->PickedUpShieldUpgrade,
                   &Current->PickedUpPlayerShieldUpgrade, &Current->PlacedMedPacks, &Current->PlacedRechargers,
                   &Current->PlacedTurrets, &Current->PlacedTeleports, &Current->PlacedShieldUpgrades,
                   &Current->PlacedWeaponSpawners, &Current->UsedPlayerPlacedTeleport, &Current->PlayTimeAsClass0,
                   &Current->PlayTimeAsClass1, &Current->PlayTimeAsClass2, &Current->PlayTimeAsClass3,
                   &Current->PlayTimeAsClass4, &Current->PlayTimeAsClass5, &Current->PlayTimeAsClass6,
                   &Current->PlayTimeAsClass7, &Current->PlayTimeAsClass8, &Current->PlayTimeAsClass9,
                   &Current->PlayTimeAsClass10, &Current->PlayTimeAsClass11, &Current->PlayTimeInSpawnRoom,
                   &Current->CompletedPlayThroughs, &Current->DeathFromPlayers, &Current->LongestPlayTimeInARound,
                   &Current->SpawnedAsCharacter0, &Current->SpawnedAsCharacter1, &Current->SpawnedAsCharacter2,
                   &Current->SpawnedAsCharacter3, &Current->SpawnedAsCharacter4, &Current->SpawnedAsCharacter5,
                   &Current->SpawnedAsCharacter6, &Current->SpawnedAsCharacter7, &Current->SpawnedAsCharacter8,
                   &Current->SpawnedAsCharacter9, &Current->KilledCrates, &Current->PickedUpGrenadeLaunchers,
                   &Current->ElevatorButtonsPressed, &Current->ElevatorLockdownButton, &Current->KilledBrokenDoors,
                   &Current->GlitchModeFound, &Current->GlitchModeCompleted, &Current->FoundCheatGun,
                   &Current->OpenedFirstDoor, &Current->GotKeycard, &Current->KilledByRapids, &Current->KilledByFall,
                   &Current->TurnedOffLaserFence, &Current->BackLaserFence, &Current->ReactorPowerRestored,
                   &Current->ComputerConsolesDeactivated, &Current->CityShieldLowered,
                   &Current->ElectrifiedWaterTurnedOff, &Current->TunnelEntryLowered, &Current->KillsWithDefenseGun,
                   &Current->KillsWithCheatGun, &Current->KillsWithFlameUpgrade, &Current->KillsWithRoboticFlameUpgrade,
                   &Current->KillsWithGlitchGun, &Current->KillsWithImperialist, &Current->KillsWithRoboticImperialist,
                   &Current->KillsWithLaserShotgun, &Current->KillsWithRoboticLaserShotgun,
                   &Current->KillsWithMachineGun, &Current->KillsWithRoboticMachineGun, &Current->KillsWithShockCoil,
                   &Current->KillsWithRoboticShockCoil, &Current->KillsWithLaser, &Current->KillsWithRoboticLaser,
                   &Current->KillsWithHyperdeath, &Current->KillsWithSuperHyperdeath, &Current->KillsWithKnife,
                   &Current->KillsWithGrenade, &Current->KillsWithRoboticGrenade, &Current->KillsWithUnknownWeapon,
                   &Current->LastPlayTime.day, &Current->LastPlayTime.month, &Current->LastPlayTime.year,
    ...
    inline MetroidHighScoresNode *
    EveluateHighestScore(double highValue, double currentValue, MetroidHighScoresNode *High,
                         MetroidHighScoresNode *Current) {
    ...
    inline MetroidHighScoresNode *
    EveluateHighestScore(unsigned long highValue, unsigned long currentValue, MetroidHighScoresNode *High,
                         MetroidHighScoresNode *Current) {
        if (highValue == currentValue) {
            selectRandomMatchingScore++;
            if (Commands->Get_Random(0.0f, (float) selectRandomMatchingScore) < 0.5)
    ...
    MetroidHighScoresNode *
    CompareHighScoreNodes(MetroidHighScoresNode *High, MetroidHighScoresNode *Current, int CompVal) {
        if (!High)
            return Current;
        switch (CompVal) {
            case 0:
            ...
            case 11:
                return EveluateHighestScore(High->DeathFromElectrifiedWater, Current->DeathFromElectrifiedWater, High,
                                            Current);
            case 12:
                return EveluateHighestScore(High->DeathFromSpikePit, Current->DeathFromSpikePit, High, Current);
            case 13:
                return EveluateHighestScore(High->DeathFromFallingOffTheTrain, Current->DeathFromFallingOffTheTrain,
                                            High, Current);
            case 14:
            ...
            case 16:
                return EveluateHighestScore(High->DeathFromReactorRadiation, Current->DeathFromReactorRadiation, High,
                                            Current);
            case 17:
            ...
            case 20:
                return EveluateHighestScore(High->DeathFromDefenseCameras, Current->DeathFromDefenseCameras, High,
                                            Current);
            case 21:
            ...
            case 24:
                return EveluateHighestScore(High->DeathFromAttackCameras, Current->DeathFromAttackCameras, High,
                                            Current);
            case 25:
                return EveluateHighestScore(High->DeathFromGunEmplacements, Current->DeathFromGunEmplacements, High,
                                            Current);
            case 26:
                return EveluateHighestScore(High->DeathFromShredderTurret, Current->DeathFromShredderTurret, High,
                                            Current);
            case 27:
            ...
            case 29:
                return EveluateHighestScore(High->DeathFromMineBossSquish, Current->DeathFromMineBossSquish, High,
                                            Current);
            case 30:
                return EveluateHighestScore(High->DeathFromMineBossResources, Current->DeathFromMineBossResources, High,
                                            Current);
            case 31:
            ...
            case 64:
                return EveluateHighestScore(High->PickedUpPlayerPlacedWeapon, Current->PickedUpPlayerPlacedWeapon, High,
                                            Current);
            case 65:
            ...
            case 72:
                return EveluateHighestScore(High->PickedUpRoboticShotgun, Current->PickedUpRoboticShotgun, High,
                                            Current);
            case 73:
            ...
            case 75:
                return EveluateHighestScore(High->PickedUpRoboticShockCoil, Current->PickedUpRoboticShockCoil, High,
                                            Current);
            case 76:
                return EveluateHighestScore(High->PickedUpRoboticMachineGun, Current->PickedUpRoboticMachineGun, High,
                                            Current);
            case 77:
            ...
            case 79:
                return EveluateHighestScore(High->PickedUpPlayerPlacedHealthPack,
                                            Current->PickedUpPlayerPlacedHealthPack, High, Current);
            case 80:
                return EveluateHighestScore(High->PickedUpShieldUpgrade, Current->PickedUpShieldUpgrade, High, Current);
            case 81:
                return EveluateHighestScore(High->PickedUpPlayerShieldUpgrade, Current->PickedUpPlayerShieldUpgrade,
                                            High, Current);
            case 82:
            ...
            case 88:
                return EveluateHighestScore(High->UsedPlayerPlacedTeleport, Current->UsedPlayerPlacedTeleport, High,
                                            Current);
            case 89:
            ...
            case 103:
                return EveluateHighestScore(High->LongestPlayTimeInARound, Current->LongestPlayTimeInARound, High,
                                            Current);
            case 104:
            ...
            case 115:
                return EveluateHighestScore(High->PickedUpGrenadeLaunchers, Current->PickedUpGrenadeLaunchers, High,
                                            Current);
            case 116:
                return EveluateHighestScore(High->ElevatorButtonsPressed, Current->ElevatorButtonsPressed, High,
                                            Current);
            case 117:
                return EveluateHighestScore(High->ElevatorLockdownButton, Current->ElevatorLockdownButton, High,
                                            Current);
            case 118:
            ...
            case 129:
                return EveluateHighestScore(High->ComputerConsolesDeactivated, Current->ComputerConsolesDeactivated,
                                            High, Current);
            case 130:
                return EveluateHighestScore(High->CityShieldLowered, Current->CityShieldLowered, High, Current);
            case 131:
                return EveluateHighestScore(High->ElectrifiedWaterTurnedOff, Current->ElectrifiedWaterTurnedOff, High,
                                            Current);
            case 132:
            ...
            case 136:
                return EveluateHighestScore(High->KillsWithRoboticFlameUpgrade, Current->KillsWithRoboticFlameUpgrade,
                                            High, Current);
            case 137:
            ...
            case 139:
                return EveluateHighestScore(High->KillsWithRoboticImperialist, Current->KillsWithRoboticImperialist,
                                            High, Current);
            case 140:
                return EveluateHighestScore(High->KillsWithLaserShotgun, Current->KillsWithLaserShotgun, High, Current);
            case 141:
                return EveluateHighestScore(High->KillsWithRoboticLaserShotgun, Current->KillsWithRoboticLaserShotgun,
                                            High, Current);
            case 142:
                return EveluateHighestScore(High->KillsWithMachineGun, Current->KillsWithMachineGun, High, Current);
            case 143:
                return EveluateHighestScore(High->KillsWithRoboticMachineGun, Current->KillsWithRoboticMachineGun, High,
                                            Current);
            case 144:
                return EveluateHighestScore(High->KillsWithShockCoil, Current->KillsWithShockCoil, High, Current);
            case 145:
                return EveluateHighestScore(High->KillsWithRoboticShockCoil, Current->KillsWithRoboticShockCoil, High,
                                            Current);
            case 146:
            ...
            case 149:
                return EveluateHighestScore(High->KillsWithSuperHyperdeath, Current->KillsWithSuperHyperdeath, High,
                                            Current);
            case 150:
            ...
            case 152:
                return EveluateHighestScore(High->KillsWithRoboticGrenade, Current->KillsWithRoboticGrenade, High,
                                            Current);
            case 153:
                return EveluateHighestScore(High->KillsWithUnknownWeapon, Current->KillsWithUnknownWeapon, High,
                                            Current);
            default:
    ...
    bool ReturnHighScoreNodeValue(MetroidHighScoresNode *Node, int CompVal) {
        ...
        switch (CompVal) {
            ...
            case 1:
                return Node->IdleTime ? true : false;
            case 2:
                return Node->Points ? true : false;
            case 3:
                return Node->MostPointsInARound ? true : false;
            case 4:
                return Node->HealthPackPoints ? true : false;
            case 5:
                return Node->RechargePoints ? true : false;
            case 6:
                return Node->DefenseGunPoints ? true : false;
            case 7:
                return Node->TeleportPoints ? true : false;
            case 8:
                return Node->ShieldUpgradePoints ? true : false;
            case 9:
                return Node->WeaponSpawnPoints ? true : false;
            case 10:
                return Node->Deaths ? true : false;
            case 11:
                return Node->DeathFromElectrifiedWater ? true : false;
            case 12:
                return Node->DeathFromSpikePit ? true : false;
            case 13:
                return Node->DeathFromFallingOffTheTrain ? true : false;
            case 14:
                return Node->DeathInLava ? true : false;
            case 15:
                return Node->DeathInRadioactivePit ? true : false;
            case 16:
                return Node->DeathFromReactorRadiation ? true : false;
            case 17:
                return Node->DeathInFire ? true : false;
            case 18:
                return Node->DeathFromMiniBoss ? true : false;
            case 19:
                return Node->KilledMiniBoss ? true : false;
            case 20:
                return Node->DeathFromDefenseCameras ? true : false;
            case 21:
                return Node->DeathFromAliens ? true : false;
            case 22:
                return Node->DeathFromRobots ? true : false;
            case 23:
                return Node->DeathFromTraitors ? true : false;
            case 24:
                return Node->DeathFromAttackCameras ? true : false;
            case 25:
                return Node->DeathFromGunEmplacements ? true : false;
            case 26:
                return Node->DeathFromShredderTurret ? true : false;
            case 27:
                return Node->DeathFromBansheeBoss ? true : false;
            case 28:
                return Node->DeathFromMineBoss ? true : false;
            case 29:
                return Node->DeathFromMineBossSquish ? true : false;
            case 30:
                return Node->DeathFromMineBossResources ? true : false;
            case 31:
                return Node->Kills ? true : false;
            case 32:
                return Node->Suicides ? true : false;
            case 33:
                return Node->KilledPlayers ? true : false;
            case 34:
                return Node->KilledDefenseCameras ? true : false;
            case 35:
                return Node->KilledAliens ? true : false;
            case 36:
                return Node->KilledRobots ? true : false;
            case 37:
                return Node->KilledTraitors ? true : false;
            case 38:
                return Node->KilledSecurityCameras ? true : false;
            case 39:
                return Node->KilledAttackCameras ? true : false;
            case 40:
                return Node->KilledGunEmplacements ? true : false;
            case 41:
                return Node->KilledTurretBoss ? true : false;
            case 42:
                return Node->KilledBansheeBoss ? true : false;
            case 43:
                return Node->KilledMineBoss ? true : false;
            case 44:
                return Node->Chapter1Completed ? true : false;
            case 45:
                return Node->Chapter2Completed ? true : false;
            case 46:
                return Node->Chapter3Completed ? true : false;
            case 47:
                return Node->Chapter4Completed ? true : false;
            case 48:
                return Node->Chapter5Completed ? true : false;
            case 49:
                return Node->Chapter6Completed ? true : false;
            case 50:
                return Node->Chapter7Completed ? true : false;
            case 51:
                return Node->Chapter8Completed ? true : false;
            case 52:
                return Node->Chapter9Completed ? true : false;
            case 53:
                return Node->Chapter10Completed ? true : false;
            case 54:
                return Node->TriggeredLockdown0 ? true : false;
            case 55:
                return Node->TriggeredLockdown1 ? true : false;
            case 56:
                return Node->TriggeredLockdown2 ? true : false;
            case 57:
                return Node->TriggeredLockdown3 ? true : false;
            case 58:
                return Node->TriggeredLockdown4 ? true : false;
            case 59:
                return Node->TriggeredLockdown5 ? true : false;
            case 60:
                return Node->TriggeredLockdown6 ? true : false;
            case 61:
                return Node->TriggeredLockdown7 ? true : false;
            case 62:
                return Node->TriggeredLockdown8 ? true : false;
            case 63:
                return Node->TriggeredLockdown9 ? true : false;
            case 64:
                return Node->PickedUpPlayerPlacedWeapon ? true : false;
            case 65:
                return Node->PickedUpLaser ? true : false;
            case 66:
                return Node->PickedUpShotgun ? true : false;
            case 67:
                return Node->PickedUpSniper ? true : false;
            case 68:
                return Node->PickedUpFlame ? true : false;
            case 69:
                return Node->PickedUpShockCoil ? true : false;
            case 70:
                return Node->PickedUpMachineGun ? true : false;
            case 71:
                return Node->PickedUpRoboticLaser ? true : false;
            case 72:
                return Node->PickedUpRoboticShotgun ? true : false;
            case 73:
                return Node->PickedUpRoboticSniper ? true : false;
            case 74:
                return Node->PickedUpRoboticFlame ? true : false;
            case 75:
                return Node->PickedUpRoboticShockCoil ? true : false;
            case 76:
                return Node->PickedUpRoboticMachineGun ? true : false;
            case 77:
                return Node->PickedUpGlitchGun ? true : false;
            case 78:
                return Node->PickedUpHealthPack ? true : false;
            case 79:
                return Node->PickedUpPlayerPlacedHealthPack ? true : false;
            case 80:
                return Node->PickedUpShieldUpgrade ? true : false;
            case 81:
                return Node->PickedUpPlayerShieldUpgrade ? true : false;
            case 82:
                return Node->PlacedMedPacks ? true : false;
            case 83:
                return Node->PlacedRechargers ? true : false;
            case 84:
                return Node->PlacedTurrets ? true : false;
            case 85:
                return Node->PlacedTeleports ? true : false;
            case 86:
                return Node->PlacedShieldUpgrades ? true : false;
            case 87:
                return Node->PlacedWeaponSpawners ? true : false;
            case 88:
                return Node->UsedPlayerPlacedTeleport ? true : false;
            case 89:
                return Node->PlayTimeAsClass0 ? true : false;
            case 90:
                return Node->PlayTimeAsClass1 ? true : false;
            case 91:
                return Node->PlayTimeAsClass2 ? true : false;
            case 92:
                return Node->PlayTimeAsClass3 ? true : false;
            case 93:
                return Node->PlayTimeAsClass4 ? true : false;
            case 94:
                return Node->PlayTimeAsClass5 ? true : false;
            case 95:
                return Node->PlayTimeAsClass6 ? true : false;
            case 96:
                return Node->PlayTimeAsClass7 ? true : false;
            case 97:
                return Node->PlayTimeAsClass8 ? true : false;
            case 98:
                return Node->PlayTimeAsClass9 ? true : false;
            case 99:
                return Node->PlayTimeAsClass10 ? true : false;
            case 100:
                return Node->PlayTimeAsClass11 ? true : false;
            case 101:
                return Node->CompletedPlayThroughs ? true : false;
            case 102:
                return Node->DeathFromPlayers ? true : false;
            case 103:
                return Node->LongestPlayTimeInARound ? true : false;
            case 104:
                return Node->SpawnedAsCharacter0 ? true : false;
            case 105:
                return Node->SpawnedAsCharacter1 ? true : false;
            case 106:
                return Node->SpawnedAsCharacter2 ? true : false;
            case 107:
                return Node->SpawnedAsCharacter3 ? true : false;
            case 108:
                return Node->SpawnedAsCharacter4 ? true : false;
            case 109:
                return Node->SpawnedAsCharacter5 ? true : false;
            case 110:
                return Node->SpawnedAsCharacter6 ? true : false;
            case 111:
                return Node->SpawnedAsCharacter7 ? true : false;
            case 112:
                return Node->SpawnedAsCharacter8 ? true : false;
            case 113:
                return Node->SpawnedAsCharacter9 ? true : false;
            case 114:
                return Node->KilledCrates ? true : false;
            case 115:
                return Node->PickedUpGrenadeLaunchers ? true : false;
            case 116:
                return Node->ElevatorButtonsPressed ? true : false;
            case 117:
                return Node->ElevatorLockdownButton ? true : false;
            case 118:
                return Node->KilledBrokenDoors ? true : false;
            case 119:
                return Node->GlitchModeFound ? true : false;
            case 120:
                return Node->GlitchModeCompleted ? true : false;
            case 121:
                return Node->FoundCheatGun ? true : false;
            case 122:
                return Node->OpenedFirstDoor ? true : false;
            case 123:
                return Node->FoundCheatGun ? true : false;
            case 124:
                return Node->KilledByRapids ? true : false;
            case 125:
                return Node->KilledByFall ? true : false;
            case 126:
                return Node->TurnedOffLaserFence ? true : false;
            case 127:
                return Node->BackLaserFence ? true : false;
            case 128:
                return Node->ReactorPowerRestored ? true : false;
            case 129:
                return Node->ComputerConsolesDeactivated ? true : false;
            case 130:
                return Node->CityShieldLowered ? true : false;
            case 131:
                return Node->ElectrifiedWaterTurnedOff ? true : false;
            case 132:
                return Node->TunnelEntryLowered ? true : false;
            case 133:
                return Node->KillsWithDefenseGun ? true : false;
            case 134:
                return Node->KillsWithCheatGun ? true : false;
            case 135:
                return Node->KillsWithFlameUpgrade ? true : false;
            case 136:
                return Node->KillsWithRoboticFlameUpgrade ? true : false;
            case 137:
                return Node->KillsWithGlitchGun ? true : false;
            case 138:
                return Node->KillsWithImperialist ? true : false;
            case 139:
                return Node->KillsWithRoboticImperialist ? true : false;
            case 140:
                return Node->KillsWithLaserShotgun ? true : false;
            case 141:
                return Node->KillsWithRoboticLaserShotgun ? true : false;
            case 142:
                return Node->KillsWithMachineGun ? true : false;
            case 143:
                return Node->KillsWithRoboticMachineGun ? true : false;
            case 144:
                return Node->KillsWithShockCoil ? true : false;
            case 145:
                return Node->KillsWithRoboticShockCoil ? true : false;
            case 146:
                return Node->KillsWithLaser ? true : false;
            case 147:
                return Node->KillsWithRoboticLaser ? true : false;
            case 148:
                return Node->KillsWithHyperdeath ? true : false;
            case 149:
                return Node->KillsWithSuperHyperdeath ? true : false;
            case 150:
                return Node->KillsWithKnife ? true : false;
            case 151:
                return Node->KillsWithGrenade ? true : false;
            case 152:
                return Node->KillsWithRoboticGrenade ? true : false;
            case 153:
                return Node->KillsWithUnknownWeapon ? true : false;
            default:
                return Node->PlayTimeInSpawnRoom ? true : false;
        }
    }
    ...
    char *ReturnScore(MetroidHighScoresNode *High, int CompVal) {
        ...
        switch (CompVal) {
            case 0:
                sprintf(RetChar, "Server Record: %s has played for %.0lf minutes.", High->PlayerName,
                        High->PlayTime / 60.0f);
                return RetChar;
            case 1:
                sprintf(RetChar, "Server Record: %s been ilde for %.0lf minutes.", High->PlayerName,
                        High->IdleTime / 60.0f);
                return RetChar;
            case 2:
                sprintf(RetChar, "Server Record: %s has scored a total of %.0lf points.", High->PlayerName,
                        High->Points);
                return RetChar;
            case 3:
                sprintf(RetChar, "Server Record: %s has socred %.0lf points in a single round.", High->PlayerName,
                        High->MostPointsInARound);
                return RetChar;
            case 4:
                sprintf(RetChar, "Server Record: %s has socred %.0lf points from placed Health Packs.",
                        High->PlayerName, High->HealthPackPoints);
                return RetChar;
            case 5:
                sprintf(RetChar, "Server Record: %s has socred %.0lf points Recharging Shields.", High->PlayerName,
                        High->RechargePoints);
                return RetChar;
            case 6:
                sprintf(RetChar, "Server Record: %s has scored %.0lf points via Defense Guns.", High->PlayerName,
                        High->DefenseGunPoints);
                return RetChar;
            case 7:
                sprintf(RetChar, "Server Record: %s has socred %.0lf points from Telepad use.", High->PlayerName,
                        High->TeleportPoints);
                return RetChar;
            case 8:
                sprintf(RetChar, "Server Record: %s has scored %.0lf points by handing out Shield Upgrades.",
                        High->PlayerName, High->ShieldUpgradePoints);
                return RetChar;
            case 9:
                sprintf(RetChar, "Server Record: %s has scored %.0lf points from placed Weapon Spawners.",
                        High->PlayerName, High->WeaponSpawnPoints);
                return RetChar;
            case 10:
                sprintf(RetChar, "Server Record: %s has been killed a total of %lu times.", High->PlayerName,
                        High->Deaths);
                return RetChar;
            case 11:
                sprintf(RetChar, "Server Record: %s has fallen into Electrified Water %lu times.", High->PlayerName,
                        High->DeathFromElectrifiedWater);
                return RetChar;
            case 12:
                sprintf(RetChar, "Server Record: %s has fallen into Spike Pits %lu times.", High->PlayerName,
                        High->DeathFromSpikePit);
                return RetChar;
            case 13:
                sprintf(RetChar, "Server Record: %s has fallen off the Train %lu times.", High->PlayerName,
                        High->DeathFromFallingOffTheTrain);
                return RetChar;
            case 14:
                sprintf(RetChar, "Server Record: %s has died in Lava %lu times.", High->PlayerName, High->DeathInLava);
                return RetChar;
            case 15:
                sprintf(RetChar, "Server Record: %s has died in the Radioactive Pit %lu times.", High->PlayerName,
                        High->DeathInRadioactivePit);
                return RetChar;
            case 16:
                sprintf(RetChar, "Server Record: %s has died from radiation from the Reactor %lu times.",
                        High->PlayerName, High->DeathFromReactorRadiation);
                return RetChar;
            case 17:
                sprintf(RetChar, "Server Record: %s has died in Fire %lu times.", High->PlayerName, High->DeathInFire);
                return RetChar;
            case 18:
                sprintf(RetChar, "Server Record: %s has been killed by the Boss Alien %lu times.", High->PlayerName,
                        High->DeathFromMiniBoss);
                return RetChar;
            case 19:
                sprintf(RetChar, "Server Record: %s has killed the Boss Alien %lu times.", High->PlayerName,
                        High->KilledMiniBoss);
                return RetChar;
            case 20:
                sprintf(RetChar, "Server Record: %s has been killed by Defense Turrets %lu times.", High->PlayerName,
                        High->DeathFromDefenseCameras);
                return RetChar;
            case 21:
                sprintf(RetChar, "Server Record: %s has been killed by Aliens %lu times.", High->PlayerName,
                        High->DeathFromAliens);
                return RetChar;
            case 22:
                sprintf(RetChar, "Server Record: %s has been killed by Robots %lu times.", High->PlayerName,
                        High->DeathFromRobots);
                return RetChar;
            case 23:
                sprintf(RetChar, "Server Record: %s has been killed by Traitors %lu times.", High->PlayerName,
                        High->DeathFromTraitors);
                return RetChar;
            case 24:
                sprintf(RetChar, "Server Record: %s has been killed by Attack Cameras %lu times.", High->PlayerName,
                        High->DeathFromAttackCameras);
                return RetChar;
            case 25:
                sprintf(RetChar, "Server Record: %s has been killed by Gun Emplacements %lu times.", High->PlayerName,
                        High->DeathFromGunEmplacements);
                return RetChar;
            case 26:
                sprintf(RetChar, "Server Record: %s has been killed by the Shredder Turret %lu times.",
                        High->PlayerName, High->DeathFromShredderTurret);
                return RetChar;
            case 27:
                sprintf(RetChar, "Server Record: %s has been killed by the Alien Strike Craft %lu times.",
                        High->PlayerName, High->DeathFromBansheeBoss);
                return RetChar;
            case 28:
                sprintf(RetChar, "Server Record: %s has been killed by the Mine Equipment %lu times.", High->PlayerName,
                        High->DeathFromMineBoss);
                return RetChar;
            case 29:
                sprintf(RetChar, "Server Record: %s has been squished by the Mine Equipment %lu times.",
                        High->PlayerName, High->DeathFromMineBossSquish);
                return RetChar;
            case 30:
                sprintf(RetChar, "Server Record: %s has been turned to resources by the Mine Equipment %lu times.",
                        High->PlayerName, High->DeathFromMineBossResources);
                return RetChar;
            case 31:
                sprintf(RetChar, "Server Record: %s has killed %lu enemies.", High->PlayerName, High->Kills);
                return RetChar;
            case 32:
                sprintf(RetChar, "Server Record: %s has killed theirself %lu times.", High->PlayerName, High->Suicides);
                return RetChar;
            case 33:
                sprintf(RetChar, "Server Record: %s has killed other players %lu times.", High->PlayerName,
                        High->KilledPlayers);
                return RetChar;
            case 34:
                sprintf(RetChar, "Server Record: %s has destroyed %lu Defense Cameras.", High->PlayerName,
                        High->KilledDefenseCameras);
                return RetChar;
            case 35:
                sprintf(RetChar, "Server Record: %s has killed %lu Aliens.", High->PlayerName, High->KilledAliens);
                return RetChar;
            case 36:
                sprintf(RetChar, "Server Record: %s has destroyed %lu Robots.", High->PlayerName, High->KilledRobots);
                return RetChar;
            case 37:
                sprintf(RetChar, "Server Record: %s has killed %lu Traitors.", High->PlayerName, High->KilledTraitors);
                return RetChar;
            case 38:
                sprintf(RetChar, "Server Record: %s has destroyed %lu Security Cameras.", High->PlayerName,
                        High->KilledSecurityCameras);
                return RetChar;
            case 39:
                sprintf(RetChar, "Server Record: %s has destroyed %lu Attack Cameras.", High->PlayerName,
                        High->KilledAttackCameras);
                return RetChar;
            case 40:
                sprintf(RetChar, "Server Record: %s has destroyed %lu Gun Emplacements.", High->PlayerName,
                        High->KilledGunEmplacements);
                return RetChar;
            case 41:
                sprintf(RetChar, "Server Record: %s has destroyed the Shredder Turret %lu times.", High->PlayerName,
                        High->KilledTurretBoss);
                return RetChar;
            case 42:
                sprintf(RetChar, "Server Record: %s has destroyed the Alien Attack Craft %lu times.", High->PlayerName,
                        High->KilledBansheeBoss);
                return RetChar;
            case 43:
                sprintf(RetChar, "Server Record: %s has destroyed the Mine Equipment %lu times.", High->PlayerName,
                        High->KilledMineBoss);
                return RetChar;
            case 44:
                sprintf(RetChar, "Server Record: %s has completed Chapter 1 %lu times.", High->PlayerName,
                        High->Chapter1Completed);
                return RetChar;
            case 45:
                sprintf(RetChar, "Server Record: %s has completed Chapter 2 %lu times.", High->PlayerName,
                        High->Chapter2Completed);
                return RetChar;
            case 46:
                sprintf(RetChar, "Server Record: %s has completed Chapter 3 %lu times.", High->PlayerName,
                        High->Chapter3Completed);
                return RetChar;
            case 47:
                sprintf(RetChar, "Server Record: %s has completed Chapter 4 %lu times.", High->PlayerName,
                        High->Chapter4Completed);
                return RetChar;
            case 48:
                sprintf(RetChar, "Server Record: %s has completed Chapter 5 %lu times.", High->PlayerName,
                        High->Chapter5Completed);
                return RetChar;
            case 49:
                sprintf(RetChar, "Server Record: %s has completed Chapter 6 %lu times.", High->PlayerName,
                        High->Chapter6Completed);
                return RetChar;
            case 50:
                sprintf(RetChar, "Server Record: %s has completed Chapter 7 %lu times.", High->PlayerName,
                        High->Chapter7Completed);
                return RetChar;
            case 51:
                sprintf(RetChar, "Server Record: %s has completed Chapter 8 %lu times", High->PlayerName,
                        High->Chapter8Completed);
                return RetChar;
            case 52:
                sprintf(RetChar, "Server Record: %s has completed Chapter 9 %lu times", High->PlayerName,
                        High->Chapter9Completed);
                return RetChar;
            case 53:
                sprintf(RetChar, "Server Record: %s has completed Chapter 10 %lu times", High->PlayerName,
                        High->Chapter10Completed);
                return RetChar;
            case 54:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 1 %lu times.", High->PlayerName,
                        High->TriggeredLockdown0);
                return RetChar;
            case 55:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 2 %lu times.", High->PlayerName,
                        High->TriggeredLockdown1);
                return RetChar;
            case 56:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 3 %lu times.", High->PlayerName,
                        High->TriggeredLockdown2);
                return RetChar;
            case 57:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 4 %lu times.", High->PlayerName,
                        High->TriggeredLockdown3);
                return RetChar;
            case 58:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 5 %lu times.", High->PlayerName,
                        High->TriggeredLockdown4);
                return RetChar;
            case 59:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 6 %lu times.", High->PlayerName,
                        High->TriggeredLockdown5);
                return RetChar;
            case 60:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 7 %lu times.", High->PlayerName,
                        High->TriggeredLockdown6);
                return RetChar;
            case 61:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 8 %lu times.", High->PlayerName,
                        High->TriggeredLockdown7);
                return RetChar;
            case 62:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 9 %lu times.", High->PlayerName,
                        High->TriggeredLockdown8);
                return RetChar;
            case 63:
                sprintf(RetChar, "Server Record: %s has triggered Lockdown Zone 10 %lu times.", High->PlayerName,
                        High->TriggeredLockdown9);
                return RetChar;
            case 64:
                sprintf(RetChar, "Server Record: %s has acquired %lu weapons placed by other players.",
                        High->PlayerName, High->PickedUpPlayerPlacedWeapon);
                return RetChar;
            case 65:
                sprintf(RetChar, "Server Record: %s has acquired %lu Laser Gun upgrades.", High->PlayerName,
                        High->PickedUpLaser);
                return RetChar;
            case 66:
                sprintf(RetChar, "Server Record: %s has acquired %lu Laser Shotgun upgrades.", High->PlayerName,
                        High->PickedUpShotgun);
                return RetChar;
            case 67:
                sprintf(RetChar, "Server Record: %s has acquired %lu Imperialist upgrades.", High->PlayerName,
                        High->PickedUpSniper);
                return RetChar;
            case 68:
                sprintf(RetChar, "Server Record: %s has acquired %lu Flame upgrades.", High->PlayerName,
                        High->PickedUpFlame);
                return RetChar;
            case 69:
                sprintf(RetChar, "Server Record: %s has acquired %lu Shock Coil upgrades.", High->PlayerName,
                        High->PickedUpShockCoil);
                return RetChar;
            case 70:
                sprintf(RetChar, "Server Record: %s has acquired %lu Machinegun upgrades.", High->PlayerName,
                        High->PickedUpMachineGun);
                return RetChar;
            case 71:
                sprintf(RetChar, "Server Record: %s has acquired %lu Robotic Laser Gun upgrades.", High->PlayerName,
                        High->PickedUpRoboticLaser);
                return RetChar;
            case 72:
                sprintf(RetChar, "Server Record: %s has acquired %lu Robotic Laser Shotgun upgrades.", High->PlayerName,
                        High->PickedUpRoboticShotgun);
                return RetChar;
            case 73:
                sprintf(RetChar, "Server Record: %s has acquired %lu Robotic Imperialist upgrades.", High->PlayerName,
                        High->PickedUpRoboticSniper);
                return RetChar;
            case 74:
                sprintf(RetChar, "Server Record: %s has acquired %lu Robotic Flame upgrades.", High->PlayerName,
                        High->PickedUpRoboticFlame);
                return RetChar;
            case 75:
                sprintf(RetChar, "Server Record: %s has acquired %lu Robotic Shock Coil upgrades.", High->PlayerName,
                        High->PickedUpRoboticShockCoil);
                return RetChar;
            case 76:
                sprintf(RetChar, "Server Record: %s has acquired %lu Robotic Machinegun upgrades.", High->PlayerName,
                        High->PickedUpRoboticMachineGun);
                return RetChar;
            case 77:
                sprintf(RetChar, "Server Record: %s has acquired %lu Glitch Guns.", High->PlayerName,
                        High->PickedUpGlitchGun);
                return RetChar;
            case 78:
                sprintf(RetChar, "Server Record: %s has acquired %lu Health Packs.", High->PlayerName,
                        High->PickedUpHealthPack);
                return RetChar;
            case 79:
                sprintf(RetChar, "Server Record: %s has acquired %lu player placed Health Packs.", High->PlayerName,
                        High->PickedUpPlayerPlacedHealthPack);
                return RetChar;
            case 80:
                sprintf(RetChar, "Server Record: %s has acquired %lu Shield Upgrades.", High->PlayerName,
                        High->PickedUpShieldUpgrade);
                return RetChar;
            case 81:
                sprintf(RetChar, "Server Record: %s has acquired %lu player placed Shield Upgrades.", High->PlayerName,
                        High->PickedUpPlayerShieldUpgrade);
                return RetChar;
            case 82:
                sprintf(RetChar, "Server Record: %s has placed %lu Med Packs.", High->PlayerName, High->PlacedMedPacks);
                return RetChar;
            case 83:
                sprintf(RetChar, "Server Record: %s has placed %lu Shield Rechargers.", High->PlayerName,
                        High->PlacedRechargers);
                return RetChar;
            case 84:
                sprintf(RetChar, "Server Record: %s has placed %lu Defense Turrets.", High->PlayerName,
                        High->PlacedTurrets);
                return RetChar;
            case 85:
                sprintf(RetChar, "Server Record: %s has placed %lu Telepads.", High->PlayerName, High->PlacedTeleports);
                return RetChar;
            case 86:
                sprintf(RetChar, "Server Record: %s has placed %lu Shield Upgrades.", High->PlayerName,
                        High->PlacedShieldUpgrades);
                return RetChar;
            case 87:
                sprintf(RetChar, "Server Record: %s has placed %lu Weapon Spawners.", High->PlayerName,
                        High->PlacedWeaponSpawners);
                return RetChar;
            case 88:
                sprintf(RetChar, "Server Record: %s has used %lu player placed Telepads.", High->PlayerName,
                        High->UsedPlayerPlacedTeleport);
                return RetChar;
            case 89:
                sprintf(RetChar, "Server Record: %s has played as Armor Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass0 / 60.0);
                return RetChar;
            case 90:
                sprintf(RetChar, "Server Record: %s has played as Speed Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass1 / 60.0);
                return RetChar;
            case 91:
                sprintf(RetChar, "Server Record: %s has played as Firepower Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass2 / 60.0);
                return RetChar;
            case 92:
                sprintf(RetChar, "Server Record: %s has played as Support Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass3 / 60.0);
                return RetChar;
            case 93:
                sprintf(RetChar, "Server Record: %s has played as Defense Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass4 / 60.0);
                return RetChar;
            case 94:
                sprintf(RetChar, "Server Record: %s has played as  Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass5 / 60.0);
                return RetChar;
            case 95:
                sprintf(RetChar, "Server Record: %s has played as Supply Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass6 / 60.0);
                return RetChar;
            case 96:
                sprintf(RetChar, "Server Record: %s has played as N/A Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass7 / 60.0);
                return RetChar;
            case 97:
                sprintf(RetChar, "Server Record: %s has played as N/A Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass8 / 60.0);
                return RetChar;
            case 98:
                sprintf(RetChar, "Server Record: %s has played as Cheat Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass9 / 60.0);
                return RetChar;
            case 99:
                sprintf(RetChar, "Server Record: %s has played as Training Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass10 / 60.0);
                return RetChar;
            case 100:
                sprintf(RetChar, "Server Record: %s has played as N/A Mode for %.0lf mintues.", High->PlayerName,
                        High->PlayTimeAsClass11 / 60.0);
                return RetChar;
            case 101:
                sprintf(RetChar, "Server Record: %s has completed the story %lu times.", High->PlayerName,
                        High->CompletedPlayThroughs);
                return RetChar;
            case 102:
                sprintf(RetChar, "Server Record: %s has been killed by friendly fire %lu times.", High->PlayerName,
                        High->DeathFromPlayers);
                return RetChar;
            case 103:
                sprintf(RetChar, "Server Record: %s has spent %.0lf minutes in a single game.", High->PlayerName,
                        High->LongestPlayTimeInARound / 60.0);
                return RetChar;
            case 104:
                sprintf(RetChar, "Server Record: %s has spawned as Armor Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter0);
                return RetChar;
            case 105:
                sprintf(RetChar, "Server Record: %s has spawned as Speed Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter1);
                return RetChar;
            case 106:
                sprintf(RetChar, "Server Record: %s has spawned as Firepower Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter2);
                return RetChar;
            case 107:
                sprintf(RetChar, "Server Record: %s has spawned as Support Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter3);
                return RetChar;
            case 108:
                sprintf(RetChar, "Server Record: %s has spawned as Defense Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter4);
                return RetChar;
            case 109:
                sprintf(RetChar, "Server Record: %s has spawned as Supply Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter5);
                return RetChar;
            case 110:
                sprintf(RetChar, "Server Record: %s has spawned as N/A Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter6);
                return RetChar;
            case 111:
                sprintf(RetChar, "Server Record: %s has spawned as N/A Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter7);
                return RetChar;
            case 112:
                sprintf(RetChar, "Server Record: %s has spawned as N/A Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter8);
                return RetChar;
            case 113:
                sprintf(RetChar, "Server Record: %s has spawned as Cheat Mode %lu times.", High->PlayerName,
                        High->SpawnedAsCharacter9);
                return RetChar;
            case 114:
                sprintf(RetChar, "Server Record: %s has destroyed %lu crates.", High->PlayerName, High->KilledCrates);
                return RetChar;
            case 115:
                sprintf(RetChar, "Server Record: %s has acquired %lu Grenade Launcher upgrades.", High->PlayerName,
                        High->PickedUpGrenadeLaunchers);
                return RetChar;
            case 116:
                sprintf(RetChar, "Server Record: %s has activated %lu elevator buttons.", High->PlayerName,
                        High->ElevatorButtonsPressed);
                return RetChar;
            case 117:
                sprintf(RetChar, "Server Record: %s has deactivated %lu drill security lockouts.", High->PlayerName,
                        High->ElevatorLockdownButton);
                return RetChar;
            case 118:
                sprintf(RetChar, "Server Record: %s has destroyed the jammed doors %lu times.", High->PlayerName,
                        High->KilledBrokenDoors);
                return RetChar;
            case 119:
                sprintf(RetChar, "Server Record: %s has found the glitch %lu times.", High->PlayerName,
                        High->GlitchModeFound);
                return RetChar;
            case 120:
                sprintf(RetChar, "Server Record: %s has escaped the glitch %lu times.", High->PlayerName,
                        High->GlitchModeCompleted);
                return RetChar;
            case 121:
                sprintf(RetChar, "Server Record: %s has acquired The Cheat Gun %lu times.", High->PlayerName,
                        High->FoundCheatGun);
                return RetChar;
            case 122:
                sprintf(RetChar, "Server Record: %s has opened the security room door %lu times.", High->PlayerName,
                        High->OpenedFirstDoor);
                return RetChar;
            case 123:
                sprintf(RetChar, "Server Record: %s has acquired %lu keycards.", High->PlayerName, High->GotKeycard);
                return RetChar;
            case 124:
                sprintf(RetChar, "Server Record: %s has fallen into the rapids %lu times.", High->PlayerName,
                        High->KilledByRapids);
                return RetChar;
            case 125:
                sprintf(RetChar, "Server Record: %s has fallen off the cliff %lu times.", High->PlayerName,
                        High->KilledByFall);
                return RetChar;
            case 126:
                sprintf(RetChar, "Server Record: %s has turned off the laser fence %lu times.", High->PlayerName,
                        High->TurnedOffLaserFence);
                return RetChar;
            case 127:
                sprintf(RetChar, "Server Record: %s has turned off the back laser fence %lu times.", High->PlayerName,
                        High->BackLaserFence);
                return RetChar;
            case 128:
                sprintf(RetChar, "Server Record: %s has restored the reactor power %lu times.", High->PlayerName,
                        High->ReactorPowerRestored);
                return RetChar;
            case 129:
                sprintf(RetChar, "Server Record: %s has deactivated %lu computer consoles.", High->PlayerName,
                        High->ComputerConsolesDeactivated);
                return RetChar;
            case 130:
                sprintf(RetChar, "Server Record: %s has lowered the city laser fence %lu times.", High->PlayerName,
                        High->CityShieldLowered);
                return RetChar;
            case 131:
                sprintf(RetChar, "Server Record: %s has turned off the electrified water %lu times.", High->PlayerName,
                        High->ElectrifiedWaterTurnedOff);
                return RetChar;
            case 132:
                sprintf(RetChar, "Server Record: %s has turned off the laser fence blocking the building %lu times.",
                        High->PlayerName, High->TunnelEntryLowered);
                return RetChar;
            case 133:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Deployable Defense Turret.",
                        High->PlayerName, High->KillsWithDefenseGun);
                return RetChar;
            case 134:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Cheating Gun.", High->PlayerName,
                        High->KillsWithCheatGun);
                return RetChar;
            case 135:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Flame Upgrade.", High->PlayerName,
                        High->KillsWithFlameUpgrade);
                return RetChar;
            case 136:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Robotic Flame Upgrade.",
                        High->PlayerName, High->KillsWithRoboticFlameUpgrade);
                return RetChar;
            case 137:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Glitch Gun.", High->PlayerName,
                        High->KillsWithGlitchGun);
                return RetChar;
            case 138:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Imperialist.", High->PlayerName,
                        High->KillsWithImperialist);
                return RetChar;
            case 139:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Robotic Imperalist.",
                        High->PlayerName, High->KillsWithRoboticImperialist);
                return RetChar;
            case 140:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Laser Shotgun.", High->PlayerName,
                        High->KillsWithLaserShotgun);
                return RetChar;
            case 141:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Robotic Laser Shotgun.",
                        High->PlayerName, High->KillsWithRoboticLaserShotgun);
                return RetChar;
            case 142:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Machinegun.", High->PlayerName,
                        High->KillsWithMachineGun);
                return RetChar;
            case 143:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Robotic Machinegun.",
                        High->PlayerName, High->KillsWithRoboticMachineGun);
                return RetChar;
            case 144:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Shock Coil.", High->PlayerName,
                        High->KillsWithShockCoil);
                return RetChar;
            case 145:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Robotic Shock Coil.",
                        High->PlayerName, High->KillsWithRoboticShockCoil);
                return RetChar;
            case 146:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Laser.", High->PlayerName,
                        High->KillsWithLaser);
                return RetChar;
            case 147:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Robotic Laser.", High->PlayerName,
                        High->KillsWithRoboticLaser);
                return RetChar;
            case 148:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Kinetic Cannon.", High->PlayerName,
                        High->KillsWithHyperdeath);
                return RetChar;
            case 149:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Energy Beam.", High->PlayerName,
                        High->KillsWithSuperHyperdeath);
                return RetChar;
            case 150:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Knife.", High->PlayerName,
                        High->KillsWithKnife);
                return RetChar;
            case 151:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Grenade Launcher.",
                        High->PlayerName, High->KillsWithGrenade);
                return RetChar;
            case 152:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with the Robotic Grenade Launcher.",
                        High->PlayerName, High->KillsWithRoboticGrenade);
                return RetChar;
            case 153:
                sprintf(RetChar, "Server Record: %s has killed %ld enemies with an Unknown Device.", High->PlayerName,
                        High->KillsWithUnknownWeapon);
                return RetChar;
            default:
                sprintf(RetChar, "Server Record: %s has spent %.0lf minutes in the spawn room.", High->PlayerName,
                        High->PlayTimeInSpawnRoom / 60.0);
                return RetChar;
        }
    }
...
void Set_Shader_Number_Vector(GameObject * Player, int
eventid,
Vector4 parameter
)
{
...
sprintf_s(text,
"%s",
MetroidStringLibrary(eventid)
);
JmgUtility::DisplayChatMessage(Player,
(int)(parameter.Y*255),(int)(parameter.Z*255),(int)(parameter.W*255),text);
}
...
{
case 99:
sprintf_s(textString,
"Control panel deactivated (%.0f/3)",parameter.Y);
Set_HUD_Help_Text_Player_Text(Player,
7233,textString,Vector3(0.0,1.0,0.0));break;
case 999:
sprintf_s(textString,
"Incorrect code! Counter measures activated!");break;
case 998:
sprintf_s(textString,
"A terminal has been reset!");break;
case 997:
sprintf_s(textString,
"You moved out of range!");break;
case 0:
sprintf_s(textString,
"Press Numpad 0!");break;
case 1:
sprintf_s(textString,
"Press Numpad 1!");break;
case 2:
sprintf_s(textString,
"Press Numpad 2!");break;
case 3:
sprintf_s(textString,
"Press Numpad 3!");break;
case 4:
sprintf_s(textString,
"Press Numpad 4!");break;
case 5:
sprintf_s(textString,
"Press Numpad 5!");break;
case 6:
sprintf_s(textString,
"Press Numpad 6!");break;
case 7:
sprintf_s(textString,
"Press Numpad 7!");break;
case 8:
sprintf_s(textString,
"Press Numpad 8!");break;
case 9:
sprintf_s(textString,
"Press Numpad 9!");break;
default:
sprintf_s(textString,
"INVALID DISARM STRING!");break;
}
if (eventid == 999 || eventid == 998 || eventid == 997)
JmgUtility::DisplayChatMessage(Player,
(int)(1.0f*255),(int)(0.1f*255),(int)(0.1f*255),textString);
else if (eventid == 99)
JmgUtility::DisplayChatMessage(Player,
(int)(0.0f*255),(int)(0.5f*255),(int)(1.0f*255),textString);
else
JmgUtility::DisplayChatMessage(Player,
(int)(0.1f*255),(int)(1.0f*255),(int)(0.1f*255),textString);
}
...
{
sprintf_s(textString,
"Security Console Deactivated (%d/3)",(int)parameter.Y);
Set_HUD_Help_Text_Player_Text(Player,
7233,textString,Vector3(0.0,1.0,0.0));
}
else
sprintf_s(textString,
...
public:
    ...
    CoverPointNode *
    FindBestCoverPoint(const Vector3 &MyPos, Vector3 *TargetPos, int groupID, float MyMaxDistance, float TargetMaxDist,
                       int MaxSoldiersAtCP) {
        CoverPointNode *Current = CoverPointNodeList;
        ...
        float dist = 0.0f;
        while (Current) {
            if (Current->GroupID == groupID && (!MaxSoldiersAtCP || Current->GuardCount < MaxSoldiersAtCP) &&
                (MyMaxDistance <= 0 || MyMaxDistance >= JmgUtility::SimpleDistance(MyPos, Current->coverPos))) {
    ...
    CoverPointNode *
    GetRandomCoverPoint(Vector3 *TargetPos, const Vector3 &SearchLocation, int groupID, int MaxSoldiersAtCP,
                        float MaxDistance) {
        CoverPointNode *Current = CoverPointNodeList;
    ...
    void CheckForErrors() {
        ...
        while (Current) {
            if (!Current->AmbushPoints) {
                char errorMsg[512];
                sprintf(errorMsg, "msg AmbushPointSystem ERROR: ObjectID:%d PointID:%d has no target points!",
                        Current->gameID, Current->ID);
...
public:
            ...
            if (TerminalID == MineTerminalID[x]) {
                if (!MineTerminalDeactivated[x]) {
                    ...
                    MetroidScoreControl.MetroidPlayerHighScoreNodes[JmgUtility::JMG_Get_Player_ID(
                            obj)]->ComputerConsolesDeactivated++;
                    for (int y = 1; y < 128; y++) {
                        GameObject * Player = Get_GameObj(y);
                        if (!Player)
                            continue;
                        Set_Shader_Number_Vector(Player, 99,
                                                 Vector4(4920037.0f, (float) NumberOfDeactivatedTerminals, 0.0f, 0.0f));
    ...
    void DisplayDynamicHUDMessage(int StringID, float SpecialParam1, float SpecialParam2 = 0.0f,
...
class JMG_Metroid_Mine_Boss : public ScriptImpClass {
    ...
    void
    Goto_Location(GameObject *obj, const Vector3 &TargetLocation, bool Pathfind, float ArriveDistance, bool Backward,
                  bool Monitor, float Speed);
    ...
    struct PlayerSettingsNode {
        ...
        void ChapterCompleted(GameObject *obj, int ChapterID) {
            ...
            if (!ChaptersCompleted[ChapterID]) {
                MetroidScoreSystem::MetroidHighScoresNode *msNode = MetroidScoreControl.MetroidPlayerHighScoreNodes[JmgUtility::JMG_Get_Player_ID(
                        obj)];
                switch (ChapterID) {
                    case 0:
                        msNode->Chapter1Completed++;
                        break;
                    case 1:
                        msNode->Chapter2Completed++;
                        break;
                    case 2:
                        msNode->Chapter3Completed++;
                        break;
                    case 3:
                        msNode->Chapter4Completed++;
                        break;
                    case 4:
                        msNode->Chapter5Completed++;
                        break;
                    case 5:
                        msNode->Chapter6Completed++;
                        break;
                    case 6:
                        msNode->Chapter7Completed++;
                        break;
                    case 7:
                        msNode->Chapter8Completed++;
                        break;
                    case 8:
                        msNode->Chapter9Completed++;
                        break;
                    case 9:
                        msNode->Chapter10Completed++;
                        break;
                }
                ...
                char ChapterNames[METROIDCHAPTERS][128] = {"Ruined", "We need moar power!", "Ship Wrecked", "Pitfall",
                                                           "Trained on victory", "Bad Traffic", "Freeze Dried",
                                                           "Going Deep", "Those are mine resources"};
                char chpmsg[512];
                sprintf(chpmsg, "Chapter %d: \"%s\" Complete (%d/%d)", ChapterID + 1, ChapterNames[ChapterID],
                        TotalChaptersCompleted, METROIDCHAPTERS);
                JmgUtility::DisplayChatMessage(obj, 220, 220, 220, chpmsg);
                if (msNode->Chapter1Completed && msNode->Chapter2Completed && msNode->Chapter3Completed &&
                    msNode->Chapter4Completed && msNode->Chapter5Completed && msNode->Chapter6Completed &&
                    msNode->Chapter7Completed && msNode->Chapter8Completed && msNode->Chapter9Completed) {
...
inline void JMGGivePoints(GameObject * obj, float
points,
int playerId
)
{
Commands->
Give_Points(obj, points,
false);
MetroidScoreControl.MetroidPlayerHighScoreNodes[playerId]->pointsThisRound +=
points;
MetroidScoreControl.MetroidPlayerHighScoreNodes[playerId]->Points +=
points;
}
...
private:
    ...
    struct EnemySpawnNode {
        ...
        EnemySpawnNode(GameObject *obj, const char *PresetName, int maxSpawnedAtATime, int totalSpawnLimit,
                       int spawnRate, int respawnDelay, int randomRespawnDelay, int nodeID) {
            NodeID = nodeID;
            ID = Commands->Get_ID(obj);
            ...
            while (Current) {
                if (Current->ID == killedId) {
                    if (RandomRespawnDelay)
                        Current->DeadTime =
                                RespawnDelay + Commands->Get_Random_Int(-RandomRespawnDelay, RandomRespawnDelay);
                    else
        ...
        void Update() {
            ...
            if (RemainingSpawnTime && (this->MaxSpawnedAtATime > this->CurrentSpawnedAtATimeCount &&
                                       (!this->TotalSpawnLimit ||
                                        this->TotalSpawnLimit > this->CurrentTotalSpawnCount))) {
                RemainingSpawnTime--;
...
public:
    ...
    bool BeginLockDown(int enemyArrivalDelay, int LockDownID) {
        ...
        if (LockdownTerminal) {
            ...
            Commands->Attach_Script(LockdownTerminal, "JMG_Metroid_Lockdown_zComputer_Console_Special_Disarm_Script",
                                    params);
            char Animation[32];
        ...
        while (Current2) {
            ...
            if (Light) {
                ...
                char bonename[32];
                for (int x = 0; x < 4; x++) {
                    GameObject * LightEffect = Commands->Create_Object("Warning_Light_Effect",
    ...
    void AddSpawnPoint(GameObject *obj, const char *PresetName, int NodeID, int MaxSpawnedAtATime, int TotalSpawnLimit,
                       int SpawnRate, int RespawnDelay, int RandomRespawnDelay) {
        int ID = Commands->Get_ID(obj);
        EnemySpawnNode *Current = EnemySpawnNodeList;
        if (!EnemySpawnNodeList)
            EnemySpawnNodeList = new EnemySpawnNode(obj, PresetName, MaxSpawnedAtATime, TotalSpawnLimit, SpawnRate,
                                                    RespawnDelay, RandomRespawnDelay, NodeID);
        while (Current) {
            if (Current->ID == ID)
                return;
            if (!Current->next) {
                Current->next = new EnemySpawnNode(obj, PresetName, MaxSpawnedAtATime, TotalSpawnLimit, SpawnRate,
                                                   RespawnDelay, RandomRespawnDelay, NodeID);
                break;
            }
            Current = Current->next;
    ...
    void AddLockdownCustomObject(GameObject *obj, int lockdownMsg, int preLockdownMsg, int postLockdownMsg) {
        ...
        if (!LockdownSendCustomObjectNodeList)
            LockdownSendCustomObjectNodeList = new LockdownSendCustomObjectNode(obj, lockdownMsg, preLockdownMsg,
                                                                                postLockdownMsg);
        while (Current) {
            if (Current->ID == ID)
                return;
