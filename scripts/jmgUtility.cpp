...
#include
"TranslateDBClass.h"
bool JmgUtility::hasStatedDeathMessage[128] = {
false
};
...
char JMG_Utility_Play_Music_On_Join_Controller::musicFileName[256] = {
"null.mp3"
};
...
int JMG_Utility_PCT::pctInaccessible[128] = {
0
};
...
JMG_Utility_Swimming_Zone::PlayerWaterNode JMG_Utility_Swimming_Zone::waterNode[128] = {
JMG_Utility_Swimming_Zone::PlayerWaterNode()
};
...
Vector3 JMG_Utility_Set_Screen_Color_Fade_Controller::color[128] = {
...
int JMG_Utility_AI_Follow_Player_On_Poke_Controller::followingPlayer[128] = {
0
};
...
JMG_Utility_AI_Skittish_Herd_Animal::HerdAnimalPositionSystem JMG_Utility_AI_Skittish_Herd_Animal::HerdAnimalPositionControl[128] = {
...
JMG_Utility_Swimming_Infantry_Advanced_Controller::WeaponNode *JMG_Utility_Swimming_Infantry_Advanced_Controller::weaponNodeGroups[128] = {
NULL
};
