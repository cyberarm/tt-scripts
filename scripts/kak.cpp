...
void KAK_Flowing_Weather::Timer_Expired(GameObject *obj, int number) {
    if (!number) {
        ...
        if (CurrentClouds >= Get_Float_Parameter("Minimum_Precipitation_Start")) {
            CurrentPrecipitation = ((Get_Float_Parameter("Max_Precipitation_Density") /
                                     (1 - Get_Float_Parameter("Minimum_Precipitation_Start"))) *
                                    (CurrentClouds + 1 - Get_Float_Parameter("Minimum_Precipitation_Start"))) -
                                   (Get_Float_Parameter("Max_Precipitation_Density") /
                                    (1 - Get_Float_Parameter("Minimum_Precipitation_Start")));
            if (!_stricmp(Get_Parameter("Precipitation_Type"), "Ash"))
                Commands->Set_Ash(CurrentPrecipitation, CurrentPrecipitation, true);
            else if (!_stricmp(Get_Parameter("Precipitation_Type"), "Snow"))
                Commands->Set_Snow(CurrentPrecipitation, CurrentPrecipitation, true);
            else if (!_stricmp(Get_Parameter("Precipitation_Type"), "Rain"))
                Commands->Set_Rain(CurrentPrecipitation, CurrentPrecipitation, true);
        } else {
        ...
        if (CurrentClouds >= Get_Float_Parameter("Minimum_Lightning_Start")) {
            CurrentLightning = ((Get_Float_Parameter("Maximum_Lightning_Intensity") /
                                 (1 - Get_Float_Parameter("Minimum_Lightning_Start"))) *
                                (CurrentClouds + 1 - Get_Float_Parameter("Minimum_Lightning_Start"))) -
                               (Get_Float_Parameter("Maximum_Lightning_Intensity") /
                                (1 - Get_Float_Parameter("Minimum_Lightning_Start")));
...
ScriptRegistrant<KAK_Precipitation_Create> KAK_Precipitation_Create_Registrant("KAK_Precipitation_Create",
                                                                               "Type=Rain:string,Density=0.000:float,Delay=0.000:float,Reset_Precipitation=0:int,OnCreate=0:int,OnDestroy=0:int");
ScriptRegistrant<KAK_Precipitation_Zone> KAK_Precipitation_Zone_Registrant("KAK_Precipitation_Zone",
                                                                           "Type=Rain:string,Density=0.000:float,Delay=0.000:float,Reset_Precipitation=0:int,OnEnter=0:int,OnExit=0:int");
ScriptRegistrant<KAK_Wind_Create> KAK_Wind_Create_Registrant("KAK_Wind_Create",
                                                             "Wind_Heading=0.000:float,Wind_Speed=0.000:float,Wind_Variability=0.000:float,Delay=0.000:float,OnCreate=0:int,OnDestroy=0:int");
ScriptRegistrant<KAK_Wind_Zone> KAK_Wind_Zone_Registrant("KAK_Wind_Zone",
                                                         "Wind_Heading=0.000:float,Wind_Speed=0.000:float,Wind_Variability=0.000:float,Delay=0.000:float,OnEnter=0:int,OnExit=0:int");
ScriptRegistrant<KAK_Clouds_Create> KAK_Clouds_Create_Registrant("KAK_Clouds_Create",
                                                                 "Cloud_Cover=0.000:float,Cloud_Gloominess=0.000:float,Delay=0.000:float,OnCreate=0:int,OnDestroy=0:int");
ScriptRegistrant<KAK_Clouds_Zone> KAK_Clouds_Zone_Registrant("KAK_Clouds_Zone",
                                                             "Cloud_Cover=0.000:float,Cloud_Gloominess=0.000:float,Delay=0.000:float,OnEnter=0:int,OnExit=0:int");
ScriptRegistrant<KAK_Lightning_Create> KAK_Lightning_Create_Registrant("KAK_Lightning_Create",
                                                                       "Lightning_Intensity=0.000:float,Start_Distance=0.000:float,End_Distance=1.000:float,Lightning_Heading=0.000:float,Lightning_Distribution=1.000:float,Delay=0.000:float,OnCreate=0:int,OnDestroy=0:int");
ScriptRegistrant<KAK_Lightning_Zone> KAK_Lightning_Zone_Registrant("KAK_Lightning_Zone",
                                                                   "Lightning_Intensity=0.000:float,Start_Distance=0.000:float,End_Distance=1.000:float,Lightning_Heading=0.000:float,Lightning_Distribution=1.000:float,Delay=0.000:float,OnEnter=0:int,OnExit=0:int");
ScriptRegistrant<KAK_Flowing_Weather> KAK_Flowing_Weather_Registrant("KAK_Flowing_Weather",
                                                                     "Precipitation_Type=Rain:string,Minimum_Precipitation_Start=0.500:float,Max_Precipitation_Density=5.000:float,Minimum_Lightning_Start=0.850:float,Maximum_Lightning_Intensity=1.000:float,Wind_Variablity=10.000:float,Speed=0.010:float");
ScriptRegistrant<KAK_Give_Powerup_On_Pickup> KAK_Give_Powerup_On_Pickup_Registrant("KAK_Give_Powerup_On_Pickup",
                                                                                   "Powerup_Preset:string");
ScriptRegistrant<KAK_Select_Weapon_Zone> KAK_Select_Weapon_Zone_Registrant("KAK_Select_Weapon_Zone",
                                                                           "Weapon_Preset:string,OnEnter=0:int,OnExit=0:int");
ScriptRegistrant<KAK_Select_Weapon_On_Pickup> KAK_Select_Weapon_On_Pickup_Registrant("KAK_Select_Weapon_On_Pickup",
                                                                                     "Weapon_Preset:string");
ScriptRegistrant<KAK_Harvester_Logic> KAK_Harvester_Logic_Registrant("KAK_Harvester_Logic",
                                                                     "Harvester_Preset:string,Explosion_Preset:string");
ScriptRegistrant<KAK_Harvester_Attached> KAK_Harvester_Attached_Registrant("KAK_Harvester_Attached",
...
ScriptRegistrant<KAK_Harvester_Spawn_Kill> KAK_Harvester_Spawn_Kill_Registrant("KAK_Harvester_Spawn_Kill",
                                                                               "LogicID=0:int");
...
ScriptRegistrant<KAK_Regen_Custom> KAK_Regen_Custom_Registrant("KAK_Regen_Custom",
                                                               "Interval=0.5:float,Health=2.0:float");
