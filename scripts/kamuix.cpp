...
void Kamuix_Kill_Change::Killed(GameObject *obj, GameObject *killer) {
    ...
    if (Get_Object_Type(obj) == 0) {
        char message[1000];
        sprintf(message, "Team2 %d %d", Get_Player_ID(obj),
                Get_Int_Parameter("Team")); //Mismatch between const char* and %d printf type, don't do it again.
        Console_Input(message);
    }
}
...
ScriptRegistrant<Kamuix_Send_FDS_MSG_Zone> Kamuix_Send_FDS_MSG_Zone_Registrant("Kamuix_Send_FDS_MSG_Zone",
                                                                               "Message:string");
ScriptRegistrant<Kamuix_Team_Change_Zone> Kamuix_Team_Change_Zone_Registrant("Kamuix_Team_Change_Zone",
                                                                             "Player_Type:int,Team:int");
ScriptRegistrant<Kamuix_Announce_Preset_Buy> Kamuix_Announce_Preset_Buy_Registrant("Kamuix_Announce_Preset_Buy",
                                                                                   "Preset_Name:string,Cost:int,location:vector3,Player_Type:int,DisplayName:String");
ScriptRegistrant<Kamuix_Death_Announce> Kamuix_Death_Announce_Registrant("Kamuix_Death_Announce",
                                                                         "DestroyedName:string");
ScriptRegistrant<Kamuix_Damaged_Send_MsgFds> Kamuix_Damaged_Send_MsgFds_Registrant("Kamuix_Damaged_Send_MsgFds",
                                                                                   "FDSMessage:string");
ScriptRegistrant<Kamuix_Death_Send_MsgFds> Kamuix_Death_Send_MsgFds_Registrant("Kamuix_Death_Send_MsgFds",
                                                                               "FDSMessage:string");
...
ScriptRegistrant<Kamuix_Player_Announce_Zone> Kamuix_Player_Announce_Zone_Registrant("Kamuix_Player_Announce_Zone",
                                                                                     "Message:string");
...
ScriptRegistrant<Zone_Kamuix_Destroy_Object> Zone_Kamuix_Destroy_Object_Registrant("Zone_Kamuix_Destroy_Object",
                                                                                   "ID:int");
ScriptRegistrant<Kamuix_Set_Type> Kamuix_Set_Type_Registrant("Kamuix_Set_Player_Type", "PlayerType:int");
ScriptRegistrant<Kamuix_Revive_Building_Zone> Kamuix_Revive_Building_Zone_Registrant("Kamuix_Revive_Building",
                                                                                     "ID:int");
ScriptRegistrant<Kamuix_Set_Building_Health_Zone> Kamuix_Set_Building_Health_Zone_Registrant("Kamuix_Zone_Set_Health",
                                                                                             "Type:int,ID:int,Health:float");
ScriptRegistrant<Kamuix_Rebuild_Structure_Zone> Kamuix_Rebuild_Structure_Zone_Registrant(
        "Kamuix_Rebuild_Structure_Zone",
        "Location:vector3,Cost:int,Type:int,ID:int,Health:float,Preset:string,page:string,Popmsg:string,Announcement:string,Teamsound:string");
ScriptRegistrant<Kamuix_Death_Destroy_Building> Kamuix_Death_Destroy_Building_Registrant(
        "Kamuix_Death_Destroy_Building", "ID:int");
ScriptRegistrant<Kamuix_Control_Spawner> Kamuix_Control_Spawner_Registrant("Kamuix_Control_Spawner",
                                                                           "ID:int,Enable:int");
ScriptRegistrant<Kamuix_Zone_Destroy_Building> Kamuix_Zone_Destroy_Building_Registrant("Kamuix_Zone_Destroy_Building",
                                                                                       "ID:int");
