...
Matrix4 Matrix4::ReflectPlane(const PlaneClass &_plane) {
    ...
    temp[0][1] = -2 * plane.N.Y * plane.N.X;
    temp[0][2] = -2 * plane.N.Z * plane.N.X;
    temp[0][3] = 0;
    temp[1][0] = -2 * plane.N.X * plane.N.Y;
    temp[1][1] = -2 * plane.N.Y * plane.N.Y + 1;
    temp[1][2] = -2 * plane.N.Z * plane.N.Y;
    temp[1][3] = 0;
    temp[2][0] = -2 * plane.N.X * plane.N.Z;
    temp[2][1] = -2 * plane.N.Y * plane.N.Z;
    temp[2][2] = -2 * plane.N.Z * plane.N.Z + 1;
    temp[2][3] = 0;
    temp[3][0] = -2 * plane.N.X * plane.D;
    temp[3][1] = -2 * plane.N.Y * plane.D;
    temp[3][2] = -2 * plane.N.Z * plane.D;
    temp[3][3] = 1;
    return temp;
};