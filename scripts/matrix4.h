...
operator*(const Matrix4 &a, float d) {
    return Matrix4(a.Row[0] * d, a.Row[1] * d, a.Row[2] * d, a.Row[3] * d);
}

TT_INLINE Matrix4

operator*(float d, const Matrix4 &a) {
    return a * d;
}
...
Add(const Matrix4 &a, const Matrix4 &b) {
    return a + b;
}
...
Subtract(const Matrix4 &a, const Matrix4 &b) {
    return a - b;
}
...
Multiply(const Matrix4 &a, const Matrix4 &b) {
    return a * b;
}

TT_INLINE Matrix4

operator*(const Matrix4 &a, const Matrix3D &b) {
...
operator*(const Matrix3D &a, const Matrix4 &b) {
#define ROWCOL(i, j) a[i][0]*b[0][j] + a[i][1]*b[1][j] + a[i][2]*b[2][j] + a[i][3]*b[3][j]
    return Matrix4(Vector4(ROWCOL(0, 0), ROWCOL(0, 1), ROWCOL(0, 2), ROWCOL(0, 3)),
                   Vector4(ROWCOL(1, 0), ROWCOL(1, 1), ROWCOL(1, 2), ROWCOL(1, 3)),
                   Vector4(ROWCOL(2, 0), ROWCOL(2, 1), ROWCOL(2, 2), ROWCOL(2, 3)),
...
operator*(const Matrix4 &a, const Vector3 &v) {
