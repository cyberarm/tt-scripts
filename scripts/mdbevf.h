...
struct UnitInfo {
    UnitInfo(PurchaseSettingsDefClass::TYPE type, unsigned int pos, unsigned int preset, bool alternate) : Type(type),
                                                                                                           Pos(pos),
                                                                                                           Preset(preset),
                                                                                                           Alternate(
                                                                                                                   alternate),
...
public:
    ...
    void Load(const char *NavalVehicles, const char *NavalCreationPresets, GameObject *script,
              const char *SupportVehicles = 0);

    void Clear();

    static int Purchase_Hook(BaseControllerClass *base, GameObject *purchaser, unsigned int cost, unsigned int preset,
                             const char *data);
