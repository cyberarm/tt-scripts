...
ScriptRegistrant<NH_Spawn_Object_On_Poke> NH_Spawn_Object_On_Poke_Registrant("NH_Spawn_Object_On_Poke",
                                                                             "PresetName:string,Add_Vectors:vector3");
ScriptRegistrant<NH_Deploy_Building_On_Poke> NH_Deploy_Building_On_Poke_Registrant("NH_Deploy_Building_On_Poke",
                                                                                   "PresetName:string,Add_Vectors:vector3");
ScriptRegistrant<NH_Create_Buy_Panels> NH_Create_Buy_Panels_Registrant("NH_Create_Buy_Panels",
                                                                       "Panel_1_Name:string,Panel_1_Position:vector3,Panel_2_Name:string,Panel_2_Position:vector3,Panel_3_Name:string,Panel_3_Position:vector3,Panel_4_Name:string,Panel_4_Position:vector3");
