...
void NHP_Smart_Targetting::Enemy_Seen(GameObject *obj, GameObject *enemy) {
    ...
    if ((!_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset_One"))) ||
        ((!_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset_Two")))) ||
        ((!_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset_Three")))) ||
        ((!_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset_Four"))))) {
        Commands->Select_Weapon(obj, c);
    } else if ((!_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset_Five"))) ||
               (!_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset_Six"))) ||
               (!_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset_Seven"))) ||
               (!_stricmp(Commands->Get_Preset_Name(enemy), Get_Parameter("Preset_Eight")))) {
...
ScriptRegistrant<NHP_Construction_AI> NHP_Construction_AI_Registrant("NHP_Construction_AI",
                                                                     "Money_Gen:string,Guard_Inf:string,Attack_Unit:string,Money_Limit:int,Guard_Limit:int,Attack_Limit:int,Time_Delay:float,Money_Waypath:int,Guard_Waypath:int,Attack_Waypath:int");
ScriptRegistrant<NHP_Smart_Targetting> NHP_Smart_Targetting_Registrant("NHP_Smart_Targetting",
                                                                       "Presets_1-4_Weapon:string,Presets_5-6_Weapon:string,Other_Weapon:string,Preset_One:string,Preset_Two:string,Preset_Three:string,Preset_Four:string,Preset_Five:string,Preset_Six:string,Preset_Seven:string,Preset_Eight:string");
ScriptRegistrant<NHP_Guard_Bot> NHP_Guard_Bot_Registrant("NHP_Guard_Bot", "Distance:float,Speed:float");
ScriptRegistrant<NHP_Sensor_Array_Zone> NHP_Sensor_Array_Zone_Registrant("NHP_Sensor_Array_Zone",
                                                                         "Sensor_List_File:string,Sound_Preset:string,Sound_Position:vector3,Check_Team:int");
