...
public:
    PhysAABoxIntersectionTestClass(const AABoxClass &box, int col_group, int col_type,
                                   MultiListClass<PhysClass> *result_list = NULL) :
...
public:
    PhysMeshIntersectionTestClass::PhysMeshIntersectionTestClass(MeshClass *mesh, int col_group, int col_type,
                                                                 MultiListClass<PhysClass> *result_list) :
