...
void Ra2Ven_Deployable_Vehicle::Damaged(GameObject *obj, GameObject *damager, float amount) {
    ...
    if ((damager == Commands->Find_Object(pilotID)) && (damager)) {
        ...
        TempCalcul = (int) (Commands->Get_Max_Health(Animation) *
                            (Commands->Get_Health(obj) / Commands->Get_Max_Health(obj)));
        Commands->Set_Health(Animation, (float) TempCalcul);
        TempCalcul = (int) (Commands->Get_Max_Shield_Strength(Animation) *
...
void Ra2Ven_Deploy_Animation::Timer_Expired(GameObject *obj, int number) {
    ...
    TempCalcul = (int) (Commands->Get_Max_Health(DeployedTnk) *
                        (Commands->Get_Health(obj) / Commands->Get_Max_Health(obj)));
    Commands->Set_Health(DeployedTnk, (float) TempCalcul);
    TempCalcul = (int) (Commands->Get_Max_Shield_Strength(DeployedTnk) *
                        (Commands->Get_Shield_Strength(obj) / Commands->Get_Max_Shield_Strength(obj)));
...
void Ra2Ven_FireAnimation::Created(GameObject *obj) {
    ...
    CanPlayAnim = true;
    InitDistance = Commands->Get_Distance(Commands->Get_Bone_Position(obj, Get_Parameter("ParentBone")),
                                          Commands->Get_Bone_Position(obj, Get_Parameter("MuzzleBone")));
    Commands->Start_Timer(obj, this, Get_Float_Parameter("Time"), Get_Int_Parameter("TimerNumber"));
}

void Ra2Ven_FireAnimation::Timer_Expired(GameObject *obj, int number) {
    float Distance;
    Distance = Commands->Get_Distance(Commands->Get_Bone_Position(obj, Get_Parameter("ParentBone")),
                                      Commands->Get_Bone_Position(obj, Get_Parameter("MuzzleBone")));
    if ((Distance == InitDistance)) {
        CanPlayAnim = true;
    }
    if (((int) (Distance * 100) != (int) (InitDistance * 100)) && (CanPlayAnim)) {
        Commands->Set_Animation(obj, Get_Parameter("Animation"), false, 0, Get_Float_Parameter("FirstFrame"),
                                Get_Float_Parameter("LastFrame"), false);
        CanPlayAnim = false;
    }
    Commands->Start_Timer(obj, this, Get_Float_Parameter("Time"), Get_Int_Parameter("TimerNumber"));
}
...
void Ra2Ven_FireAnimation::Animation_Complete(GameObject *obj, const char *animation_name) {
    if (!_stricmp(animation_name, Get_Parameter("Animation"))) {
        if (AnimMode) {
            Commands->Set_Animation(obj, Get_Parameter("AfAnimation"), false, 0, Get_Float_Parameter("AfFirstFrame"),
                                    Get_Float_Parameter("AfLastFrame"), false);
            CanPlayAnim = true;
        } else {
...
void Ra2Ven_FireAnimation2::Timer_Expired(GameObject *obj, int number) {
    ...
    if (((int) (Distance * 100) != (int) (InitDistance * 100)) && (CanPlayAnim)) {
        if (CurAnim == 1) {
            Commands->Set_Animation(obj, Get_Parameter("Animation1"), false, 0, Get_Float_Parameter("FirstFrame1"),
                                    Get_Float_Parameter("LastFrame1"), false);
            CurAnim = 2;
        } else if (CurAnim == 2) {
            Commands->Set_Animation(obj, Get_Parameter("Animation2"), false, 0, Get_Float_Parameter("FirstFrame2"),
                                    Get_Float_Parameter("LastFrame2"), false);
            CurAnim = 1;
        }
        CanPlayAnim = false;
    }
...
void Ra2Ven_FireAnimation2::Animation_Complete(GameObject *obj, const char *animation_name) {
    if ((!_stricmp(animation_name, Get_Parameter("Animation1"))) ||
        (!_stricmp(animation_name, Get_Parameter("Animation2")))) {
        Commands->Set_Animation(obj, Get_Parameter("AfAnimation"), false, 0, Get_Float_Parameter("AfFirstFrame"),
                                Get_Float_Parameter("AfLastFrame"), false);
        CurAnim = 1;
        CanPlayAnim = true;
...
ScriptRegistrant<Ra2Ven_MirageTank> Ra2Ven_MirageTank_Registrant("Ra2Ven_MirageTank",
                                                                 "Tree1_Preset:string,Tree2_Preset=none:string,Tree3_Preset=none:string,Tree4_Preset=none:string,Explosion_Preset:string,Time=1:float,TimerNumber:int");
ScriptRegistrant<Ra2Ven_VehicleFalling> Ra2Ven_VehicleFalling_Registrant("Ra2Ven_VehicleFalling",
                                                                         "ZValueBeforeStartFallingMode:int=3,ImpactExplosion_Preset:string,Warhead:string,DammageMultiplier=10:int,Time=1:float,TimerNumber:int");
ScriptRegistrant<Ra2Ven_DemoTruck> Ra2Ven_DemoTruck_Registrant("Ra2Ven_DemoTruck",
                                                               "Dammage:float,Warhead:string,Demo_Explosion:string");
ScriptRegistrant<Ra2Ven_Deployable_Vehicle> Ra2Ven_Deployable_Vehicle_Registrant("Ra2Ven_Deployable_Vehicle",
                                                                                 "Animation_Preset:string,oldTnk_Warhead:string,oldTnk_Dammage:float,Explosion_preset:string");
ScriptRegistrant<Ra2Ven_Deploy_Animation> Ra2Ven_Deploy_Animation_Registrant("Ra2Ven_Deploy_Animation",
                                                                             "Deployed_Tank_Preset:string,oldTnk_Warhead:string,oldTnk_Dammage:float,Animation_Time:float,TimerNumber:int");
ScriptRegistrant<Ra2Ven_RandomTree> Ra2Ven_RandomTree_Registrant("Ra2Ven_RandomTree",
                                                                 "Tree1_Preset:string,Tree2_Preset=none:string,Tree3_Preset=none:string,Tree4_Preset=none:string");
ScriptRegistrant<Ra2Ven_TurretSound> Ra2Ven_TurretSound_Registrant("Ra2Ven_TurretSound", "TurretSoundObj:string");
ScriptRegistrant<Ra2Ven_TurretSoundObj> Ra2Ven_TurretSoundObj_Registrant("Ra2Ven_TurretSoundObj",
                                                                         "RotationAngleLimit:int,Rotate_3dSound:string,Explosion_Preset:string,Time=0.5:float,TimerNumber:int,Wav_Length:float,TimerNumber2:int");
ScriptRegistrant<Ra2Ven_OccupentWeapon> Ra2Ven_OccupentWeapon_Registrant("Ra2Ven_OccupentWeapon",
                                                                         "Character1:string,PowerUp1:string,Weapon1:string,Character2:string,PowerUp2:string,Weapon2:string,Character3:string,PowerUp3:string,Weapon3:string,Character4:string,PowerUp4:string,Weapon4:string,DefPowerUp:string,DefWeapon:string");
ScriptRegistrant<Ra2Ven_Dplbl_Vhcls_Cursor> Ra2Ven_Dplbl_Vhcls_Cursor_Registrant("Ra2Ven_Dplbl_Vhcls_Cursor",
                                                                                 "Cursor_preset:string,CursorBoneName:string,CursorExplosion:string,Animation_Preset:string,oldTnk_Warhead:string,oldTnk_Dammage:float,Explosion_preset:string");
ScriptRegistrant<Ra2Ven_FireAnimation> Ra2Ven_FireAnimation_Registrant("Ra2Ven_FireAnimation",
                                                                       "ParentBone:string,MuzzleBone:string,Animation:string,FirstFrame=0:float,LastFrame=0:float,AfAnimation=none:string,AfFirstFrame=0:float,AfLastFrame=0:float,Time=0.1:float,TimerNumber:int");
ScriptRegistrant<Ra2Ven_FireAnimation2> Ra2Ven_FireAnimation2_Registrant("Ra2Ven_FireAnimation2",
                                                                         "ParentBone:string,MuzzleBone:string,Animation1:string,FirstFrame1=0:float,LastFrame1=0:float,Animation2:string,FirstFrame2=0:float,LastFrame2=0:float,AfAnimation:string,AfFirstFrame=0:float,AfLastFrame=0:float,Time=0.1:float,TimerNumber:int");
