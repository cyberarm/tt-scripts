...
void Reborn_Diggable_Vehicle_Animated::Action_Complete(GameObject *obj, int action_id,
...
void Reborn_Deployable_Vehicle_Player::KeyHook() {
    Commands->Send_Custom_Event(Owner(), Commands->Find_Object(Get_Int_Parameter("ID")), Get_Int_Parameter("Message"),
                                0, 0);
}
...
void Reborn_IsDeployableMech::Timer_Expired(GameObject *obj, int number) {
    ...
    if (number == 2) {
        ...
        if (enabled && forward && !play) {
            if (((Get_Animation_Frame(obj) > (Get_Int_Parameter("Stomp1Frame_Forward") - 2)) &&
                 (Get_Animation_Frame(obj) < (Get_Int_Parameter("Stomp1Frame_Forward") + 2))) ||
                ((Get_Animation_Frame(obj) > (Get_Int_Parameter("Stomp2Frame_Forward") - 1)) &&
                 (Get_Animation_Frame(obj) < (Get_Int_Parameter("Stomp2Frame_Forward") + 2)))) {
                play = true;
        ...
        if (enabled && backward && !play) {
            if (((Get_Animation_Frame(obj) > (Get_Int_Parameter("Stomp1Frame_Backward") - 2)) &&
                 (Get_Animation_Frame(obj) < (Get_Int_Parameter("Stomp1Frame_Backward") + 2))) ||
                ((Get_Animation_Frame(obj) > (Get_Int_Parameter("Stomp2Frame_Backward") - 1)) &&
                 (Get_Animation_Frame(obj) < (Get_Int_Parameter("Stomp2Frame_Backward") + 2)))) {
                play = true;
                Commands->Create_3D_WAV_Sound_At_Bone(Get_Parameter("StompWAVSound"), obj, "Origin");
                Commands->Start_Timer(obj, this, (float) 0.5, 2);
            }
    ...
    if (number == 2) {
        ...
        if (dist > 0.1) {
            ...
            if (Get_Animation_Frame(obj)) {
                if (forward) {
                    LastDir = 1;
                    Commands->Set_Animation(obj, moveanim, true, 0, Get_Animation_Frame(obj), Get_Animation_Frame(obj),
                                            0);
                }
                if (backward) {
                    LastDir = 2;
                    Commands->Set_Animation(obj, movebanim, true, 0, Get_Animation_Frame(obj), Get_Animation_Frame(obj),
                                            0);
                }
                enabled = true;
    ...
    if (type == CUSTOM_EVENT_VEHICLE_ENTERED) {
        ...
        if (!mode) {
            ...
            if ((coltest.CollidedRenderObj) && (Vector3::Dot_Product(res.Normal, ray.Get_Dir()) <= 0) &&
                (pos.Z - res.ContactPoint.Z <= Get_Float_Parameter("GroundDistance")) &&
                (!obj->As_VehicleGameObj()->Is_Immovable())) {
                Commands->Enable_Engine(obj, false);
...
ScriptRegistrant<Reborn_MMK2> Reborn_MMK2_Registrant("Reborn_MMK2",
                                                     "GameManager_ID:int,Explosion_Preset_Name:string,MoneyToReturn:float");
ScriptRegistrant<Reborn_Cyborg> Reborn_Cyborg_Registrant("Reborn_Cyborg",
                                                         "GameManager_ID:int,Explosion_Preset_Name:string,MoneyToReturn:float");
ScriptRegistrant<Reborn_Deployable_Vehicle> Reborn_Deployable_Vehicle_Registrant("Reborn_Deployable_Vehicle",
                                                                                 "Animated_Preset:string,Explosion_Preset:string");
ScriptRegistrant<Reborn_Deploy_Animation> Reborn_Deploy_Animation_Registrant("Reborn_Deploy_Animation",
                                                                             "Time_Till_Death:float,Deployed_Tank_Preset:string,Explosion_Preset:string");
ScriptRegistrant<Reborn_MMK2_Turret_Spawn> Reborn_MMK2_Turret_Spawn_Registrant("Reborn_MMK2_Turret_Spawn",
                                                                               "Turret_Preset:string,Bone_Name=Tur_Mount:string,Explosion_Preset:string");
ScriptRegistrant<Reborn_Diggable_Vehicle> Reborn_Diggable_Vehicle_Registrant("Reborn_Diggable_Vehicle",
                                                                             "Mode:int,Dig_Delay:float,Z_Hieght_Adjust:float");
ScriptRegistrant<Reborn_PlaySound_OnCreate> Reborn_PlaySound_OnCreate_Registrant("Reborn_PlaySound_OnCreate",
                                                                                 "Sound_Preset_Name=BLAH!:string");
ScriptRegistrant<Reborn_Diggable_Vehicle_Animated> Reborn_Diggable_Vehicle_Animated_Registrant(
        "Reborn_Diggable_Vehicle_Animated", "Z_Hieght_Adjust:float,Dig_Animation:string,Surface_Animation:string");
ScriptRegistrant<Reborn_IsDeployableMech> Reborn_IsDeployableMech_Registrant("Reborn_IsDeployableMech",
                                                                             "Model_Name=none:string,Weapon_Name=none:string,Weapon_Powerup_Name=none:string,Last_Deploy_Frame=0.00:float,StompWAVSound=wolverine_stomp.wav:string,Stomp1Frame_Forward=21:int,Stomp2Frame_Forward=10:int,Stomp1Frame_Backward=51:int,Stomp2Frame_Backward=40:int,DeploySound:string,UndeploySound:string");
ScriptRegistrant<Reborn_IsDeployableTank> Reborn_IsDeployableTank_Registrant("Reborn_IsDeployableTank",
                                                                             "Model_Name=v_nod_art:string,Weapon_Name=weapon_artillery:string,Weapon_Powerup_Name=pow_artillery:string,Last_Deploy_Frame=0.00:float,Velocity:float,Message:string,Sound:string,DeploySound:string,UndeploySound:string");
ScriptRegistrant<Reborn_IsDeployableTank_2> Reborn_IsDeployableTank_2_Registrant("Reborn_IsDeployableTank_2",
                                                                                 "Model_Name=v_nod_art:string,Last_Deploy_Frame=0.00:float,Velocity:float,Message:string,Sound:string,DeploySound:string,UndeploySound:string");
ScriptRegistrant<Reborn_IsDeployableTank_3> Reborn_IsDeployableTank_3_Registrant("Reborn_IsDeployableTank_3",
                                                                                 "Model_Name=v_nod_art:string,Last_Deploy_Frame=0.00:float,Weapon_Name:string,Weapon_Powerup_Name:string,Armor:string,Weapon_Name2:string,Weapon_Powerup_Name2:string,Armor2:string,Velocity:float,Message:string,Sound:string,DeploySound:string,UndeploySound:string");
ScriptRegistrant<Reborn_IsDeployableTank_4> Reborn_IsDeployableTank_4_Registrant("Reborn_IsDeployableTank_4",
                                                                                 "Model_Name=v_nod_art:string,Last_Deploy_Frame=0.00:float,Weapon_Name:string,Weapon_Powerup_Name:string,Armor:string,Weapon_Name2:string,Weapon_Powerup_Name2:string,Armor2:string,Velocity:float,Message:string,Sound:string,GroundBone:string,GroundDistance:float,DeploySound:string,UndeploySound:string");
ScriptRegistrant<Reborn_IsMech> Reborn_IsMech_Registrant("Reborn_IsMech",
                                                         "StompWAVSound=wolverine_stomp.wav:string,Stomp1Frame_Forward=21:int,Stomp2Frame_Forward=51:int,Stomp1Frame_Backward=10:int,Stomp2Frame_Backward=40:int");
ScriptRegistrant<Reborn_Deployable_Vehicle_Player> Reborn_Deployable_Vehicle_Player_Registrant(
        "Reborn_Deployable_Vehicle_Player", "Key=Deploy:string,ID=0:int,Message=0:int");
