...
public:
    ScriptVariableClass(void *data_ptr, int data_size, int id, ScriptVariableClass *next) : DataPtr(data_ptr),
                                                                                            DataSize(data_size), ID(id),
                                                                                            Next(next) {}
...
class SCRIPTS_API ScriptImpClass
...
struct ScriptCommands {
    ...
    void ( *Modify_Action )(GameObject *obj, int ActionID, const ActionParamsStruct &params, bool modify_move,
                            bool modify_attack);
    ...
    */
    ...
    void (*Add_Objective)(int id, int type, int status, int short_description_id, char *description_sound_filename,
...
extern SCRIPTS_API ScriptCommands
*
Commands;
#endif
