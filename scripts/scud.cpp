...
void SCUD_Follow_Waypath_Until_Custom::Action_Complete(GameObject *obj, int action_id,
...
void SCUD_CustomSend_PresetBuy_GeneralPresets_FollowWaypath::Custom(GameObject *obj, int type, int param,
                                                                    GameObject *sender) {
    const char *preset;
    const char *preset1;
    const char *preset2;
...
void SCUD_USHarvester_Terminal::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    ...
    if (type == CUSTOM_EVENT_VEHICLE_EXITED) {
        if (cost <= Commands->Get_Money(sender)) {
            ...
            facing = Get_Float_Parameter("Rotation");
            Commands->Set_Facing(npre, facing);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(Get_Int_Parameter("Harvester_Control_ID")), 1919,
                                        visitorID, 0);
            if (Get_Int_Parameter("Waypath_enabled") == 1) {
                int waypathid;
                float speed;
...
void SCUD_CHHarvester_Terminal::Custom(GameObject *obj, int type, int param, GameObject *sender) {
    ...
    if (type == CUSTOM_EVENT_VEHICLE_EXITED) {
        if (cost <= Commands->Get_Money(sender)) {
            ...
            facing = Get_Float_Parameter("Rotation");
            Commands->Set_Facing(npre, facing);
            Commands->Send_Custom_Event(obj, Commands->Find_Object(Get_Int_Parameter("Harvester_Control_ID")), 1920,
                                        visitorID, 0);
            if (Get_Int_Parameter("Waypath_enabled") == 1) {
                int waypathid;
                float speed;
...
void SCUD_DozerBuildTurret::Damaged(GameObject *obj, GameObject *damager, float amount) {
    ...
    if ((damager == Commands->Find_Object(PilotID)) && (damager)) {
        if (cost <= Commands->Get_Money(damager)) {
            ...
            Commands->Send_Custom_Event(obj, Commands->Find_Object(Get_Int_Parameter("Controller_ID")), 1920, PilotID,
                                        0);
            npre = Commands->Create_Object(preset, spawn_position);
...
ScriptRegistrant<SCUD_Turret_Spawn> SCUD_Turret_Spawn_Registrant("SCUD_Turret_Spawn",
                                                                 "Turret_Preset:string,Bone_Name=BoneName:string,Explosion_Preset:string");
ScriptRegistrant<SCUD_Harvester_Zone> SCUD_Harvester_Zone_Registrant("SCUD_Harvester_Zone",
                                                                     "Credits=1000.00:float,Next_Harvester_Time=5.00:float,Harvester_Preset_ID:int,LvlHarvester_Preset_ID:int,Thief_Credits=500.00:float,Thief_Time=5.00:float,Thief_Preset_ID:int");
ScriptRegistrant<SCUD_Custom_Follow_Waypath> SCUD_Custom_Follow_Waypath_Registrant("SCUD_Custom_Follow_Waypath",
                                                                                   "WaypathID:int,Speed:float,Message:int");
ScriptRegistrant<SCUD_Follow_Waypath_Until_Custom> SCUD_Follow_Waypath_Until_Custom_Registrant(
        "SCUD_Follow_Waypath_Until_Custom", "WaypathID:int,Speed:float,Message:int");
ScriptRegistrant<SCUD_Poke_Preset_Buy> SCUD_Poke_Preset_Buy_Registrant("SCUD_Poke_Preset_Buy",
                                                                       "Unknown:float,Preset_Name:string,Cost:int,location:vector3,Player_Type:int");
ScriptRegistrant<SCUD_Preset_Buy> SCUD_Preset_Buy_Registrant("SCUD_Preset_Buy",
                                                             "Unknown:float,Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Rotation:float");
ScriptRegistrant<SCUD_CustomSend_Preset_Buy> SCUD_CustomSend_Preset_Buy_Registrant("SCUD_CustomSend_Preset_Buy",
                                                                                   "Unknown:float,SendID:int,SendMessage:int,SendParam:int,Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Rotation:float");
ScriptRegistrant<SCUD_CustomSend_PresetBuy_FollowWaypath> SCUD_CustomSend_PresetBuy_FollowWaypath_Registrant(
        "SCUD_CustomSend_PresetBuy_FollowWaypath",
        "Unknown:float,SendID:int,SendMessage:int,SendParam:int,Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Rotation:float,Waypath_enabled:int,WaypathID:int,Speed:float");
ScriptRegistrant<SCUD_CustomSend_PresetBuy_GeneralPresets_FollowWaypath> SCUD_CustomSend_PresetBuy_GeneralPresets_FollowWaypath_Registrant(
...
ScriptRegistrant<SCUD_Deployable_Vehicle> SCUD_Deployable_Vehicle_Registrant("SCUD_Deployable_Vehicle",
                                                                             "Animated_Preset:string,Explosion_Preset:string");
ScriptRegistrant<SCUD_Deploy_Animation> SCUD_Deploy_Animation_Registrant("SCUD_Deploy_Animation",
                                                                         "Time_Till_Death:float,Deployed_Tank_Preset:string,Explosion_Preset:string");
ScriptRegistrant<SCUD_DeathZoneOnCustom> SCUD_DeathZoneOnCustom_Registrant("SCUD_DeathZoneOnCustom",
                                                                           "Message:int,Explosion:string");
ScriptRegistrant<SCUD_Harvester_Control> SCUD_Harvester_Control_Registrant("SCUD_Harvester_Control",
                                                                           "USA_Harvester_Limit:int,China_Harvester_Limit:int,US_Harvester_Terminal_ID:int,CH_Harvester_Terminal_ID:int,USA_Harvester_Cost:int,China_Harvester_Cost:int");
ScriptRegistrant<SCUD_USHarvester> SCUD_USHarvester_Registrant("SCUD_USHarvester",
                                                               "Harvester_Control_ID:int,Explosion_Preset_Name:string");
ScriptRegistrant<SCUD_CHHarvester> SCUD_CHHarvester_Registrant("SCUD_CHHarvester",
                                                               "Harvester_Control_ID:int,Explosion_Preset_Name:string");
ScriptRegistrant<SCUD_USHarvester_Terminal> SCUD_USHarvester_Terminal_Registrant("SCUD_USHarvester_Terminal",
                                                                                 "Unknown:float,SendID:int,SendMessage:int,SendParam:int,Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Rotation:float,Waypath_enabled:int,WaypathID:int,Speed:float,Harvester_Control_ID:int");
ScriptRegistrant<SCUD_CHHarvester_Terminal> SCUD_CHHarvester_Terminal_Registrant("SCUD_CHHarvester_Terminal",
                                                                                 "Unknown:float,SendID:int,SendMessage:int,SendParam:int,Preset_Name:string,Cost:int,location:vector3,Player_Type:int,Rotation:float,Waypath_enabled:int,WaypathID:int,Speed:float,Harvester_Control_ID:int");
ScriptRegistrant<SCUD_Set_Player_Type_OnCustom> SCUD_Set_Player_Type_OnCustom_Registrant(
        "SCUD_Set_Player_Type_OnCustom", "Message:int,Player_Type:int");
ScriptRegistrant<SCUD_SuperWeapon> SCUD_SuperWeapon_Registrant("SCUD_SuperWeapon",
                                                               "SuperWeaponAmmo:int,FireTimeSinceFirstShot:float");
ScriptRegistrant<SCUD_DozerBuildTurret> SCUD_DozerBuildTurret_Registrant("SCUD_DozerBuildTurret",
                                                                         "Turret_PresetName:string,Cost:int,Controller_ID:int");
ScriptRegistrant<SCUD_TurretBuildup> SCUD_TurretBuildup_Registrant("SCUD_TurretBuildup",
                                                                   "Buildup_Time:float,Turret_PresetName:string");
