...
public:
    ...
    TT_INLINE Vector4(const Vector4 &v) {
        X = v.X;
        Y = v.Y;
        Z = v.Z;
        W = v.W;
    ...
    TT_INLINE Vector4(float x, float y, float z, float w) {
        X = x;
        Y = y;
        Z = z;
        W = w;
    ...
    TT_INLINE explicit Vector4(const float v[4]) {
        TT_ASSERT(v != NULL);
        X = v[0];
        Y = v[1];
        Z = v[2];
    ...
    TT_INLINE void Set(float x, float y, float z, float w) {
        X = x;
        Y = y;
        Z = z;
        W = w;
    ...
    operator-() const { return (Vector4(-X, -Y, -Z, -W)); };
    TT_INLINE Vector4
    ...
    TT_INLINE static Vector4

    Lerp(const Vector4 &a, const Vector4 &b, float alpha) {
...
operator*(const Vector4 &a, float b) {
    return Vector4(a.X * b, a.Y * b, a.Z * b, a.W * b);
};

TT_INLINE Vector4

operator*(float a, const Vector4 &b) {
    return b * a;
};

TT_INLINE Vector4

operator/(const Vector4 &a, float k) {
