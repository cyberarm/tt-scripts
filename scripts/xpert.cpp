...
ScriptRegistrant<Xpert_Teleport_Zone_Random> Xpert_Teleport_Zone_Random_Registrant("Xpert_Teleport_Zone_Random",
                                                                                   "Location1:vector3,Object_ID1=0:int,Location2:vector3,Object_ID2=0:int,Location3:vector3,Object_ID3=0:int,Location4:vector3,Object_ID4=0:int,Location5:vector3,Object_ID5=0:int");
